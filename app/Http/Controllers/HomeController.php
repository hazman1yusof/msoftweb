...
{   
    ...
    public function create_khealth_menu(){
        ...
        $menu.="<li><a style='padding-left:21px' title='Recomputed' class='clickable' programid='fin_salesOrder_recomputed' targeturl='./PointOfSales?scope=RECOMPUTED'>Recomputed</a></li>";
