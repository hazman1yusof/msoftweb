        ...
        try {
            ...
            DB::table('nursing.nursassessgen')
                    ->insert([
                        ...
                        'ps_nopain' => $request->ps_nopain,
                        'ps_mildpain' => $request->ps_mildpain,
                        'ps_moderatepain' => $request->ps_moderatepain,
                        'ps_severepain' => $request->ps_severepain,
                        'ps_worstpain' => $request->ps_worstpain,
