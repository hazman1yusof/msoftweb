...
class physioMRController extends defaultController
{
        ...
        try {
            ...
            DB::table('hisdb.phy_neuroassessment')
                ->insert([
                    ...
                    'painType2' => $request->painType2,
                    'severityBC' => $request->severityBC,
                    'severityBC2' => $request->severityBC2,
                    'irritabilityBC' => $request->irritabilityBC,
                    'irritabilityBC2' => $request->irritabilityBC2,
                    'painLocation' => $request->painLocation,
                    'painLocation2' => $request->painLocation2,
                    ...
                    'btrRT' => $request->btrRT,
                    'btrLT' => $request->btrLT,
                    'btrRemarks' => $request->btrRemarks,
                    'ttrRT' => $request->ttrRT,
                    'ttrLT' => $request->ttrLT,
                    'ttrRemarks' => $request->ttrRemarks,
                    'ktrRT' => $request->ktrRT,
                    'ktrLT' => $request->ktrLT,
                    'ktrRemarks' => $request->ktrRemarks,
                    'atrRT' => $request->atrRT,
                    'atrLT' => $request->atrLT,
                    'atrRemarks' => $request->atrRemarks,
                    'babinskyRT' => $request->babinskyRT,
                    'babinskyLT' => $request->babinskyLT,
                    'babinskyRemarks' => $request->babinskyRemarks,
                    'impressionDTR' => $request->impressionDTR,
                    'fingerTestR' => $request->fingerTestR,
                    'fingerTestL' => $request->fingerTestL,
                    'fingerTestRemarks' => $request->fingerTestRemarks,
                    'heelTestR' => $request->heelTestR,
                    'heelTestL' => $request->heelTestL,
                    'heelTestRemarks' => $request->heelTestRemarks,
            ...
            DB::table('hisdb.phy_musclepower')
                ->insert([
                    ...
                    'aShlderAddInit' => $request->aShlderAddInit,
                    // 'aShlderAddProg' => $request->aShlderAddProg,
                    'aShlderAddFin' => $request->aShlderAddFin,
                    'aShlderIntRotInit' => $request->aShlderIntRotInit,
                    // 'aShlderIntRotProg' => $request->aShlderIntRotProg,
                    'aShlderIntRotFin' => $request->aShlderIntRotFin,
                    'aShlderExtRotInit' => $request->aShlderExtRotInit,
                    // 'aShlderExtRotProg' => $request->aShlderExtRotProg,
                    'aShlderExtRotFin' => $request->aShlderExtRotFin,
                    ...
                    'aElbowProInit' => $request->aElbowProInit,
                    // 'aElbowProProg' => $request->aElbowProProg,
                    'aElbowProFin' => $request->aElbowProFin,
                    'aElbowSupInit' => $request->aElbowSupInit,
                    // 'aElbowSupProg' => $request->aElbowSupProg,
                    'aElbowSupFin' => $request->aElbowSupFin,
                    ...
                    'aWristRadInit' => $request->aWristRadInit,
                    // 'aWristRadProg' => $request->aWristRadProg,
                    'aWristRadFin' => $request->aWristRadFin,
                    'aWristUlnarInit' => $request->aWristUlnarInit,
                    // 'aWristUlnarProg' => $request->aWristUlnarProg,
                    'aWristUlnarFin' => $request->aWristUlnarFin,
                    ...
                    'aHipAddInit' => $request->aHipAddInit,
                    // 'aHipAddProg' => $request->aHipAddProg,
                    'aHipAddFin' => $request->aHipAddFin,
                    'aHipIntRotInit' => $request->aHipIntRotInit,
                    // 'aHipIntRotProg' => $request->aHipIntRotProg,
                    'aHipIntRotFin' => $request->aHipIntRotFin,
                    'aHipExtRotInit' => $request->aHipExtRotInit,
                    // 'aHipExtRotProg' => $request->aHipExtRotProg,
                    'aHipExtRotFin' => $request->aHipExtRotFin,
                    ...
                    'aAnkleEverInit' => $request->aAnkleEverInit,
                    // 'aAnkleEverProg' => $request->aAnkleEverProg,
                    'aAnkleEverFin' => $request->aAnkleEverFin,
                    'aAnkleInverInit' => $request->aAnkleInverInit,
                    // 'aAnkleInverProg' => $request->aAnkleInverProg,
                    'aAnkleInverFin' => $request->aAnkleInverFin,
                    // 'impressionAMP' => $request->impressionAMP,
                    ...
                    'sShlderAddInit' => $request->sShlderAddInit,
                    // 'sShlderAddProg' => $request->sShlderAddProg,
                    'sShlderAddFin' => $request->sShlderAddFin,
                    'sShlderIntRotInit' => $request->sShlderIntRotInit,
                    // 'sShlderIntRotProg' => $request->sShlderIntRotProg,
                    'sShlderIntRotFin' => $request->sShlderIntRotFin,
                    'sShlderExtRotInit' => $request->sShlderExtRotInit,
                    // 'sShlderExtRotProg' => $request->sShlderExtRotProg,
                    'sShlderExtRotFin' => $request->sShlderExtRotFin,
                    ...
                    'sElbowProInit' => $request->sElbowProInit,
                    // 'sElbowProProg' => $request->sElbowProProg,
                    'sElbowProFin' => $request->sElbowProFin,
                    'sElbowSupInit' => $request->sElbowSupInit,
                    // 'sElbowSupProg' => $request->sElbowSupProg,
                    'sElbowSupFin' => $request->sElbowSupFin,
                    ...
                    'sWristRadInit' => $request->sWristRadInit,
                    // 'sWristRadProg' => $request->sWristRadProg,
                    'sWristRadFin' => $request->sWristRadFin,
                    'sWristUlnarInit' => $request->sWristUlnarInit,
                    // 'sWristUlnarProg' => $request->sWristUlnarProg,
                    'sWristUlnarFin' => $request->sWristUlnarFin,
                    ...
                    'sHipAddInit' => $request->sHipAddInit,
                    // 'sHipAddProg' => $request->sHipAddProg,
                    'sHipAddFin' => $request->sHipAddFin,
                    'sHipIntRotInit' => $request->sHipIntRotInit,
                    // 'sHipIntRotProg' => $request->sHipIntRotProg,
                    'sHipIntRotFin' => $request->sHipIntRotFin,
                    'sHipExtRotInit' => $request->sHipExtRotInit,
                    // 'sHipExtRotProg' => $request->sHipExtRotProg,
                    'sHipExtRotFin' => $request->sHipExtRotFin,
                    ...
                    'sAnkleEverInit' => $request->sAnkleEverInit,
                    // 'sAnkleEverProg' => $request->sAnkleEverProg,
                    'sAnkleEverFin' => $request->sAnkleEverFin,
                    'sAnkleInverInit' => $request->sAnkleInverInit,
                    // 'sAnkleInverProg' => $request->sAnkleInverProg,
                    'sAnkleInverFin' => $request->sAnkleInverFin,
            ...
            DB::table('hisdb.patrehabperkeso')
                ->insert([
                    ...
                    'patComplaint' => $request->patComplaint,
                    'patHX' => $request->patHX,
                    ...
                    'barthelIndexRemarks' => $request->barthelIndexRemarks,
                    'bergBalanceInit' => $request->bergBalanceInit,
                    // 'bergBalanceProg' => $request->bergBalanceProg,
                    'bergBalanceFin' => $request->bergBalanceFin,
                    'bergBalanceRemarks' => $request->bergBalanceRemarks,
                    'sixMinWalkInit' => $request->sixMinWalkInit,
                    // 'sixMinWalkProg' => $request->sixMinWalkProg,
                    'sixMinWalkFin' => $request->sixMinWalkFin,
                    'sixMinWalkRemarks' => $request->sixMinWalkRemarks,
                    'impressionST' => $request->impressionST,
                    'jawInit' => $request->jawInit,
                    'jawFin' => $request->jawFin,
                    'lipsInit' => $request->lipsInit,
                    'lipsFin' => $request->lipsFin,
                    'softPalateInit' => $request->softPalateInit,
                    'softPalateFin' => $request->softPalateFin,
                    'voiceInit' => $request->voiceInit,
                    'voiceFin' => $request->voiceFin,
                    'tongueInit' => $request->tongueInit,
                    'tongueFin' => $request->tongueFin,
                    'oromotorCmtInit' => $request->oromotorCmtInit,
                    'oromotorCmtFin' => $request->oromotorCmtFin,
                    'MPTInit' => $request->MPTInit,
                    'MPTFin' => $request->MPTFin,
                    'loudInit' => $request->loudInit,
                    'loudFin' => $request->loudFin,
                    'pitchInit' => $request->pitchInit,
                    'pitchFin' => $request->pitchFin,
                    'articltInit' => $request->articltInit,
                    'articltFin' => $request->articltFin,
                    'speechCmtInit' => $request->speechCmtInit,
                    'speechCmtFin' => $request->speechCmtFin,
                    'spontaneousInit' => $request->spontaneousInit,
                    'spontaneousFin' => $request->spontaneousFin,
                    'auditoryInit' => $request->auditoryInit,
                    'auditoryFin' => $request->auditoryFin,
                    'repeatInit' => $request->repeatInit,
                    'repeatFin' => $request->repeatFin,
                    'namingInit' => $request->namingInit,
                    'namingFin' => $request->namingFin,
                    'aphasiaInit' => $request->aphasiaInit,
                    'aphasiaFin' => $request->aphasiaFin,
                    'languageCmtInit' => $request->languageCmtInit,
                    'languageCmtFin' => $request->languageCmtFin,
                    'oralInit' => $request->oralInit,
                    'oralFin' => $request->oralFin,
                    'pharyngealInit' => $request->pharyngealInit,
                    'pharyngealFin' => $request->pharyngealFin,
                    'manageInit' => $request->manageInit,
                    'manageFin' => $request->manageFin,
                    ...
                    'therapistNameInit3' => $request->therapistNameInit3,
                    // 'therapistNameProg3' => $request->therapistNameProg3,
                    'therapistNameFin3' => $request->therapistNameFin3,
