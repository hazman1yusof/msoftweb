        ...
        try {
            ...
            DB::table('hisdb.phy_musclepower')
                ->insert([
                    ...
                    'impressionMP' => $request->impressionMP,
                    'adduser'  => session('username'),
                    'adddate'  => Carbon::now("Asia/Kuala_Lumpur")->toDateString(),
                    'lastuser'  => session('username'),
                    'lastupdate'  => Carbon::now("Asia/Kuala_Lumpur")->toDateString(),
            ...
            DB::table('hisdb.patrehabperkeso')
                ->insert([
                    ...
                    'therapistNameInit' => $request->therapistNameInit,
                    'therapistNameProg' => $request->therapistNameProg,
                    'therapistNameFin' => $request->therapistNameFin,
