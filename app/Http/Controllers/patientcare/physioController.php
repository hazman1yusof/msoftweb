        ...
        try {
            ...
            DB::table('hisdb.patrehabncase')
                ->insert([
                    ...
                    'FAC_toeOut_L' => $request->FAC_toeOut_L,
                    'FAC_toeOut_R' => $request->FAC_toeOut_R,
                    'FAC_toeIn_L' => $request->FAC_toeIn_L,
                    'FAC_toeIn_R' => $request->FAC_toeIn_R,
                    'FAC_pronation_L' => $request->FAC_pronation_L,
                    'FAC_pronation_R' => $request->FAC_pronation_R,
                    'FAC_flatfeet_L' => $request->FAC_flatfeet_L,
                    'FAC_flatfeet_R' => $request->FAC_flatfeet_R,
                    'FAC_higharch_L' => $request->FAC_higharch_L,
                    'FAC_higharch_R' => $request->FAC_higharch_R,
                    'KH_knockknees_L' => $request->KH_knockknees_L,
                    'KH_knockknees_R' => $request->KH_knockknees_R,
                    'KH_bowlegs_L' => $request->KH_bowlegs_L,
                    'KH_bowlegs_R' => $request->KH_bowlegs_R,
                    'SP_scoliosis_L' => $request->SP_scoliosis_L,
                    'SP_scoliosis_R' => $request->SP_scoliosis_R,
                    'scapula_dev_L' => $request->scapula_dev_L,
                    'scapula_dev_R' => $request->scapula_dev_R,
                    'shoulder_dev_L' => $request->shoulder_dev_L,
                    'shoulder_dev_R' => $request->shoulder_dev_R,
                    'head_tilt_L' => $request->head_tilt_L,
                    'head_tilt_R' => $request->head_tilt_R,
                    'head_rotate_L' => $request->head_rotate_L,
                    'head_rotate_R' => $request->head_rotate_R,
                    'anteriorPosterior_rmk' => $request->anteriorPosterior_rmk,
                    'ankle_dorsif_L' => $request->ankle_dorsif_L,
                    'ankle_dorsif_R' => $request->ankle_dorsif_R,
                    'ankle_plantarf_L' => $request->ankle_plantarf_L,
                    'ankle_plantarf_R' => $request->ankle_plantarf_R,
                    'knee_flexed_L' => $request->knee_flexed_L,
                    'knee_flexed_R' => $request->knee_flexed_R,
                    'knee_extended_L' => $request->knee_extended_L,
                    'knee_extended_R' => $request->knee_extended_R,
                    'pelvis_translation_L' => $request->pelvis_translation_L,
                    'pelvis_translation_R' => $request->pelvis_translation_R,
                    'dev_symmetry' => $request->dev_symmetry,
                    'tilt_anterior' => $request->tilt_anterior,
                    'tilt_posterior' => $request->tilt_posterior,
                    'LS_lordosis' => $request->LS_lordosis,
                    'LS_flat' => $request->LS_flat,
                    'TS_kyphosis' => $request->TS_kyphosis,
                    'TS_flat' => $request->TS_flat,
                    'TR_rotation' => $request->TR_rotation,
                    'SH_forward' => $request->SH_forward,
                    'HP_forward' => $request->HP_forward,
                    'HP_back' => $request->HP_back,
                    'lateral_rmk' => $request->lateral_rmk,
