...
class OccupTherapyBarthelMRController extends defaultController
{
    ...
    {
        return view('rehab_MR.occupTherapy_MR.occupTherapy_barthel_MR');
    }
    ...
    public function barthel_chart(Request $request){
        ...
        return view('rehab.occupTherapy.barthelChart_pdfmake',compact('barthel'));
