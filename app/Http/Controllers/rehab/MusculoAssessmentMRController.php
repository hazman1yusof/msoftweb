...
class MusculoAssessmentMRController extends defaultController
{
    ...
    {
        return view('rehab_MR.physio_MR.musculoAssessment_MR');
    }
    ...
    public function form(Request $request)
    {
        ...
        switch($request->action){
            case 'save_table_musculoAssessment':
                switch($request->oper){
                    case 'add':
                        return $this->add_musculoAssessment($request);
                    case 'edit':
                        return $this->edit_musculoAssessment($request);
                    default:
                        return 'error happen..';
                }
            
            case 'get_table_musculoAssessment':
                return $this->get_table_musculoAssessment($request);
    ...
    {
        switch($request->action){
            case 'get_datetime_musculoAssessment':
                return $this->get_datetime_musculoAssessment($request);
    ...
    public function add_musculoAssessment(Request $request){
        
        DB::beginTransaction();
        
        try {
            
            $musculoassessment = DB::table('hisdb.phy_musculoassessment')
            ...
            DB::table('hisdb.phy_musculoassessment')
                ->insert([
                    ...
                    'deep' => $request->deep,
                    'superficial' => $request->superficial,
    ...
    public function edit_musculoAssessment(Request $request){
        ...
        try {
            ...
            if(!empty($request->idno_musculoAssessment)){
                if($musculoassessment->exists()){
                    if($musculoassessment->first()->idno != $request->idno_musculoAssessment){
                        // throw new \Exception('Date already exist.', 500);
                        return response('Date already exist.');
                    }
                }
                ...
                DB::table('hisdb.phy_musculoassessment')
                    ->where('idno','=',$request->idno_musculoAssessment)
                    // ->where('mrn','=',$request->mrn)
                    // ->where('episno','=',$request->episno)
                    // ->where('compcode','=',session('compcode'))
                    ->update([
                ...
                DB::table('hisdb.phy_romaffectedside')
                    ->where('idno','=',$request->idno_affectedside)
                    // ->where('compcode','=',session('compcode'))
                    // ->where('mrn','=',$request->mrn)
                    // ->where('episno','=',$request->episno)
                    // ->where('entereddate','=',$request->entereddate)
                ...
                DB::table('hisdb.phy_romsoundside')
                    ->where('idno','=',$request->idno_soundside)
                    // ->where('compcode','=',session('compcode'))
                    // ->where('mrn','=',$request->mrn)
                    // ->where('episno','=',$request->episno)
                    // ->where('entereddate','=',$request->entereddate)
                ...
                DB::table('hisdb.phy_musclepower')
                    ->where('idno','=',$request->idno_musclepwr)
                    // ->where('compcode','=',session('compcode'))
                    // ->where('mrn','=',$request->mrn)
                    // ->where('episno','=',$request->episno)
                    // ->where('entereddate','=',$request->entereddate)
    ...
    public function get_table_musculoAssessment(Request $request){
        
        $musculoassessment_obj = DB::table('hisdb.phy_musculoassessment')
                                ->where('compcode','=',session('compcode'))
                                ->where('idno','=',$request->ma_idno);
                                // ->where('mrn','=',$request->mrn)
                                // ->where('episno','=',$request->episno);
        ...
        if($musculoassessment_obj->exists()){
            $musculoassessment_obj = $musculoassessment_obj->first();
            $responce->musculoassessment = $musculoassessment_obj;
        }
    ...
    public function get_datetime_musculoAssessment(Request $request){
        ...
        if($musculoassessment_obj->exists()){
            $musculoassessment_obj = $musculoassessment_obj->get();
            
            $data = [];
            
            foreach($musculoassessment_obj as $key => $value){
                $date['ma_idno'] = $value->ma_idno;
                $date['mrn'] = $value->mrn;
    ...
    public function musculoassessment_chart(Request $request){
