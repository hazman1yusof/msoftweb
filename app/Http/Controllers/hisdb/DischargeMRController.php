...
class DischargeMRController extends defaultController
{   
    ...
    {
        return view('hisdb.discharge_MR.discharge_MR');
    }    
    ...
    public function showpdf(Request $request){
        ...
        return view('hisdb.discharge_MR.discharge_pdfmake',compact('discharge'));
