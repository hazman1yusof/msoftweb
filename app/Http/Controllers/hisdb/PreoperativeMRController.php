...
class PreoperativeMRController extends defaultController
{
    ...
    {
        return view('hisdb.preoperative_MR.preoperative_MR');
    }
    ...
    public function add_preop(Request $request){
        DB::beginTransaction();
