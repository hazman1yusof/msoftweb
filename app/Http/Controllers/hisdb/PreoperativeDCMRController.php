...
class PreoperativeDCMRController extends defaultController
{
    ...
    {
        return view('hisdb.preoperativeDC_MR.preoperativeDC_MR');
    }
    ...
    public function form(Request $request)
    {
        ...
        switch($request->action){
            ...
            case 'add_preopDC_save':
                return $this->add_preopDC($request);
    ...
    public function add_preopDC(Request $request){
        DB::beginTransaction();
