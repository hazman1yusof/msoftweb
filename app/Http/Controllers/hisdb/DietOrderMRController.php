...
class DietOrderMRController extends defaultController
{
    ...
    {
        return view('hisdb.dietorder_MR.dietorder_MR');
    }
    ...
    public function dietorder_preview(Request $request){
        ...
        return view('hisdb.dietorder_MR.dietorder_preview_MR',compact('dietorder'));
