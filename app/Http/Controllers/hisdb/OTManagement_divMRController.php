...
class OTManagement_divMRController extends defaultController
{
    ...
    {
        return view('hisdb.otmanagement_MR.otmanagement_div_MR');
    }
    ...
    public function form(Request $request)
    {
        ...
        switch($request->action){
            ...
            case 'add_operRec_save':
                return $this->add_operRec($request);
    ...
    public function add_operRec(Request $request){
        DB::beginTransaction();
