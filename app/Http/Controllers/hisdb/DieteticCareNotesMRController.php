...
class DieteticCareNotesMRController extends defaultController
{
    ...
    {
        return view('hisdb.dieteticCareNotes_MR.dieteticCareNotes_MR');
    }
    ...
    public function form(Request $request)
    {
        ...
        switch($request->action){
            ...
            case 'addNotesDieteticCareNotes_save':
                return $this->add_notesDieteticCareNotes($request);
            default:
                return 'error happen..';
        }
    }
    ...
    public function add_notesDieteticCareNotes(Request $request){
        DB::beginTransaction();
