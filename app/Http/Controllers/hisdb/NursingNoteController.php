...
class NursingNoteController extends defaultController
{
    ...
    public function form(Request $request){
        ...
        switch($request->action){
            ...
            case 'addNotesInvChartFBC_save':
                return $this->add_notesInvChartFBC($request);
        
            case 'addNotesInvChartCoag_save':
                return $this->add_notesInvChartCoag($request);

            case 'addNotesInvChartRP_save':
                return $this->add_notesInvChartRP($request);
            
            case 'addNotesInvChartLFT_save':
                return $this->add_notesInvChartLFT($request);

            case 'addNotesInvChartElect_save':
                return $this->add_notesInvChartElect($request);

            case 'addNotesInvChartABGVBG_save':
                return $this->add_notesInvChartABGVBG($request);

            case 'addNotesInvChartUFEME_save':
                return $this->add_notesInvChartUFEME($request);

            case 'addNotesInvChartCE_save':
                return $this->add_notesInvChartCE($request);

            case 'addNotesInvChartCS_save':
                return $this->add_notesInvChartCS($request);

            case 'addNotesProgressIP_save':
                return $this->add_notesProgressIP($request);

            case 'addNotesIntake1_save':
                return $this->add_notesIntake1($request);

            case 'addNotesIntake2_save':
                return $this->add_notesIntake2($request);

            case 'addNotesIntake3_save':
                return $this->add_notesIntake3($request);
            ...
            case 'addNotesBladder1_save':
                return $this->add_notesBladder1($request);

            case 'addNotesBladder2_save':
                return $this->add_notesBladder2($request);

            case 'addNotesBladder3_save':
                return $this->add_notesBladder3($request);
    ...
    public function add_notesInvChartFBC(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartCoag(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartRP(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartLFT(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartElect(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartABGVBG(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartUFEME(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartCE(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesInvChartCS(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesProgressIP(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesIntake1(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesIntake2(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesIntake3(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesTreatmentP(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesBladder1(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesBladder2(Request $request){
        DB::beginTransaction();
    ...
    public function add_notesBladder3(Request $request){
        DB::beginTransaction();
