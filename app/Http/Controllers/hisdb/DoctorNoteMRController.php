...
class DoctorNoteMRController extends defaultController
{
    ...
    {
        return view('hisdb.doctornote_MR.doctornote_MR');
    }
    ...
    public function bpgraph(Request $request)
    {
        ...
        return view('hisdb.doctornote_MR.doctornote_bpgraph_MR',compact('pat'));
    }
