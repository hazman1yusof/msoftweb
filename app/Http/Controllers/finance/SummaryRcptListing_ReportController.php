...
{   
    ...
    public function showExcel(Request $request){
        return Excel::download(new SummaryRcptListingExport($request->datefr,$request->dateto,$request->tillcode,$request->tillno), 'SummaryRcptListingExport.xlsx');
    }
    ...
    public function showpdf(Request $request){
        ...
        return view('finance.AR.SummaryRcptListing_Report.SummaryRcptListing_Report_pdfmake',compact('dbacthdr','dbacthdr_rf','totalAmount','sum_cash','sum_chq','sum_card','sum_bank','sum_all','sum_cash_ref','sum_chq_ref','sum_card_ref','sum_bank_ref','sum_all_ref','grandtotal_cash','grandtotal_card', 'grandtotal_chq', 'grandtotal_all','title', 'title2','company','totamt_eng'));
