...
class ccupdateController extends defaultController
{
    ...
    {
        return view('finance.AR.ccupdate.ccupdate');
    }
    ...
    public function ccupdate(Request $request){
        ...
        try{
            ...
            if($gltran->exists()){
                ...
                $yearperiod = $this->getyearperiod($dbacthdr->entrydate);
            ...
            // $OldAmount = $gltran_first->amount;
            // $yearperiod = $this->getyearperiod($dbacthdr->entrydate);
            $drcostcode = $paymode->ccode;
            $dracc = $paymode->glaccno;
            $crcostcode = $gltran_first->crcostcode;
            $cracc = $gltran_first->cracc;
