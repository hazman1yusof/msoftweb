...
class SuppListSummary_ReportController extends defaultController
{   
    ...
    {   
        return view('finance.AP.SuppListSummary_Report.SuppListSummary_Report');
    }
    ...
    public function showpdf(Request $request){
        ...
        return view('finance.AP.SuppListSummary_Report.SuppListSummary_Report_pdfmake',compact('header', 'supp_code'));
    }
