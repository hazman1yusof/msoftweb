...
{   
    ...
    {   
        ...
        return view('finance.AR.refundListing_Report.refundListing_Report',[
    ...
    public function showpdf(Request $request){
        ...
        return view('finance.AR.refundListing_Report.refundListing_Report_pdfmake',compact('dbacthdr','paymode','totamt_eng','totalAmount'));
