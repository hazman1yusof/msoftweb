...
{   
    ...
    {   
        ...
        return view('finance.AR.chequeReceipt_Report.chequeReceipt_Report',[
    ...
    public function showpdf(Request $request){
        ...
        return view('finance.AR.chequeReceipt_Report.chequeReceipt_Report_pdfmake',compact('dbacthdr', 'dbacthdr_rf','totalAmount','sum_cash','sum_chq','sum_card','sum_bank','sum_all','sum_cash_ref','sum_chq_ref','sum_card_ref','sum_bank_ref','sum_all_ref','grandtotal_cash','grandtotal_card', 'grandtotal_chq', 'title','company','totamt_eng'));
