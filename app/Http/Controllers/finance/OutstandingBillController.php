...
use DateTime;
use Carbon\Carbon;
use App\Exports\OutstandingBillExport;
use App\Exports\OutstandingBillExport_main;
use Maatwebsite\Excel\Facades\Excel;

class OutstandingBillController extends defaultController
{
    ...
    public function show(Request $request)
    {
        ...
        return view('finance.AR.OutstandingBill_Report.OutstandingBill_Report',[
    ...
    public function showExcel(Request $request){
        return Excel::download(new OutstandingBillExport_main($request->datefr,$request->dateto), 'OutstandingBill.xlsx');
    }
