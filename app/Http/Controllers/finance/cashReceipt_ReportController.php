...
class cashReceipt_ReportController extends defaultController
{   
    ...
    {   
        ...
        return view('finance.AR.cashReceipt_Report.cashReceipt_Report',[
    ...
    public function showExcel(Request $request){
        return Excel::download(new CashReceiptExport($request->datefr,$request->dateto,$request->tillcode,$request->tillno), 'CashReceiptExport.xlsx');
    }
    ...
    public function showpdf(Request $request){
        ...
        return view('finance.AR.cashReceipt_Report.cashReceipt_Report_pdfmake',compact('dbacthdr', 'dbacthdr_rf','totalAmount','sum_cash','sum_chq','sum_card','sum_bank','sum_all','sum_cash_ref','sum_chq_ref','sum_card_ref','sum_bank_ref','sum_all_ref','grandtotal_cash','grandtotal_card', 'grandtotal_chq', 'title','company','totamt_eng'));
