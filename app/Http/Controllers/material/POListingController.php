    ...
    public function showpdf(Request $request){
        ...
        if ($Status == 'ALL'){
            ...
            $purordhd = DB::table('material.purordhd as h')
                        ->select('h.idno', 'h.compcode', 'h.recno', 'h.prdept', 'h.deldept', 'h.purordno', 'h.purdate', 'h.suppcode', 's.name as supp_name', 'h.recstatus', 'dp.description as dept_desc', 'dd.description as deldept_desc')
