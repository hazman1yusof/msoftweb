            ...
            DB::table('material.purreqdt')
                ->insert([
                   ...
                   // 'suppcode' => $request->suppcode,
                    ...
                    'qtyrequest' => floatval($request->qtyrequest),
                    'qtyapproved' => 0,
                    'qtybalance' => floatval($request->qtyrequest),
                    ...
                    'netunitprice' => floatval($request->netunitprice),
                    'amount' => floatval($request->amount),
                    'totamount' => floatval($request->totamount),
