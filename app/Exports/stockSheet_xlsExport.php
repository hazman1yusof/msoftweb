...
class stockSheet_xlsExport implements FromView, WithEvents, WithColumnWidths, WithColumnFormatting
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('material.stockBalance.stockSheet_excel',compact('unit','deptcode','array_report','period'));
    }
