...
class BankReceiptExport implements FromView, WithEvents, WithColumnWidths
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('finance.AR.bankReceipt_Report.bankReceipt_Report_excel',compact('dbacthdr','totalAmount','sum_cash','sum_chq','sum_card','sum_bank','sum_all','sum_cash_ref','sum_chq_ref','sum_card_ref','sum_bank_ref','sum_all_ref','grandtotal_cash','grandtotal_card', 'grandtotal_chq', 'grandtotal_all','title','company','totamt_eng'));
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('D1','AUTO DEBIT LISTING');
                ...
                $event->sheet->setCellValue('H7','RECEIPT NO');
