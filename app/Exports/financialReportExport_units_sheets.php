...
class financialReportExport_units_sheets implements FromView, WithEvents, WithColumnWidths,ShouldAutoSize, WithTitle
{
    ...
    */
    ...
    public function __construct($monthfrom,$monthto,$yearfrom,$yearto,$reporttype,$sector,$description)
    {
        ...
        $this->costcode = [];
        $this->tab_desc = $description;

        foreach ($sector as $key => $value) {
            array_push($this->costcode,$value->costcode);
        }
    }
            ...
            if($obj_rpt->rowdef == 'H'){
                ...
                foreach ($glcondtl as $key_con => $obj_con) {
                    ...
                    $glmasdtl = DB::table('finance.glmasdtl as gldt')
                            ...
                            ->whereIn('gldt.costcode',$this->costcode);
