...
class do_posted_report_no_invoice implements FromView, WithEvents, WithColumnWidths, WithColumnFormatting
{
    ...
    */
    ...
    public function view(): View{
        ...
        if($recstatus == 'POSTED'){
            $delordhd = $delordhd
                    ->whereDate('do_hd.postdate','>=',$datefr)
                    ->whereDate('do_hd.postdate','<=',$dateto);
        }else{
            $delordhd = $delordhd
