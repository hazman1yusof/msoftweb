...
class do_posted_report_with_gl implements FromView, WithEvents, WithColumnWidths, WithColumnFormatting
{
    ...
    */
    ...
    public function __construct($datefr,$dateto,$dept)
    {
    ...
    public function view(): View{
        ...
        return view('material.deliveryOrder.do_posted_report_excel_withGL',compact('do_hd'));
    }
