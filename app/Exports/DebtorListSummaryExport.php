...
class DebtorListSummaryExport implements FromView, WithEvents, WithColumnWidths
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('finance.AR.DebtorList_Report.DebtorListSummary_Report_excel', compact('debtormast'));
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getHeaderFooter()->setOddHeader('&C'.$this->comp->name."\DEBTOR LIST SUMMARY"."\n"
                .'&L'
