...
class RefundListingExport implements FromView, WithEvents, WithColumnWidths
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('finance.AR.refundListing_Report.refundListing_Report_excel',compact('dbacthdr','paymode','totalAmount','title','company','totamt_eng'));
    }
