...
<body>
					...
					<form class='form-horizontal' style='width:99%' id='formdata'>
						...
						<div class="form-group">
						  	...
						  	<label class="col-md-2 control-label" for="pvno">PV No</label>  
						  		<div class="col-md-3">
									<input id="pvno" name="pvno" type="text" maxlength="30" class="form-control input-sm">
						  		</div>
						</div>
						...
						<div class="form-group">
						  	<label class="col-md-2 control-label" for="actdate">Payment Date</label>  
						  		<div class="col-md-2">
									<input id="actdate" name="actdate" type="date" maxlength="12" class="form-control input-sm">
						  		</div>
					    ...
					    <div class="form-group">
					    	<label class="col-md-2 control-label" for="cheqdate">Date</label>  
							  	<div class="col-md-2">
									<input id="cheqdate" name="cheqdate" type="date" maxlength="12" class="form-control input-sm">
							  	</div>

							 <label class="col-md-2 control-label" for="amount">Amount</label>  
							  	<div class="col-md-2">
										<input id="amount" name="amount" maxlength="12" class="form-control input-sm" data-sanitize="numberFormat" data-sanitize-number-format="0,0.00" value="0.00">  <!--data-validation-allowing="float" -->
				 				</div>
					    </div>
					    ...
					    <div class="form-group">
					    	...
					    	<div class="col-md-3"> 
					    	<textarea wrap="hard" class="col-md" rows="5" cols="35" id="remarks" name="remarks" type="text" maxlength="100">
					    	</textarea>
					    	</div>
					    </div>
	...
	<!-- JS Page Level-->
	<script src="DirectPayment2.js"></script>
