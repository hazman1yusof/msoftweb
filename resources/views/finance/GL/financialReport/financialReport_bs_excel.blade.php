<table>
    ...
    @foreach ($excel_data as $obj_ar)
        ...
        @elseif($obj_ar['rowdef'] == 'T' || $obj_ar['rowdef'] == 'T0')
            ...
            <td ></td>
            @if($obj_ar['revsign'] == 'Y')
            <td style="font-weight:bold;text-align: right;">{{abs($obj_ar['tot_arr']['curr_month'])}}</td>
            <td style="font-weight:bold;text-align: right;">{{abs($obj_ar['tot_arr']['last_month'])}}</td>
            @else
        ...
        @elseif($obj_ar['rowdef'] == 'D')
            <tr>
                ...
                @if($obj_ar['revsign'] == 'Y')
                <td style="text-align: right;">{{abs($obj_ar['curr_month'])}}</td>
                <td style="text-align: right;">{{abs($obj_ar['last_month'])}}</td>
                @else
