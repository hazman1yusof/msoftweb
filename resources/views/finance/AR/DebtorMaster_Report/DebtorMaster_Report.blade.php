...
@section('title', 'Debtor Master Report')

@section('body')
<div class="container">
	<div class="jumbotron" style="margin-top: 30px;text-align: center;">
		<form method="get" id="genreport" action="./DebtorMaster_Report/showExcel">
		<h2>DEBTOR MASTER REPORT</h2>
...
@section('scripts')
	...
	<script src="js/finance/AR/DebtorMaster_Report/DebtorMaster_Report.js"></script>
