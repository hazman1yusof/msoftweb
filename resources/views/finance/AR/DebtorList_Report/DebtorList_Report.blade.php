                            ...
                            <div class="panel-body">
                                <div class='col-md-12 btnform' style="padding: 20px 0px">
                                    <fieldset>
                                        ...
                                        <button name="DebtorListSummary_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="summary_pdf">
                                            <span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
                                        </button>
                                        <button name="DebtorListSummary_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="summary_excel">
                                            <span class="fa fa-file-excel-o fa-lg"></span> Generate Report Excel
                                        </button>
                                        
                                        <legend>Details :</legend>
                                        <button name="DebtorListDtl_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="dtl_pdf">
                                            <span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
                                        </button>
                                        <button name="DebtorListDtl_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="dtl_excel">
                                            <span class="fa fa-file-excel-o fa-lg"></span> Generate Report Excel
                                        </button>
                                    </fieldset>
                                </div>
...
@section('scripts')
    <script src="js/finance/AR/DebtorList_Report/DebtorList_Report.js"></script>
@endsection