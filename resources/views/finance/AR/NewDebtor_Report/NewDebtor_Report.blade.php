...
@section('title', 'New Debtor Created')
...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 350px;">
            <form method="get" id="genreport" action="./NewDebtor_Report/showExcel">
                <h4>NEW DEBTOR CREATED</h4>
                <h7 style="padding:3% 10% 3% 10%; letter-spacing: 1px;line-height: 1.5"> </h7>
				
				<div style="width: 800px;margin: 0 auto;">
					<div class="col-md-4" style="margin-left: 120px;">
						<div class="col-md-12">
							<label class="control-label" for="Scol">Year From</label>
						...
						<div class="col-md-12" style="padding-top: 30px;">
							<label class="control-label" for="Scol">Year To</label>
							...
							<div class="panel-body">
								<div class='col-md-12 btnform' style="padding: 20px 0px">
									<fieldset>
										...
										<button name="NewDebtor_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="pdfgen1">
											<span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
										</button>
										<button name="NewDebtor_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="excelgen1">
	...
	<!-- <div class="container">
		<div class="jumbotron" style="margin-top: 30px;text-align: center;">
			...
			<form method="get" id= "genreportpdf" href="" target="_blank" action="./NewDebtor_Report/showpdf?">
...
@section('scripts')
	<script src="js/finance/AR/NewDebtor_Report/NewDebtor_Report.js"></script>
@endsection