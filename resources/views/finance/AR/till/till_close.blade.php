						...
						<div class="panel-body">
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="CashCollected">Cash</label>  
									<div class="col-md-3">
										<input id="CashCollected" name="CashCollected" type="text" class="form-control input-sm" value="@if(!empty($sum_cash)){{$sum_cash}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>

								<label class="col-md-2 control-label" for="CashRefund">Cash</label>  
									<div class="col-md-3">
										<input id="CashRefund" name="CashRefund" type="text" class="form-control input-sm" value="@if(!empty($sum_cash_ref)){{$sum_cash_ref}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>
							</div>
						</div>
						...
						<div class="panel-body">
							<div class="form-group">
								<label class="col-md-2 control-label" for="ChequeCollected">Cheque</label>  
									<div class="col-md-3">
										<input id="ChequeCollected" name="ChequeCollected" type="text" class="form-control input-sm" value="@if(!empty($sum_chq)){{$sum_chq}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>

								<label class="col-md-2 control-label" for="ChequeRefund">Cheque</label>  
									<div class="col-md-3">
										<input id="ChequeRefund" name="ChequeRefund" type="text" class="form-control input-sm" value="@if(!empty($sum_chq_ref)){{$sum_chq_ref}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>
							</div>
						</div>
						...
						<div class="panel-body">
							<div class="form-group">
								<label class="col-md-2 control-label" for="CardCollected">Card</label>  
									<div class="col-md-3">
										<input id="CardCollected" name="CardCollected" type="text" class="form-control input-sm" value="@if(!empty($sum_card)){{$sum_card}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>

								<label class="col-md-2 control-label" for="CardRefund">Card</label>  
									<div class="col-md-3">
										<input id="CardRefund" name="CardRefund" type="text" class="form-control input-sm" value="@if(!empty($sum_card_ref)){{$sum_card_ref}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>
							</div>
						</div>
						...
						<div class="panel-body">
							<div class="form-group">
								<label class="col-md-2 control-label" for="DebitCollected">Auto Debit</label>  
									<div class="col-md-3">
										<input id="DebitCollected" name="DebitCollected" type="text" class="form-control input-sm" value="@if(!empty($sum_bank)){{$sum_bank}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>

								<label class="col-md-2 control-label" for="DebitRefund">Auto Debit</label>  
									<div class="col-md-3">
										<input id="DebitRefund" name="DebitRefund" type="text" class="form-control input-sm" value="@if(!empty($sum_bank_ref)){{$sum_bank_ref}}@else{{number_format(0.00,2)}}@endif" style='text-align:right' readonly>
								</div>
								<br><br>
							</div>
						...
						<div class="panel-body">
							<div class="form-group">
								<label class="col-md-2 control-label" for="cashCloseBal">Cash Closing <br>Balance</label>  
									<div class="col-md-3">
										<input id="cashBal" name="cashBal" type="text" class="form-control input-sm" value="0.00" style='text-align:right' readonly>
						...
						<div class="panel-body">
							<div class="form-group">
								<label class="col-md-2 control-label" for="actclosebal">Actual Closing<br>Balance</label>  
									<div class="col-md-3">
										<input id="actclosebal" name="actclosebal" type="text" class="form-control input-sm" value="0.00" style='text-align:right' readonly>
								</div>

								<label class="col-md-2 control-label" for="discrepancy">Discrepancy</label>  
									<div class="col-md-3">
										<input id="discrepancy" name="discrepancy" type="text" class="form-control input-sm" value="0.00" style='text-align:right' readonly>
								</div>
							</div>
						</div>
