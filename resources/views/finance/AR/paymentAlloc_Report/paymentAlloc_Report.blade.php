...
@section('title', 'Payment Allocation Listing')
...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 500px;">
            <form method="get" id="genreport" action="./paymentAlloc_Report/showExcel">
                <h3>PAYMENT ALLOCATION LISTING</h3>
							...
							<div class="panel-body">
								<div class='col-md-12 btnform' style="padding: 20px 0px">
									<fieldset>
										...
										<button name="paymentAlloc_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="pdfgen1">
											<span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
										</button>
										<button name="paymentAlloc_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="excelgen1">
    ...
    <!-- <div class="container">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;">
            <form method="get" id="genreport" action="./paymentAlloc_Report/showExcel">
                <h2>PAYMENT ALLOCATION LISTING</h2>
                <h4 style="padding:3% 10% 3% 10%; letter-spacing: 1px;line-height: 1.5"> </h4>
            ...
            <form method="get" id= "genreportpdf" href="" target="_blank" action="./paymentAlloc_Report/showpdf?">
...
@section('scripts')
    <script src="js/finance/AR/paymentAlloc_Report/paymentAlloc_Report.js"></script>
@endsection