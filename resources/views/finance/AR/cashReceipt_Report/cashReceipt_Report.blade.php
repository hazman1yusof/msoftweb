							...
							<div class="panel-body">
								<div class='col-md-12 btnform' style="padding: 20px 0px">
									<fieldset>
										...
										<button name="cashReceipt_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="pdfgen1">
											<span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
										</button>
										<button name="cashReceipt_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="excelgen1">
...
@section('scripts')
	<script src="js/finance/AR/cashReceipt_Report/cashReceipt_Report.js"></script>
@endsection