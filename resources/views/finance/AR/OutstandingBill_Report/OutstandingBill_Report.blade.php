	...
	<script>
		$(document).ready(function () {
		    ...
		    $("#pdfgen1").click(function() {
		        window.open('./OutstandingBill_Report/showpdf?datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val(), '_blank');
		    });
		    
		    $("#excelgen1").click(function() {
		        window.open('./OutstandingBill_Report/table?action=showExcel&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val(), '_blank');
