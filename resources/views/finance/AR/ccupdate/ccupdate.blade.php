...
@section('title', 'Credit Card Update')
...
@section('body')
	...
	<div class='row'>
		...
		<div class="panel panel-default">
			<div class="panel-heading">Credit Card Update
	...
	<div id="dialogForm_updcc" title="Update Form">
		<div class='panel panel-info'>
			<div class="panel-heading">Update Credit Card</div>
			<div class="panel-body" style="position: relative;padding-bottom: 0px !important">
				<form class='form-horizontal' style='width:99%' id="formdata_updcc">
					<input name="db_idno" type="hidden">
					<div class='col-md-12'>
						<label class="control-label">Receipt No</label>
						<input name="db_recptno" type="text" class="form-control input-sm text-uppercase" rdonly readonly>
					</div>
					<div class='col-md-12'>
						<label class="control-label">Date</label>
						<input name="db_posteddate" type="text" class="form-control input-sm text-uppercase" rdonly readonly>
					</div>
					<div class='col-md-12'>
						<label class="control-label">Payer</label>
						<input name="db_payercode" type="text" class="form-control input-sm text-uppercase" rdonly readonly>
						<span class="help-block db_payercode"></span>
					</div>
					<div class='col-md-12'>
						<label class="control-label">Amount</label>
						<input name="db_amount" type="text" class="form-control input-sm text-uppercase" rdonly readonly>
					</div>
					<div class='col-md-12' style="margin-bottom: 30px;">
						<label class="control-label">Paymode</label>
						<div class='input-group'>
							<input name="db_paymode" type="text" class="form-control input-sm" data-validation="required" data-validation-error-msg="Please Enter Value"/>
							<a class='input-group-addon btn btn-primary'><span class='fa fa-ellipsis-h'></span></a>
						</div>
					</div>
				</form>
