...
@section('title', 'Debit Note Category Finance')
...
<div class='row'>
		<form id="searchForm" class="formclass" style='width:99%; position:relative'>
		 ...
		 <div class="panel panel-default">
		    <div class="panel-heading">Debit Note Category Finance Setup Header</div>
...
@section('scripts')
	...
	<script src="js/finance/AR/DebitNoteCategory/DebitNoteCategory.js"></script>
