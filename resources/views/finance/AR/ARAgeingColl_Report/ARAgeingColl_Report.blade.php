...
@section('title', 'AR Ageing Collection')
...
@section('body')
    ...
    <h4 style="text-align: center;">AR AGEING COLLECTION</h4>
    <div class="col-md-6">
                ...
                <div class="col-md-5" >
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <input id="date_from" name="date_from" type="date" class="form-control input-sm" data-validation="required" value="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12" style="padding-top: 10px;">
                            ...
                            <input id="date_to" name="date_to" type="date" class="form-control input-sm" data-validation="required" value="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                        </div>
                    </div>
                ...
                <div class="col-md-6" style="padding-top: 30px;">
                    <div class="panel panel-default" style="height: 137px;">
                        <div class="panel-body">
                            ...
                            <input type="radio" id="sortbydt" name="groupby" value="debtorcode" checked>
                            <label for="sortbydt">By Debtor Code</label>
...
@section('scripts')
    <script src="js/finance/AR/ARAgeingColl_Report/ARAgeingColl_Report.js?v=1.2"></script>
