...
@section('title', 'Receipt Trans Report')

@section('body')
<div class="container">
	<div class="jumbotron" style="margin-top: 30px;text-align: center;">
		<form method="get" id="genreport" action="/ReceiptAR_Report/showExcel">
		<h2>RECEIPT AR REPORT</h2>
...
@section('scripts')
	...
	<script src="js/finance/AR/ReceiptAR_Report/ReceiptAR_Report.js"></script>
