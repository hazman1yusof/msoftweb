...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 350px;">
            <form method="get" id="genreport" action="./SalesListing_Report/showExcel">
                <h4>SALES LISTING</h4>
							...
							<div class="panel-body">
								<div class='col-md-12 btnform' style="padding: 20px 0px">
									<fieldset>
										...
										<button name="SalesListing_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="pdfgen1">
											<span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
										</button>
										<button name="SalesListing_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="excelgen1">
	...
	<!-- <div class="container">
		<div class="jumbotron" style="margin-top: 30px;text-align: center;">
			...
			<form method="get" id= "genreportpdf" href="" target="_blank" action="./SalesListing_Report/showpdf?">
...
@section('scripts')
	<script src="js/finance/AR/SalesListing_Report/SalesListing_Report.js"></script>
@endsection