...
@section('body')
							...
							<div class="panel-body">
								<div class='col-md-12 btnform' style="padding: 20px 0px">
									<fieldset>
										...
										<button name="chequeReceipt_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="pdfgen1">
											<span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
										</button>
										<button name="chequeReceipt_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="excelgen1">
	...
	<!-- <div class="container">
		<div class="jumbotron" style="margin-top: 30px;text-align: center;">
			...
			<form method="get" id= "genreportpdf" href="" target="_blank" action="./chequeReceipt_Report/showpdf?">
...
@section('scripts')
	<script src="js/finance/AR/chequeReceipt_Report/chequeReceipt_Report.js"></script>
@endsection