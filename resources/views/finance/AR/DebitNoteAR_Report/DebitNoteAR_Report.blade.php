...
@section('title', 'Debit Note AR Report')
...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 500px;">
            <form method="get" id="genreport" action="./DebitNoteAR_Report/showExcel">
                <h3>DEBIT NOTE AR REPORT</h3>
							...
							<div class="panel-body">
								<div class='col-md-12 btnform' style="padding: 20px 0px">
									<fieldset>
										...
										<!-- <button name="DebitNoteAR_pdf" type="button" class="mybtn btn btn-sm mybtnpdf" id="pdfgen1">
											<span class="fa fa-file-pdf-o fa-lg"></span> Generate Report PDF
										</button> -->
										<button name="DebitNoteAR_xls" type="button" class="mybtn btn btn-sm mybtnxls" id="excelgen1">
...
@section('scripts')
	<script src="js/finance/AR/DebitNoteAR_Report/DebitNoteAR_Report.js"></script>
@endsection