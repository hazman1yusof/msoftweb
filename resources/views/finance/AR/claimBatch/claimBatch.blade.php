  ...
  <div class="row">
		<div class="col-md-12">
			<div class="panel panel-default" style="width: 90%;margin: auto;">
				<div class="panel-heading" >Claim Batch
				...
				<div class="panel-body" style="padding-left: 35px !important;">
					<div class='col-md-12 btnform' style="padding:0px">
					 	<form id="formdata">
						 	...
						 	<div class="col-md-10">
							 	<label for="monthto">Debtor Code</label>
	              ...
	              <span class="help-block"></span>
						 	...
						 	<div class="col-md-4" style="padding-top: 10px;">
								...
								<input name='datefr' id='datefr' type="date" class="form-control" data-validation="required" value="{{ now()->toDateString() }}">
							</div>

						 	<div class="col-md-4" style="padding-top: 10px;">
							 	<label for="monthfrom">Date To</label>
								<input name='dateto' id='dateto' type="date" class="form-control" data-validation="required" value="{{ now()->toDateString() }}">
							</div>

						 	<div class="col-md-4" style="padding-top: 10px;">
							 	<label for="datesend">Date Send</label>
								<input name='datesend' id='datesend' type="date" class="form-control" data-validation="required" value="{{ now()->toDateString() }}">
							</div>
...
@section('scripts')
<script src="js/finance/AR/claimBatch/claimBatch.js?v=1.1"></script>
@endsection