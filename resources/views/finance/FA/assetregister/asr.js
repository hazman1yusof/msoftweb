			...
			$("#gridDialog").jqGrid({
				...
				ondblClickRow: function(rowid, iRow, iCol, e){
					...
					if(selText=="#assetcode"){
						...
						$('#description').val(data.desc);  ///remarks
					...
					switch(id){
						...
						case '#itemcode':
							if($("input[name=regtype]:checked").val() == "P"){
								...
								paramD.field=['product.itemcode','product.description','delorddt.qtydelivered','delorddt.amount','delorddt.remarks','delorddt.itemcode','delorddt.lineno_','delorddt.idno'];  //remarks, not description
								...
								$("#gridDialog").jqGrid('hideCol',["holder5","holder2"]);
								}
							else{
						...
						default:
							...
							$("#gridDialog").jqGrid('setLabel','code','Code');
							$("#gridDialog").jqGrid('setLabel','desc','Description');
							$("#gridDialog").jqGrid('hideCol',["holder1","holder3","holder5","holder2"]);
							break;
					}
