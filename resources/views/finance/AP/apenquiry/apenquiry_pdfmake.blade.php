        ...
        $(document).ready(function () {
            var docDefinition = {
                ...
                content: [
                    ...
                    {
                        text: '\nFROM {{\Carbon\Carbon::parse($header->datefrom)->format('d/m/Y')}} TO {{\Carbon\Carbon::parse($header->dateto)->format('d/m/Y')}}\n',
                        alignment: 'center',
                        fontSize: 10,
                    },
                    {
                        text: '\nFROM {{($header->suppcode_from)}} TO {{($header->suppcode_to)}}\n',
                        alignment: 'center',
                        fontSize: 10,
                    },
                    {
