...
@section('body')
	<div class="container mycontainer">
		<div class="jumbotron" style="margin-top: 30px;text-align: center; height:500px">
			<form method="get" class='form-horizontal' style='width:99%' id="genreport" action="./APSummary_Report/showExcel">
				<h2>AP SUMMARY</h2>
...
@section('scripts')
	<script src="js/finance/AP/APSummary_Report/APSummary_Report.js"></script>
@endsection