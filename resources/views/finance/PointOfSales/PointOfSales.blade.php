...
@section('body')
					...
					<div id="div_for_but_post" class="col-md-6 col-md-offset-6" style="padding-top: 20px; text-align: end;">
						...
						type="button" 
							...
							@if (strtoupper(Request::get('scope')) == 'ALL')
								{{'POSTED'}}
							@elseif (strtoupper(Request::get('scope')) == 'RECOMPUTED')
								{{'RECOMPUTE'}}
							@else
								{{Request::get('scope')}}
							@endif
    	...
    	<div class="panel-heading clearfix collapsed" data-toggle="collapse" href="#jqGrid3_panel">
	    	...
	    	<i class="fa fa-angle-double-up" style="font-size:24px;margin: 0 0 0 12px"></i>
				...
				<div class="pull-right" style="position: absolute; padding: 0 0 0 0; right: 50px; top: 10px;">
					<h5>Point of Sales Data Entry Detail</h5>
				</div>
			</div>
	...
	<div id="dialogForm" title="Add Form" >
			...
			<div class="panel-body" style="position: relative;padding-bottom: 0px !important">
				<form class='form-horizontal' style='width:99%' id='formdata'>
					...
					<div class="form-group data_info">
						...
						<div class="col-md-2 minuspad-15">
							<label class="control-label" for="db_approvedby">Posted By</label>
						...
						<div class="col-md-2 minuspad-15">
							<label class="control-label" for="db_approveddate">Posted Date</label>
		...
		<div class='panel panel-info'>
			<div class="panel-heading">Point of Sales Detail</div>
				<div class="panel-body">
					<div id="fail_msg"></div>
...
@section('scripts')
	<script type="text/javascript">
		...
		<script src="js/finance/PointOfSales/PointOfSales.js?v=1.5"></script>
