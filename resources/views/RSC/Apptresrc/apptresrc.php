...
<body>
  ...
  <div id="dialogForm" title="Add Form" >
      <form class='form-horizontal' style='width:99%' id='formdata'>
        ...
        <label class="col-md-2 control-label" for="type">Interval Time (minute)</label>    
          <div class="col-md-4">
                <div class='input-group'>
            <input id="intervaltime" name="intervalTime" type="integer" class="form-control input-sm" data-validation="number, required">
            </div>
          </div> 
...
<script src="apptresrc.js"></script>
