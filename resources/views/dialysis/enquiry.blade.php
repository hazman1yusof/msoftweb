...
@section('content')
    ...
    <div class="panel panel-default" style="position: relative;margin: 10px 0px 10px 0px" id="tab_absent_panel">
        ...
        <div id="tab_absent" class="panel-collapse collapse">
            <div class="panel-body paneldiv" style="position: relative;">
                @include('dialysis.absent_record')
            </div>
        </div>
    </div>
    ...
    <!-- <div class="panel panel-default" style="position: relative;margin: 10px 0px 10px 0px" id="tab_userlog_panel">
        ...
        <div id="tab_userlog" class="panel-collapse collapse">
            <div class="panel-body paneldiv" style="position: relative;">
                @include('dialysis.user_activity_log')
            </div>
        </div>
    </div> -->
...
@section('js')
	...
	<script type="text/javascript" src="{{ asset('dialysis/js/enquiry_main.js') }}?v=3.1"></script>
    <script type="text/javascript" src="{{ asset('dialysis/js/blood_test_result.js') }}?v=3"></script>
    <script type="text/javascript" src="{{ asset('dialysis/js/enquiry.js') }}?v=4.1"></script>
    <script type="text/javascript" src="{{ asset('dialysis/js/absent.js') }}?v=1"></script>
@endsection
