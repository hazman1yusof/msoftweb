...
<html>
    <head>
        <title>Cardiorespiratory Assessment</title>
    </head>
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    {
                                        text: [
                                            ...
                                            { text: `\n\n{!!$cardiorespassessment->subjectiveAssessmt!!}\n\n` },
                                        ],
                                    },
                                ],
                                [
                                    {
                                        text: [
                                            ...
                                            { text: `\n\n{!!$cardiorespassessment->objectiveAssessmt!!}\n\n` },
                                        ],
                                    },
                                ],
                                [
                                ...
                                [
                                    {
                                        text: [
                                            { text: '\nANALYSIS', decoration: 'underline', bold: true },
                                            { text: `\n\n{!!$cardiorespassessment->analysis!!}\n\n` },
                                        ],
                                    },
                                ],
                                [
                                    {
                                        text: [
                                            ...
                                            { text: `\n\n{!!$cardiorespassessment->intervention!!}\n\n` },
                                        ],
                                    },
                                ],
                                [
                                    {
                                        text: [
                                            ...
                                            { text: `\n\n{!!$cardiorespassessment->homeEducation!!}\n\n` },
                                        ],
                                    },
                                ],
                                [
                                    {
                                        text: [
                                            ...
                                            { text: `\n\n{!!$cardiorespassessment->evaluation!!}\n\n` },
                                        ],
                                    },
                                ],
                                [
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    {
                                        text: [
                                            { text: '\nADDITIONAL NOTES: ', decoration: 'underline', bold: true },
                                            { text: `\n\n{!!$cardiorespassessment->additionalNotes!!}\n\n` },
                                        ],
                                    },
                                ],
                            ]
    ...
    <body style="margin: 0px;">
        ...
        <div class="ui segments" style="width: 18vw; height: 95vh; float: left; margin: 10px; position: fixed;">
            ...
            <div class="ui segment teal inverted canclick" style="cursor: pointer;" data-goto='#pdfiframe'>
                <p>Cardiorespiratory Assessment</p>
            </div>
            @if($attachment_files != '')
