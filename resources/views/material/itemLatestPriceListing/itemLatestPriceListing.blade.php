...
@section('title', 'Item`s Latest Price Listing')
...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 350px;">
            <form method="get" id="genreport" action="./itemLatestPriceListing/showExcel">
                <h4>ITEM'S LATEST PRICE LISTING</h4>
...
@section('scripts')
	<script src="js/material/itemLatestPriceListing/itemLatestPriceListing.js"></script>
@endsection