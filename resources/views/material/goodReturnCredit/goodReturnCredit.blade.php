...
@section('title', 'Good Return Credit')
@section('style')
...
@section('body')
	...
	<div class='row'>
        ...
        <div class="panel panel-default">
		    	<div class="panel-heading">Good Return Credit Data Entry Header
 ...
 -->
	    <div class="panel panel-default" style="position: relative;" id="jqGrid3_c">
			<div class="panel-heading clearfix collapsed" data-toggle="collapse" data-target="#jqGrid3_panel">
				...
				<div class="pull-right" style="position: absolute; padding: 0 0 0 0; right: 50px; top: 10px;">
					<h5>Good Return Credit Data Entry Detail</h5>
				</div>
			</div>
	...
	<div id="dialogForm" title="Add Form" >
		<div class='panel panel-info'>
			...
			<div class='panel panel-info'>
				<div class="panel-heading">Good Return Credit Detail</div>
					<div class="panel-body">
...
@section('scripts')
	...
	<script src="js/material/goodReturnCredit/goodReturnCredit.js?v=1.7"></script>
