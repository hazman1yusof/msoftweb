...
<body>
        	...
        	<form class='form-horizontal' style='width:99%' id='Fsuppitems'>
            	...
            	<div class="form-group">
                 ...
                 <div class="form-group">
				  	<label class="col-md-4 control-label" for="si.purqty">Purchase Quantity</label>  
				  		<div class="col-md-4">
				  		<input id="si.purqty" name="si.purqty" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
				  		</div>
                </div>	
                ...
                <div class="form-group">
				  	<label class="col-md-4 control-label" for="si.unitprice">Unit Price</label>  
				  		<div class="col-md-4">
				  		<input id="si.unitprice" name="si.unitprice" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
				  		</div>
                </div>
                ...
                <div class="form-group">
				  	<label class="col-md-4 control-label" for="si.perdiscount">Percentage of Discount</label>  
				  		<div class="col-md-4">
				  		<input id="si.perdiscount" name="si.perdiscount" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
				  		</div>
                </div>
                ...
                <div class="form-group">
				  	<label class="col-md-4 control-label" for="si.amtdisc">Amount Discount</label>  
				  		<div class="col-md-4">
				  		<input id="si.amtdisc" name="si.amtdisc" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
				  		</div>
                </div>	
                ...
                <div class="form-group">
				  	<label class="col-md-4 control-label" for="si.perslstax">Percentage of Sales Tax</label>  
				  		<div class="col-md-4">
				  		<input id="si.perslstax" name="si.perslstax" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
				  		</div>
                </div>
                ...
                <div class="form-group">
				  	<label class="col-md-4 control-label" for="si.amtslstax">Amount Sales Tax</label>  
				  		<div class="col-md-4">
				  		<input id="si.amtslstax" name="si.amtslstax" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
				  		</div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
				  	<label class="col-md-4 control-label" for="sb.bonqty">Bonus Quantity</label>  
				  		<div class="col-md-4">
				  		<input id="sb.bonqty" name="sb.bonqty" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
				  		</div>
                </div>	
	...
	<!-- JS Page Level -->
	<script src="supplier1.js"></script>
