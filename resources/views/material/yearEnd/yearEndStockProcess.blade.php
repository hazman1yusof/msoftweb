  ...
  <div class="row">
	<div class="col-md-9">
		<div class="panel panel-default">
			<div class="panel-heading">Update the Stock Location Opening Balance (NEW YEAR RECORD)</div>
			<div class="panel-body">
				<form class='form-horizontal' style='width:99%' id='formdata'>
					{{ csrf_field() }}
					<input id="action" name="action" type="hidden" value="yearEndProcess_form">
					...
					<div class="form-group">
						<div class="col-md-12">
						  	<label class="control-label" for="Scol">Closing Balance to be carried forward</label>  
					  		<select id='year' name='year' class="form-control input-sm" tabindex="1"></select>
					  	</div>
					</div>
				</form>
			</div>
	...
	<div class="col-md-3">
		<div class="panel panel-default" style="height: 276px;">
			<div class="panel-body">
...
@section('scripts')
	...
	<script src="js/material/YearEnd/yearEndStockProcess.js"></script>
