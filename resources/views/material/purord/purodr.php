	...
	<div id="dialogForm" title="Add Form" >
		<form class='form-horizontal' style='width:99%' id='formdata'>
			...
			<div class="form-group">
				<label class="col-md-2 control-label" for="tillcode">Rec No</label>  
					<div class="col-md-4">
						<input id="recno" name="recno" type="text" maxlength="30" class="form-control input-sm text-uppercase" data-validation="required" frozeOnEdit>
					</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input id="purdate" name="purdate" type="date" class="form-control input-sm" data-validation="required">
				</div>
		...
		<fieldset style="border:3px; border-top:1px solid black;">
	       ...
	       font-size:16px !important; font-weight: bold;">PO Detail Items</legend>
	    </fieldset>
	    ...
	    <div class='row'>
			...
			<button id='sbut2' class='btn btn-default btn-xs' style=''><i></i> Search</button>style="padding:0 0 15px 0"-->
	        <div id='gridSuppitems_c' class='col-md-12' >
