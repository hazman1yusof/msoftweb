            ...
            var docDefinition = {
                ...
                content: [
                    ...
                    },
                    {
                        ...
                        table: {
                            headerRows: 1,
                            widths: [50,50,60,250,50,50,50,50],  //panjang standard dia 515
                            body: [
                                [
                                    {text: 'UNIT', style: 'tableHeader'},
                                    {text: 'DEPT CODE', style: 'tableHeader'},
                                    ...
                                    {text: 'BALANCE QTY', style: 'tableHeader', alignment: 'right'},
                                ...
                                [
                                    ...
                                    {text: '{{$obj->deptcode}}'},
                                    {text: '{{$obj->itemcode}}'},
                                    {text: `{!!str_replace('`', '', $obj->p_desc)!!}`},
                                    {text: `{!!$obj->uomcode!!}`},
                                    {text:'{{\Carbon\Carbon::createFromFormat('Y-m-d',$obj->expdate)->format('d-m-Y')}}'},
                                    {text: '{{$obj->batchno}}', alignment: 'left'},
                                    {text: '{{$obj->balqty}}', alignment: 'right'},
