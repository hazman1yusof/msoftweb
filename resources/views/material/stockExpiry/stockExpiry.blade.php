...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 350px;">
            <form method="get" id="genreport" action="./stockExpiry/showExcel">
                <h4>STOCK EXPIRY</h4>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class='input-group'>
                                        <input id="item_from" name="item_from" type="text" class="form-control input-sm" autocomplete="off" value="">
...
@section('scripts')
	<script src="js/material/stockExpiry/stockExpiry.js"></script>
@endsection