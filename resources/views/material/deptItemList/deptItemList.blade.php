...
@section('title', 'Departmental Item List')
...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 350px;">
            <form method="get" id="genreport" action="./deptItemList/showExcel">
                <h4>DEPARTMENTAL ITEM LIST</h4>
                <h7 style="padding:3% 10% 3% 10%; letter-spacing: 1px;line-height: 1.5"> </h7>
				
				<div style="width: 800px;margin: 0 auto;">
					<div class="col-md-4" style="margin-left: 120px;">
						<div class="col-md-12">
							<label class="control-label" for="Scol">Dept Code From</label>
						...
						<div class="col-md-12" style="padding-top: 30px;">
							<label class="control-label" for="Scol">Dept Code To</label>
                            <div class='input-group'>
...
@section('scripts')
	<script src="js/material/deptItemList/deptItemList.js"></script>
@endsection