	...
	<script>
		...
		$(document).ready(function () {
			...
			$("#jqGrid").jqGrid({
				...
				datatype: "json",
				 colModel: [
					...
					{label: 'UOM Code', name: 'uomcode', width: 90 , editable: true, classes: 'wrap', checked:
					true, canSearch: true,
					...
					{label: 'Conversion Factor', name: 'convfactor', width: 90, editable: true, 
					classes: 'wrap', 
					editrules:{required: true}},
					
					{label: 'Add User', name: 'adduser', width: 90 , hidden: true},
					
					{label: 'Add Date', name: 'adddate', width: 90 , hidden: true},
					
					{label: 'Update User', name: 'upduser', width: 90 , hidden: true},
					
					{label: 'Update Date', name: 'upddate', width: 90 ,  hidden: true},
					
					{label: 'Delete User', name: 'deluser', width: 90 ,  hidden: true},
					
					{label: 'Delete Date', name: 'deldate', width: 90 , hidden: true},
			...
			function saveFormdata(oper){
				$.post( "UOMSave.php", $( "#formdata" ).serialize()+'&'+$.param({ 'oper': oper }) , function( data ) {
			...
			function search(Stext,Scol){
				$("#jqGrid").jqGrid('setGridParam',{datatype:'json',url:'UOMTbl.php?Scol='+Scol+'&Stext='+Stext}).trigger('reloadGrid');
			}
     ...
     <meta charset="utf-8" />
    <title>Material - Unit Of Measurement</title>
</head>
	...
	<div class="container" style="margin-bottom:1em">
        ...
        <div id="dialogForm" title="Dialog Form" >
            ...
            <div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="uomcode" name="uomcode" type="text" maxlength="12" class="form-control input-sm" data-validation="required" >
				  </div>
                 ...
                 <div class="form-group">
				  <label class="col-md-2 control-label" for="convfactor">Conversion Factor</label>  
				  <div class="col-md-4">
				  <input id="convfactor" name="convfactor" type="text" class="form-control input-sm" data-validation="required">
				  </div>
