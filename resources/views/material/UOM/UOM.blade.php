			...
			<form class='form-horizontal' style='width:99%' id='formdata'>
				...
				<div class="form-group">
                	<label class="col-md-2 control-label" for="uomcode">UOM Code</label>  
                      <div class="col-md-3">
                      <input id="uomcode" name="uomcode" type="text" maxlength="10" class="form-control input-sm text-uppercase" data-validation="required" frozeOnEdit>
                      </div>
				</div>
				...
				<div class="form-group">
                	<label class="col-md-2 control-label" for="convfactor">Conversion Factor</label>  
                      <div class="col-md-8">
                      <input id="convfactor" name="convfactor" type="text" maxlength="100" class="form-control input-sm" data-validation="required">
                      </div>
				</div>
...
@section('scripts')
	...
	<script src="js/material/UOM/UOMScript.js"></script>
