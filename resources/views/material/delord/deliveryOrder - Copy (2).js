...
$(document).ready(function () {
	...
	var urlParam={
		...
		field:'',
		fixPost:'true',
		table_name:['material.delordhd', 'material.supplier', 'material.purreqhd'],
		table_id:'delordhd_idno',
		sort_idno:true,
		join_type:['LEFT JOIN', 'LEFT JOIN'],
		join_onCol:['supplier.suppcode', 'supplier.suppcode'],
		join_onVal:['delordhd.suppcode', 'purreqhd.suppcode'],
		filterCol:['trantype'],
		filterVal:['GRN'],
	}
	...
	$("#jqGrid").jqGrid({
		datatype: "local",
		 colModel: [
			{ label: 'Record No', name: 'delordhd_recno', width: 10, classes: 'wrap', canSearch: true, formatter: padzero, unformat: unpadzero},
			...
			{ label: 'GRN No', name: 'delordhd_docno', width: 15, classes: 'wrap', canSearch: true},
		...
		onSelectRow:function(rowid, selected){
			...
			$('#reqdeptdepan').text(selrowData("#jqGrid").delordhd_prdept);
