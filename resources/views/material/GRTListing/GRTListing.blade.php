...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 400px;">
            <form method="get" id="genreport" action="./GRTListing/showExcel">
                <h4>GOOD RETURN LISTING</h4>
...
@section('scripts')
	<script src="js/material/GRTListing/GRTListing.js"></script>
@endsection