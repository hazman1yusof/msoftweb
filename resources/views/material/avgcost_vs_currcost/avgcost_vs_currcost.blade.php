...
@section('title', 'Average Cost vs Current Cost')
...
@section('body')
    <div class="container mycontainer">
        <div class="jumbotron" style="margin-top: 30px;text-align: center;height: 350px;">
            <form method="get" id="genreport" action="./avgcost_vs_currcost/showExcel">
                <h4>AVERAGE COST VS CURRENT COST</h4>
...
@section('scripts')
	<script src="js/material/avgcost_vs_currcost/avgcost_vs_currcost.js"></script>
@endsection