...
<html>
    <head>
        <title>Average Cost vs Current Cost</title>
    </head>
            ...
            var docDefinition = {
                ...
                content: [
                    ...
                    },
                    {
                        ...
                        table: {
                            headerRows: 1,
                            widths: [40,150,30,30,60,60,50,55,37,130],  //panjang standard dia 515
                            body: [
                                [
                                    {text: 'UNIT', style: 'tableHeader'},
                                    {text: 'ITEM CODE', style: 'tableHeader'},
                                    {text: 'UOM', style: 'tableHeader'},
                                    {text: 'QTY ON HAND', style: 'tableHeader', alignment: 'right'},
                                    {text: 'AVG COST', style: 'tableHeader', alignment: 'right'},
                                    {text: 'CURRENT PRICE', style: 'tableHeader', alignment: 'right'},
                                    {text: 'GROUP CODE', style: 'tableHeader'},
                                    {text: 'PRODUCT\nCATEGORY', style: 'tableHeader'},
                                ...
                                [
                                    ...
                                    {text: '{{number_format($obj->currprice,2)}}', alignment: 'right'},
                                    {text: '{{$obj->groupcode}}'},
                                    {text: '{{$obj->productcat}}'},
                                    @if($obj->chgflag == '1')
