			...
			$("#jqGrid").jqGrid({
				datatype: "local",
				 colModel: [
					...
					{ label: 'Item code', name: 'itemcode', width: 20, classes: 'wrap', canSearch: false, checked:false},						
					{ label: 'Item Description', name: 'description', width: 40, classes: 'wrap', canSearch: false},
        ...
        multiSort: true,
			...
			// ('#ModalAdd #addForm').submit(function(event){
