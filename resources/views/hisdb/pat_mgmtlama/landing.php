    ...
    <div class="wrapper">
		...
		<div class="panel">
			<!--div class="btn-group" role="group" aria-label="ACTION"-->
				<button id="patientBox" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#mdl_patient_info"><span class="glyphicon glyphicon-inbox" aria-hidden="true"> </span> Register New</button>
				&nbsp;&nbsp;
				<button type="button" class="btn btn-success btn-md" disabled ><span class="glyphicon glyphicon-credit-card" aria-hidden="true"> </span> My Kad</button>
				&nbsp;&nbsp;
				...
				&nbsp;&nbsp;
				<button type="button" class="btn btn-success btn-md" disabled ><span class="glyphicon glyphicon-calendar" aria-hidden="true"> </span> GP</button>
<!--				<button type="button" class="btn btn-success btn-md" disabled ><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> OTC Episode</button>-->
<!--				<button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#editEpisode" ><span class="glyphicon glyphicon-header" aria-hidden="true"></span> Episode</button>-->
		...
		<div class="panel">
			...
			<table id="grid-command-buttons" class="table table-condensed table-hover table-striped" width="100%">
                <thead>
                <tr>
