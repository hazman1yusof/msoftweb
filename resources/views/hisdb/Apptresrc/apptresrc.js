		...
		$(document).ready(function () {
			...
			$("#jqGrid").jqGrid({
				...
				{ label: 'Compcode', name: 'compcode', hidden:true},	
					...
					{ label: 'record status', name: 'recstatus', width: 90, classes: 'wrap',cellattr: function(rowid, cellvalue){
			...
			$("#g_resource").jqGrid({
				datatype: "local",
				 colModel: [
				 { label: 'type', name: 'type', width: 90 , hidden: true},
					{label: 'Resource Code', name: 'resourcecode', width: 200, checked:true, canSearch: true},
					{label: 'Description', name: 'description', width: 200, canSearch: true},
					{ label: 'Comment', name: 'comment', width: 200, classes: 'wrap', hidden: true},
				],
						autowidth:true,
		                multiSort: true,
						viewrecords: true,
			...
			$("#g_ot").jqGrid({
				datatype: "local",
				 colModel: [
				 { label: 'type', name: 'type', width: 90 , hidden: true},
					{label: 'Operation Theater Code', name: 'resourcecode', width: 200, checked:true, canSearch: true},
					{label: 'Description', name: 'description', width: 200, canSearch: true},
					{ label: 'Comment', name: 'comment', width: 200, classes: 'wrap',hidden: true},
				],
				autowidth:true,
