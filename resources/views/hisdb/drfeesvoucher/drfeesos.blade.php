...
@section('title', 'Dr Fees Outstanding Reporting')
...
@section('body')
    ...
    <div class='' style="margin: auto; width: 70%; padding-top: 20px;">
        <div class="panel panel-info">
            <div class="panel-heading text-center"><b>Doctor Fees Outstanding</b></div>
    ...
    <script>
        ...
        $(document).ready(function (){
            ...
            $('#excelgen1').click(function(){
                ...
                window.open('./drfeesvoucher/table?action=download_report_os&reportno='+report+'&datefrom='+$('#datefrom').val()+'&dateto='+$('#dateto').val(), '_blank');
            });
        });
    </script>
@endsection