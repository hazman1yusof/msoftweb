                                                ...
                                                <div class="panel-body" style="height: 837px;">
                                                    ...
                                                    <div class="form-row col-md-12">
                                                        <div class="form-group col-md-6" style="margin-left: 2px">
                                                            ...
                                                            <div class='input-group'>
                                                                <input name="blood_grp" type="text" class="form-control input-sm">
                                                    ...
                                                    <div class="form-row col-md-12">
                                                        <div class="form-group col-md-6" style="margin-left: 2px">
                                                            ...
                                                            <input class="form-control" list="rhesus_factor1" name="rhesus_factor">
                                                        ...
                                                        <div class="form-group col-md-6" style="margin-left: 2px">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="rubella" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;">
                                                    ...
                                                    <div class="form-row col-md-12">
                                                        ...
                                                        <div class="form-group col-md-6" style="margin-left: 2px">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="HIV" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-6" style="margin-left: 2px">
                                                                        ...
                                                                        <input name="first_dose" type="date" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="form-group col-md-6" style="margin-left: 2px">
                                                                        <label for="second_dose">2nd dose</label>
                                                                        <input name="second_dose" type="date" class="form-control input-sm">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-6" style="margin-left: 2px">
                                                                        ...
                                                                        <input name="booster" type="date" class="form-control input-sm">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="form-group col-md-10" style="margin-top: 10px;margin-left: 35px">
                                                        ...
                                                        <input class="form-control" list="blood_trans1" name="blood_trans">
                                                    ...
                                                    <div class="form-group col-md-10" style="margin-top: 10px;margin-left: 35px">
                                                        ...
                                                        <textarea id="drug_allergy" name="drug_allergy" type="text" class="form-control input-sm"></textarea>
                                                    </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="checkbox-inline" for="pgh_myomectomy" style="margin-left: 50px">
                                                                <input type="checkbox" name="pgh_myomectomy" value="1">Myomectomy
                                                            </label>
                                                            <label class="checkbox-inline" for="pgh_laparoscopy" style="margin-left: 30px">
                                                                <input type="checkbox" name="pgh_laparoscopy" value="1">Laparoscopy
                                                            </label>
                                                            <label class="checkbox-inline" for="pgh_endomet" style="margin-left: 30px">
                                                                <input type="checkbox" name="pgh_endomet" value="1">Endometriosis
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-5" style="margin-top: 10px;margin-left: 35px">
                                                            ...
                                                            <input name="pgh_lastpapsmear" type="date" class="form-control input-sm">
                                                        </div>
                                                        <div class="form-group col-md-10" style="margin-top: 10px;margin-left: 35px">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="checkbox-inline" for="pmh_renal" style="margin-left: 50px">
                                                                <input type="checkbox" name="pmh_renal" value="1">Renal Disease
                                                            </label>
                                                            <label class="checkbox-inline" for="pmh_hypertension" style="margin-left: 30px">
                                                                <input type="checkbox" name="pmh_hypertension" value="1">Hypertension
                                                            </label>
                                                            <label class="checkbox-inline" for="pmh_diabetes" style="margin-left: 30px">
                                                                <input type="checkbox" name="pmh_diabetes" value="1">Diabetes
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <label class="checkbox-inline" for="pmh_heart" style="margin-left: 50px">
                                                                <input type="checkbox" name="pmh_heart" value="1">Heart Disease
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="checkbox-inline" for="psh_appendic" style="margin-left: 50px">
                                                                <input type="checkbox" name="psh_appendic" value="1">Appendicectomy
                                                            </label>
                                                            <label class="checkbox-inline" for="psh_hypertension" style="margin-left: 30px">
                                                                <input type="checkbox" name="psh_hypertension" value="1">Hypertension
                                                            </label>
                                                            <label class="checkbox-inline" for="psh_laparotomy" style="margin-left: 30px">
                                                                <input type="checkbox" name="psh_laparotomy" value="1">Laparotomy
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <label class="checkbox-inline" for="psh_thyroid" style="margin-left: 50px">
                                                                <input type="checkbox" name="psh_thyroid" value="1">Thyroid Surgery
                                                            </label>
                                                        </div>

                                                        <div class="form-group col-md-10" style="margin-top: 10px;margin-left: 35px">
                                                            <label for="psh_others">Others</label>
                                                            <textarea id="psh_others" name="psh_others" type="text" class="form-control input-sm"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="checkbox-inline" for="fh_hypertension" style="margin-left: 50px">
                                                                <input type="checkbox" name="fh_hypertension" value="1">Hypertension
                                                            </label>
                                                            <label class="checkbox-inline" for="fh_diabetes" style="margin-left: 30px">
                                                                <input type="checkbox" name="fh_diabetes" value="1">Diabetes
                                                            </label>
                                                            <label class="checkbox-inline" for="fh_epilepsy" style="margin-left: 30px">
                                                                <input type="checkbox" name="fh_epilepsy" value="1">Epilepsy
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <label class="checkbox-inline" for="fh_multipregnan" style="margin-left: 50px">
                                                                <input type="checkbox" name="fh_multipregnan" value="1">Multiple Pregnancy
                                                            </label>
                                                        </div>

                                                        <div class="form-group col-md-10" style="margin-top: 10px;margin-left: 35px">
                                                            <label for="fh_congenital">Congenital Abnormalities (Specify)</label>
                                                            <textarea id="fh_congenital" name="fh_congenital" type="text" class="form-control input-sm"></textarea>
                                                        </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input name="sysexam_date" type="date" class="form-control input-sm">
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label class="control-label" for="sysexam_varicose" style="padding-bottom:5px">Varicose Veins</label>
                                                        <input name="sysexam_varicose" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label class="control-label" for="sysexam_pallor" style="padding-bottom:5px">Pallor</label>
                                                        <input name="sysexam_pallor" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label class="control-label" for="sysexam_jaundice" style="padding-bottom:5px">Jaundice</label>
                                                        <input name="sysexam_jaundice" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input name="sysexam_oral" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label class="control-label" for="sysexam_thyroid" style="padding-bottom:5px">Thyroid</label>
                                                        <input name="sysexam_thyroid" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input name="sysexam_breastr" type="text" class="form-control input-sm" style="text-transform: none">
                                                        </div>
                                                        <label class="col-md-2 control-label" for="sysexam_breastl" style="padding-top:10px;padding-left:0px;">(L)</label>
                                                        <div class="col-md-10" style="padding-top:5px;">
                                                            <input name="sysexam_breastl" type="text" class="form-control input-sm" style="text-transform: none">
                                                        </div>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label class="control-label" for="sysexam_cvs" style="padding-bottom:5px">CVS</label>
                                                        <input name="sysexam_cvs" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input name="sysexam_resp" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label class="control-label" for="sysexam_abdomen" style="padding-bottom:5px">Abdomen</label>
                                                        <input name="sysexam_abdomen" type="text" class="form-control input-sm" style="text-transform: none">
                                                    </div>
                                                
                                                    <div class="col-md-6">
                                                        <label class="control-label" for="sysexam_remark" style="padding-bottom:5px">Special Remarks</label>
                                                        <textarea id="sysexam_remark" name="sysexam_remark" type="text" class="form-control input-sm"></textarea>
                                                    </div>
                                                </div>
        ...
        <div class='col-md-12'>
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                                        ...
                                        <div class="panel panel-info">
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input name="gravida" type="number" class="form-control input-sm" onkeydown="return event.keyCode !== 69">
                                                    </div>

                                                    <label class="col-md-1 control-label" for="para">P</label>
                                                    <div class="col-md-3">
                                                        <input name="para" type="number" class="form-control input-sm" onkeydown="return event.keyCode !== 69">
                                                    </div>

                                                    <label class="col-md-1 control-label" for="abortus">+</label>
                                                    <div class="col-md-3">
                                                        <input name="abortus" type="number" class="form-control input-sm" onkeydown="return event.keyCode !== 69">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class='col-md-12'>
                                                        ...
                                                        <div class="col-md-3">
                                                            <input name="lmp" type="date" class="form-control input-sm">
                                                        </div>

                                                        <label class="col-md-2 control-label" for="edd">EDD</label>
                                                        <div class="col-md-3">
                                                            <input name="edd" type="date" class="form-control input-sm">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class='col-md-12' style="padding-top: 10px;">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input name="corrected_edd" type="date" class="form-control input-sm">
                                                        </div>

                                                        <label class="col-md-2 control-label" for="deliverydate">Delivery date</label>
                                                        <div class="col-md-3">
                                                            <input name="deliverydate" type="date" class="form-control input-sm">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                    ...
                                                                    <div class="col-md-8" style="padding-top:6px;">
                                                                        ...
                                                                        <div class="form-check">
                                                                            ...
                                                                            <div class="col-md-6 input-group">
                                                                                <input name="vsdsize" type="number" class="form-control input-sm" onkeydown="return event.keyCode !== 69">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input name="otherDefects" type="text" class="form-control input-sm" style="text-transform: none">
                                                                    </div>
                                                                </div>	
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8" style="padding-top:6px;">
                                                            <div class="form-check col-md-6">  
                                                                <div class="input-group">
                                                                    <input name="cordA" type="text" class="form-control input-sm" style="text-transform: none">
                                                                    <span class="input-group-addon">A</span>
                                                                </div> 
                                                            </div>
                                                            <div class="form-check col-md-6"> 
                                                                <div class="input-group">
                                                                    <input name="cordV" type="text" class="form-control input-sm" style="text-transform: none">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="col-md-4">
                                                                        <input name="upperlimbs_1R" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="upperlimbs_2R" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="upperlimbs_3R" type="text" class="form-control input-sm">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="col-md-4">
                                                                        <input name="upperlimbs_1L" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="upperlimbs_2L" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="upperlimbs_3L" type="text" class="form-control input-sm">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="col-md-4">
                                                                        <input name="lowerlimbs_1R" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="lowerlimbs_2R" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="lowerlimbs_3R" type="text" class="form-control input-sm">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="col-md-4">
                                                                        <input name="lowerlimbs_1L" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="lowerlimbs_2L" type="text" class="form-control input-sm">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input name="lowerlimbs_3L" type="text" class="form-control input-sm">
                                                                    </div>
                                                                </div>
                                                            </div>
                    ...
                    <div class='col-md-12'>
                        <div class="panel panel-info" id="jqGridAddNotesAntenatal_c">
                            <div class="panel-heading text-center">ADDITIONAL NOTES</div>
                            <div class="panel-body">
                                <div class='col-md-12' style="padding:0 0 15px 0">
                                    <table id="jqGridAddNotesAntenatal" class="table table-striped"></table>
                                    <div id="jqGridPagerAddNotesAntenatal"></div>
                                </div>
                            </div>
                        </div>
                    </div>
