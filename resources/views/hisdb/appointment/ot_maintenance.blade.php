...
@section('title', 'RESCOURCE Maintenance ')
...
@section('body')
	...
	<div id="ALBox" title="Annual Leave" style="display:none">
		<div class="row" style="padding:0">
			<label class="col-md-2 control-label">RESCOURCE CODE</label>
			<span name='resourcecode' ></span>
		</div>
		<div class="row" style="padding:0">
			<label class="col-md-2 control-label">RESCOURCE NAME</label>
...
@section('scripts')
	...
	<script src="js/hisdb/appointment/ot_maintenanceScript.js"></script>
