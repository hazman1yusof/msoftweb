...
@section('body')
	...
	<div class='row'>   
		<div class="panel panel-default" style="position: relative;" id="jqGridWard_c">
			...
			<div class="panel-heading clearfix collapsed" id="toggle_ward" data-toggle="collapse" data-target="#jqGridWard_panel">
				<b><span id="name_show_ward"></span></b><br>
				<span id="newic_show_ward"></span>
				<span id="sex_show_ward"></span>
				<span id="age_show_ward"></span>
				<span id="race_show_ward"></span>
							...
							<div class='col-md-6'>
								<div class="panel panel-info">
									...
									<div class="panel-body">
										...
										<input id="mrn_edit_ward" name="mrn_edit_ward" type="hidden">
