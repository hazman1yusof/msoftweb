								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<label class="radio-inline">
											<input type="radio" id="feedingmode" name="oral" value="1">Oral
										</label>
										<label class="radio-inline">
											<input type="radio" id="feedingmode" name="nbm" value="1">Nil by Mouth
										</label>
										<label class="radio-inline">
											<input type="radio" id="feedingmode" name="rtf" value="1">Ryles Tube Feeding
										</label>
										<label class="radio-inline">
											<input type="radio" id="feedingmode" name="rof" value="1">Restriction of Fluid
										</label>
										<label class="radio-inline">
											<input type="radio" id="feedingmode" name="tpn" value="1">Total Parenteral Nutrition
										</label>
									</div>
								</div>
