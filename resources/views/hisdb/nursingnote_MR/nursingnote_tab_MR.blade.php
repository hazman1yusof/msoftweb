    ...
    <div id="jqGridNursNote_paneltab" class='col-md-12' style="padding: 0 0 15px 0;" data-curtype='navtab_invChart'>
        ...
        <div class="tab-content" style="padding: 10px 5px;">
            ...
            <div id="tab-intake" class="tab-pane fade">
                @include('hisdb.nursingnote_MR.nursingnote_intake_MR')
            </div>
            ...
            <div id="tab-treatmentP" class="tab-pane fade">
                <div class='col-md-12' style="padding-left: 0px; padding-right: 3px;">
                    <div class="panel panel-info">
                        <div class="panel-heading text-center">TREATMENT & PROCEDURE</div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body" style="padding-right: 0px;">
                            <form class='form-horizontal' style='width: 99%;' id='formCirculation'>
                                ...
                                <div class='col-md-12'>
                                    <div class="panel panel-info" id="jqGridAddNotesCirculation_c">
                                        <div class="panel-heading text-center">ADDITIONAL NOTES</div>
                                        <div class="panel-body">
                                            <div class='col-md-12' style="padding:0 0 15px 0">
                                                <table id="jqGridAddNotesCirculation" class="table table-striped"></table>
                                                <div id="jqGridPagerAddNotesCirculation"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body" style="padding-right: 0px;">
                            <form class='form-horizontal' style='width: 99%;' id='formSlidingScale'>
                                ...
                                <div class='col-md-12'>
                                    <div class="panel panel-info" id="jqGridAddNotesSlidingScale_c">
                                        <div class="panel-heading text-center">ADDITIONAL NOTES</div>
                                        <div class="panel-body">
                                            <div class='col-md-12' style="padding:0 0 15px 0">
                                                <table id="jqGridAddNotesSlidingScale" class="table table-striped"></table>
                                                <div id="jqGridPagerAddNotesSlidingScale"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="tab-gcs" class="tab-pane fade">
                @include('hisdb.nursingnote_MR.nursingnote_glasgow_MR')
            </div>
            <div id="tab-pivc" class="tab-pane fade">
                @include('hisdb.nursingnote_MR.nursingnote_pivc_MR')
            </div>
            <div id="tab-morsefallscale" class="tab-pane fade">
                @include('hisdb.nursingnote_MR.morsefallscale_MR')
            </div>
            <div id="tab-thrombo" class="tab-pane fade">
                @include('hisdb.nursingnote_MR.nursingnote_thrombo_MR')
            </div>
        </div>
    </div>
<!-- </div> -->
