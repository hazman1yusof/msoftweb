...
<div class="modal-dialog modal-lg" id="allmodal">
    ...
    <input type="hidden" name="episno_episode" id="episno_episode" value="{{$episno}}">
    <input type="hidden" name="episode_oper" id="episode_oper" value="edit">
    ...
    <div class="modal-content">
        <div class="modal-header label-info form-horizontal" style="position: sticky; top: 0px; z-index: 3;">
            <form id="epis_header">
                <button type="button" class="" data-dismiss="modal" aria-label="Close" id="close_iframe" 
                style="z-index: 100; 
                    right: 10px; 
                    color: white; 
                    position: absolute; 
                ...
                <div class="form-group">
                    <div class="col-sm-1">
                        ...
                        <input class="form-control input-sm" id="txt_epis_mrn" name="txt_epis_mrn" placeholder="" type="text" readonly value="{{str_pad($mrn, 7, '0', STR_PAD_LEFT)}}">
                    </div>
                    <div class="col-sm-1">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-1 col-md-10">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn btn-info" id="btn_epis_payer" data-mrn="{{$mrn}}"><span class="fa fa-ellipsis-h"></span></button>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="col-md-offset-1 col-md-10">
...
@section('js')
<script type="text/javascript" src="{{asset('js/hisdb/pat_mgmt/epis_doctor.js')}}"></script>
<script type="text/javascript" src="{{asset('js/hisdb/pat_mgmt/epis_nok.js?v=1.1')}}"></script>
...
<script type="text/javascript" src="{{asset('js/hisdb/pat_mgmt/episode_iframe.js?v=1.4')}}"></script>
@endsection