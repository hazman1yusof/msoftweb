...
<body class="header-fixed">
	...
	@if (request()->get('curpat') == 'true')
		...
		@if (request()->get('epistycode') == 'OP')
			@if (Auth::user()->doctor == 1)
				...
				<script type="text/javascript" src="js/hisdb/nursingnote/nursingnote.js?v=2.1"></script>
				...
				<script type="text/javascript" src="js/hisdb/doctornote/doctornote.js?v=1.3"></script>
				...
				<script type="text/javascript" src="js/hisdb/requestfor/requestfor.js?v=1.3"></script>
	...
	<script type="text/javascript" src="js/hisdb/pat_mgmt/landing.js?v=1.2"></script>
