...
<body class="header-fixed">
	...
	<script type="text/javascript" src="js/hisdb/pat_mgmt/episode.js?v=1.1"></script>
	...
	@if (request()->get('curpat') == 'true')
		...
		@if (request()->get('epistycode') == 'IP')
			...
			@if (Auth::user()->doctor == 1)
				...
				<script type="text/javascript" src="js/hisdb/nursingnote/nursingnote.js?v=1.7"></script>
	...
	<script type="text/javascript" src="js/hisdb/pat_mgmt/landing.js?v=1.1"></script>
