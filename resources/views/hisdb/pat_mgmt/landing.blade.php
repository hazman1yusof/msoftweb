	...
	@if (request()->get('curpat') == 'true')
		...
		@if (request()->get('epistycode') == 'OP')
			@if (Auth::user()->doctor == 1)
				...
				<script type="text/javascript" src="js/hisdb/doctornote/doctornote.js?v=1.4"></script>
				...
				<script type="text/javascript" src="js/hisdb/requestfor/requestfor.js?v=1.4"></script>
