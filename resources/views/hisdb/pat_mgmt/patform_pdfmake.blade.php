...
{!!$ini_array['EmployersAddress3']!!}`;
        ...
        var FaxNo = ``;
        var LegalProceeding = ``;
        var RegTime = `{!!$episode->reg_date!!} {!!$episode->reg_time!!}`;
        var ReferredFrom = ``;
        var MothersName = ``;
        var MothersAddress = ``;
        ...
        var DischargeWard = ``;
        var Note2 = ``;
        var AdmDicipline = `{!!$ini_array['AdmDicipline']!!}`;
        ...
        var Note3 = ``;
        var DischargeTime = ``;
        var SpecialistName = `{!!$ini_array['doctorname']!!}`;
        var Deposit = ``;
        var FirstTopUp = ``;
        var SecTopUp = ``;
        var ThirdTopUp = ``;
        ...
        var Operation = ``;
        var OperationCodeNo = ``;
        var MedOfficerName = `{!!$ini_array['doctorname']!!}`;
        var Signature = ``;
        var SpecialistNote = ``;
        ...
        $(document).ready(function (){
            var docDefinition = {
                ...
                images: {
                    ukmsc_logo: "{{asset('/img/logoukm.png')}}"
                }
            };
