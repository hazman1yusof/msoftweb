    ...
    <div class="ui segment" style="padding: 10px 10px 30px 30px;">
        <form id="form_otdischarge" class="ui form">
            <div class="ui grid">
                ...
                <div class="sixteen wide column" id="addnotes_otDischarge">
                    <div class="ui segments">
                        <div class="ui secondary segment">Additional Notes</div>
                        <div class="ui segment" id="jqGridAddNotesOtDischarge_c">
                            <table id="jqGridAddNotesOtDischarge" class="table table-striped"></table>
                            <div id="jqGridPagerAddNotesOtDischarge"></div>
                        </div>
                    </div>
                </div>
            </div>
