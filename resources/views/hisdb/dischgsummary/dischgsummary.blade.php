						...
						<div class="panel panel-info">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input name="reg_time" type="time" class="form-control input-sm" rdonly>
									</div>

									<label class="col-md-1 control-label" for="dischargetime">Discharge</label>  
									<div class="col-md-4">
										<input name="dischargetime" type="time" class="form-control input-sm">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="diagprov" name="diagprov" type="text" class="form-control input-sm"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="procedure" name="procedure" type="text" class="form-control input-sm"></textarea>
									</div>
								</div>
									...
									<div class="panel panel-info">
										...
										<div class="panel-body">
											...
											<div class="form-check">
												<input class="form-check-input" type="radio" name="dischargestatus" value="well">
												<label class="form-check-label" for="well">Well</label>
											</div>

											<div class="form-check">
												<input class="form-check-input" type="radio" name="dischargestatus" value="improved">
												<label class="form-check-label" for="improved">Improved</label>
											</div>

											<div class="form-check">
												<input class="form-check-input" type="radio" name="dischargestatus" value="aor">
												<label class="form-check-label" for="aor">AOR</label>
											</div>
											
											<div class="form-check">
												<input class="form-check-input" type="radio" name="dischargestatus" value="expired">
												<label class="form-check-label" for="expired">Expired</label>
											</div>	
											
											<div class="form-check">
												<input class="form-check-input" type="radio" name="dischargestatus" value="absconded">
												<label class="form-check-label" for="absconded">Absconded</label>
											</div>
											
											<div class="form-check">
												<input class="form-check-input" type="radio" name="dischargestatus" value="transferred">
								...
								<div class='col-md-12'>
									<div class="panel panel-info">
										<div class="panel-body">
											...
											<div class="form-check">
												<input class="form-check-input" type="checkbox" name="medOnDischarge" value="1">
												<label class="form-check-label" for="medOnDischarge">Medication(s) on Discharge</label>
											</div>

											<div class="form-check">
												<input class="form-check-input" type="checkbox" name="medCert" value="1">
