    ...
    <div id="jqGridNursActionPlan_paneltab" class="panel-body" data-curtype='navtab_treatment'>
                ...
                <div class="panel-body" style="padding-right: 0px;">
                    <form class='form-horizontal' style='width: 99%;' id='formHeader'>
                        <div class="form-group">
                            ...
                            <label class="col-md-1 control-label" for="icd">ICD</label>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <label class="col-md-1 control-label" for="op_date">Date of Operation</label>
                            <div class="col-md-2">
                            ...
                            <label class="col-md-1 control-label" for="icd_desc"></label>
                            <div class="col-md-3">
                                <textarea id="icd_desc" name="icd_desc" type="text" class="form-control input-sm"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class='col-md-12' style="padding: 0 0 15px 0;">
            <ul class="nav nav-tabs" id="jqGridNursActionPlan_panel_tabs">
                <li class="active"><a data-toggle="tab" id="navtab_treatment" href="#tab-treatments" data-type='treatment'>Treatment</a></li>
            ...
            <div class="tab-content" style="padding: 10px 5px;">
                ...
                <!-- TREATMENT -->
                <div id="tab-treatments" class="active in tab-pane fade">
                    <div class='col-md-12' style="padding-left: 0px; padding-right: 0px;">
                        <div class="panel panel-info">
                ...
                <div id="tab-procedure" class="tab-pane fade">
                    <div class='col-md-12' style="padding-left: 0px; padding-right: 0px;">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading text-center" style="height: 40px;" id="prod"></div>
                            <div class="panel-body" style="padding-right: 0px;">
