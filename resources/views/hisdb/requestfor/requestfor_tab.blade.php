...
<!-- <div class="panel-body paneldiv" style="overflow-y: auto;"> -->
    ...
    <div id="jqGridRequestFor_paneltab" class='col-md-12' style="padding: 0 0 15px 0;" data-curtype='navtab_otbookReqFor'>
        <div class="panel panel-info">
            <!-- <div class="panel-heading text-center">REQUEST FOR</div> -->
            <div class="panel-body">
                <ul class="nav nav-tabs nav-tabs-second" id="jqGridRequestFor_panel_tabs">
                    ...
                    <li><a data-toggle="tab" id="navtab_physioReqFor" href="#tab-physioReqFor" data-type='PHYSIO_REQFOR'>Rehab</a></li>
                                        ...
                                        <div class='col-md-12'>
                                            <div class="panel panel-info">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group" id='ReqFor_treatment'>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" name="tr_speech" id="ReqFor_tr_speech" value="1">
                                                                <label class="form-check-label" for="ReqFor_tr_speech">Speech</label>
                                                            </div>
                                                        </div>
                                                    </div>
