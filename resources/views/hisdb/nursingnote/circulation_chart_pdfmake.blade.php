            ...
            var docDefinition = {
                ...
                content: [
                    ...
                    // { canvas: [{ type: 'line', x1: 0, y1: 5, x2: 515, y2: 5, lineWidth: 0.5 }] },
                    {
                        ...
                        table: {
                            headerRows: 1,
                            widths: [90,50,40,40,60,60,50,40], // panjang standard dia 515
                            body: [
                                [
                                    { text: 'DATE/TIME', style: 'tableHeader' },
                                    { text: 'CAPILLARY\nREFILL', style: 'tableHeader' },
                                    { text: 'SKIN\nTEMP', style: 'tableHeader' },
                                ...
                                [
                                    { text: '{{\Carbon\Carbon::createFromFormat('Y-m-d',$obj->entereddate)->format('d-m-Y')}} {{$obj->enteredtime}}' },
                                    { text: '{{$obj->capillary}}' },
                                    { text: '{{$obj->skintemp}}' },
                                    { text: '{{$obj->pulse}}' },
                                    { text: '{{$obj->movement}}' },
