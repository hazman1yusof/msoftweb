...
<!-- <div class="panel-body paneldiv" style="overflow-y: auto;"> -->
    <div class='col-md-12'>
        <div class="panel panel-default">
            <div class="panel-heading text-center" style="position: sticky; top: 0px; z-index: 3;">DOCTOR NOTE</div>
                                ...
                                <div class="panel-body">
                                    <div class="form-inline col-md-12" style="padding-bottom: 15px;">
                                        ...
                                        <!-- @if(Auth::user()->doctor == '1')
                                            <button class="btn btn-default btn-sm" type="button" id="referLetterClientProgNote" style="float: right; margin-right: 40px; display: none;">Referral Letter</button>
                                            <button class="btn btn-default btn-sm" type="button" id="clientProgNote_medc" style="float: right; margin-right: 20px;">MC Letter</button>
                                        @endif -->
                                    </div>
...
<div id="dialog_medc_ClientProgNote" title="Medical Certificate">
    <div class="row">
