            ...
            <form id="formEndoscopyIntestine" class="floated ui form sixteen wide column">
                <div class='ui grid sixteen wide column' style="padding: 15px 30px;">
                                ...
                                <tr>
                                    <td colspan="2">HBsAG : 
                                        ...
                                        <label class="radio-inline" style="padding-left: 30px;">
                                            <input type="radio" name="HBsAG" value="Positive">Positive
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="HBsAG" value="Negative">Negative
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="HBsAG" value="Not Know">Not Know
                                        </label>
                                    </td>
                                    <td></td>
                                </tr>
                    ...
                    <div class="eight wide column">
                     ...
                     <div class="sixteen wide column" id="addnotes_endoIntestine">
                        <div class="ui segments">
                            <div class="ui secondary segment">Additional Notes</div>
                            <div class="ui segment" id="jqGridAddNotesEndoIntestine_c">
                                <table id="jqGridAddNotesEndoIntestine" class="table table-striped"></table>
                                <div id="jqGridPagerAddNotesEndoIntestine"></div>
                            </div>
                        </div>
                    </div>
                </div>
