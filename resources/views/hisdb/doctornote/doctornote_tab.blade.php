...
<!-- <div class="panel-body paneldiv" style="overflow-y: auto;"> -->
    <div id="jqGridDoctorNote_paneltab" class='col-md-12' data-curtype='navtab_otbook'>
        <div class="panel panel-default">
            <div class="panel-heading text-center" style="position: sticky; top: 0px; z-index: 3;">DOCTOR NOTE (PSYCHIATRY)
