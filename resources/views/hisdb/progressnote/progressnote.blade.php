...
<div class="panel panel-default" style="position: relative;" id="jqGridProgress_c">
	
	<div class="panel-heading clearfix collapsed position" id="toggle_progress" style="position: sticky;top: 0px;z-index: 3;">
		<b>NAME: <span id="name_show_progress"></span></b><br>
		MRN: <span id="mrn_show_progress"></span>
		SEX: <span id="sex_show_progress"></span>
		DOB: <span id="dob_show_progress"></span>
		AGE: <span id="age_show_progress"></span>
		RACE: <span id="race_show_progress"></span>
		RELIGION: <span id="religion_show_progress"></span><br>
		OCCUPATION: <span id="occupation_show_progress"></span>
		CITIZENSHIP: <span id="citizenship_show_progress"></span>
		AREA: <span id="area_show_progress"></span>
		
		<i class="arrow fa fa-angle-double-up" style="font-size:24px;margin: 0 0 0 12px" data-toggle="collapse" data-target="#jqGridProgress_panel"></i>
		<i class="arrow fa fa-angle-double-down" style="font-size:24px;margin: 0 0 0 12px" data-toggle="collapse" data-target="#jqGridProgress_panel"></i>
	...
	<div id="jqGridProgress_panel" class="panel-collapse collapse">
		<div class="panel-body paneldiv" style="overflow-y: auto;">
			<div class='col-md-12' style="padding:0 0 15px 0">
				...
				<form class='form-horizontal' style='width:99%' id='formProgress'>
                    ...
                    <input id="mrn_progress" name="mrn_progress" type="hidden">
                    <input id="episno_progress" name="episno_progress" type="hidden">
