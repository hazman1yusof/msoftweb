											...
											<div class="panel-body">
												...
												<div class="form-row">
													<div class="form-group col-md-6" style="margin-left: 2px">
														...
														<div class="input-group">
															<input name="vs_temperature" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter temperature." data-validation-error-msg-container="#error-cn_temperature">
															<span class="input-group-addon">°C</span>
														</div>
														<div class="error-msg" id="error-cn_temperature"></div>
													</div>
													<div class="form-group col-md-6" style="margin-left: 2px">
														<label for="vs_pulse">Pulse</label>  
														<div class="input-group">
															<input name="vs_pulse" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter pulse." data-validation-error-msg-container="#error-cn_pulse">
															<span class="input-group-addon">/min</span>
														</div>
														<div class="error-msg" id="error-cn_pulse"></div>
													</div>
												</div>
												...
												<div class="form-row">
													<div class="form-group col-md-6" style="margin-left: 2px">
														...
														<div class="input-group">
															<input name="vs_respiration" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter respiratory rate." data-validation-error-msg-container="#error-cn_respiration">
															<span class="input-group-addon">/min</span>
														</div>
														<div class="error-msg" id="error-cn_respiration"></div>
													</div>
													<div class="form-group col-md-6" style="margin-left: 2px">
														<label for="vs_bloodpressure">Blood Pressure</label>
														<div class="input-group">
															<input name="vs_bp_sys1" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter systolic reading." data-validation-error-msg-container="#error-cn_bp_sys1">
															<!-- <label class="col-md-1 control-label">/</label>  -->
															<input name="vs_bp_dias2" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter diastolic reading." data-validation-error-msg-container="#error-cn_bp_dias2">
															<span class="input-group-addon">/mmHg</span>
														</div>
														<div class="error-msg" id="error-cn_bp_sys1"></div>
														<div class="error-msg" id="error-cn_bp_dias2"></div>
													</div>
												</div>
												...
												<div class="form-row">
													<div class="form-group col-md-6" style="margin-left: 2px">
														...
														<div class="input-group">
															<input name="vs_height" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter height." data-validation-error-msg-container="#error-cn_height">
															<span class="input-group-addon">cm</span>
														</div>
														<div class="error-msg" id="error-cn_height"></div>
													</div>
													<div class="form-group col-md-6" style="margin-left: 2px">
														<label for="vs_weight">Weight</label> 
														<div class="input-group">
															<input name="vs_weight" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter weight." data-validation-error-msg-container="#error-cn_weight">
															<span class="input-group-addon">kg</span>
														</div>
														<div class="error-msg" id="error-cn_weight"></div>
													</div>
												</div>
												...
												<div class="form-row">
													<div class="form-group col-md-6" style="margin-left: 2px">
														...
														<div class="input-group">
															<input name="vs_gxt" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter the value of graded exercise test." data-validation-error-msg-container="#error-cn_gxt">
															<span class="input-group-addon">mmOL</span>
														</div>
														<div class="error-msg" id="error-cn_gxt"></div>
													</div>
													<div class="form-group col-md-6" style="margin-left: 2px">
														<label for="vs_painscore">Pain Score</label>  
														<div class="input-group">
															<input name="vs_painscore" type="number" class="form-control input-sm floatNumberField" onkeydown="return event.keyCode !== 69" onKeyPress="if(this.value.length==6) return false;" data-validation="required" data-validation-error-msg-required="Please enter pain score." data-validation-error-msg-container="#error-cn_painscore">
															<span class="input-group-addon">/10</span>
														</div>
														<div class="error-msg" id="error-cn_painscore"></div>
													</div>
												</div>
