    ...
    <div class="panel panel-default" style="z-index: 100; position: relative; margin: 10px 0px 10px 0px;" id="apptMain_panel">
        ...
        <div id="tab_apptMain" class="panel-collapse collapse">
            <div class="panel-body paneldiv" style="overflow-x: hidden;">
                @include('appointment_MR.appt_main_MR')
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('patientcare/js/appointment_MR/appointment_MR.js?v=1.2') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('patientcare/js/doctornote_MR.js?v=1.4') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/appointment_MR/doctorNoteAppt_MR.js') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/appointment_MR/nursingAppt_MR.js?v=1.1') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('patientcare/js/appointment_MR/admhandoverAppt_MR.js?v=1.2') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/appointment_MR/appt_main_MR.js?v=1.3') }}"></script>
