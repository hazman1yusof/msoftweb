...
<link rel="resource" type="application/l10n" src="{{ asset('plugins/pdfjs/web/locale/locale.json') }}" />
<script src="{{ asset('plugins/pdfjs/build/pdf.mjs') }}" type="module"></script>

    <link rel="stylesheet" href="{{ asset('plugins/pdfjs/web/viewer.css') }}" />

  <script src="{{ asset('plugins/pdfjs/web/viewer.mjs') }}" type="module"></script>
  </head>
...
<script type="module">
  ...
  document.addEventListener("DOMContentLoaded", function () {
      ...
      const button =
          document.getElementById("saveToServerButton");
      ...
      button.addEventListener("click", async function () {
        ...
        try {
             ...
             *
             * This includes PDF.js annotations/editors:
             * - freehand
             * - drawing
             * - images
             * - etc.
             */
            console.log("Generating edited PDF...");
            ...
            /*
             * Send actual PDF file to Laravel.
             */
            const formData =
                new FormData();
             ...
             * test.pdf for now.
             *
             * Later we can get the actual filename
             * from the PDF.js viewer URL / Laravel.
             */
            formData.append(
                "pdf",
                pdfBlob,
