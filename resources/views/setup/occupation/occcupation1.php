...
<body>
		...
		<div id="dialogForm" title="Add Form" >
			<form class='form-horizontal' style='width:99%' id='formdata'>
				...
				<div class="form-group">
                	<label class="col-md-3 control-label" for="occupcode">Occupation Code</label>  
                      <div class="col-md-4">
                      <input id="occupcode" name="occupcode" type="text" maxlength="2" class="form-control input-sm" data-validation="required">
                      </div>
				</div>
	...
	<!-- JS Page Level -->
	<script src="occupationScript.js"></script>
