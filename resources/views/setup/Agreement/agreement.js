...
$(document).ready(function () {
	...
	$("#jqGrid").jqGrid({
		...
		colModel: [
			...
			{ label: 'record status', name: 'recstatus', width: 90, classes: 'wrap', hidden: true },
	...
	$("#gridDialog").jqGrid({
		datatype: "local",
		colModel: [
			{ label: 'Agreement ID', name: 'AgreementID', width: 200, classes: 'pointer', canSearch: true },
			{ label: 'Agreement No', name: 'AgreementNo', width: 200, classes: 'pointer', canSearch: true },
		],
		width: 680,
		viewrecords: true,
		loadonce: false,
