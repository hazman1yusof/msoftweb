...
<body>
	...
	<!-------------------------------- End Search + table ------------------>
		...
		<div id="Ditem" title="Bill Type Item" >
        	<form class='form-horizontal' style='width:99%' id='Fitem'>
				...
				<input id="billtype" name="billtype" type="hidden" class="form-control input-sm">

				<div class="form-group">
				  <label class="col-md-2 control-label" for="chggroup">Chg Group</label>   
				  <div class="col-md-2">
				  <input id="chggroup" name="chggroup" type="text" class="form-control input-sm" rdonly>
				  </div>
				...
				<div class="form-group">
				  <label class="col-md-2 control-label" for="chgcode">Chg. Code</label>  
				  	<div class="col-md-2">
					  <div class='input-group'>
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="amount">Amount</label>  
					    <div class="col-md-2">
						  	<input id="i.amount" name="amount" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
						</div>
					  
					<label class="col-md-2 control-label" for="percent_">Percentage</label>  
					    <div class="col-md-2">
						  <div class='input-group'>
						  	<input id="i.percent_" name="percent_" type="text" class="form-control input-sm" data-validation="number" data-validation-allowing="float">
						  	<span class="input-group-addon">%</span>
						  </div>
						</div>
				</div>
	...
	<!-- JS Page Level -->
	<script src="billtype1.js"></script>
