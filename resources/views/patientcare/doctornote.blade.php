...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('patientcare/js/doctornote.js?v=1.6') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/hisdb/pat_mgmt/epis_payer.js?v=1.1') }}"></script>
