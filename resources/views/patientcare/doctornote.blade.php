...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('patientcare/js/doctornote.js?v=1.1') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('patientcare/js/requestfor.js?v=1.1') }}"></script>
