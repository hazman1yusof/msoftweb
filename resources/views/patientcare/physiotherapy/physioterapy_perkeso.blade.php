<div class="ui grid">
        ...
        <div class="ui grid">
            ...
            <div class="sixteen wide column">
                <div class="ui segments">
                    <div class="ui secondary segment">SUBJECTIVE AX</div>
                        ...
                        <div class="ui grid">
                            <div class="sixteen wide column">
                                <table class="ui celled table">
                                    <tbody>
                                        <tr>
                                            <td>1) PATIENT COMPLAINT</td>
                                            <td>
                                                <textarea rows="4" cols="50" name="patComplaint"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2) PATIENT HX</td>
                                            <td>
                                                <textarea rows="4" cols="50" name="patHX"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">3) INITIAL & FINAL ASSESSMENT
                                        ...
                                        <tr>
                                            <td>4) PATIENT EXPECTATION</td>
                                            <td>
                                                <textarea rows="4" cols="50" name="patExpectation"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>5) FAMILY EXPECTATION</td>
                                            <td>
    ...
    <div class="sixteen wide column">
        <div class="ui segments">
            <div class="ui secondary segment">OBJECTIVE AX</div>
            <div class="ui segment">
                <div class="ui grid">
                    <div class="sixteen wide column">
                        <div class="ui segments">
                            <div class="ui secondary segment">1) BODY CHART</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                        ...
                                        <div class="ui form">
                                            <div class="field">
                                                ...
                                                <div class="ui right labeled input" style="margin-top: 10px;">
                                                    <input type="number" name="painscore2">
                                                    <div class="ui basic label">/10</div>
                                                </div>
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="text" name="painType2" style="margin-top: 10px;">
                                            </div>
                                            <div class="field">
                                                <label>Severity</label>
                                                <input type="text" name="severityBC">
                                                <input type="text" name="severityBC2" style="margin-top: 10px;">
                                            </div>
                                            <div class="field">
                                                <label>Irritability</label>
                                                <input type="text" name="irritabilityBC">
                                                <input type="text" name="irritabilityBC2" style="margin-top: 10px;">
                                            </div>
                                            <div class="field">
                                                <label>Location of Pain</label>
                                                <input type="text" name="painLocation">
                                                <input type="text" name="painLocation2" style="margin-top: 10px;">
                                                <!-- <div class="inline fields"> -->
                                            ...
                                            <div class="field">
                                                ...
                                                <textarea rows="6" cols="50" name="subluxation"></textarea>
                                            ...
                                            <div class="field">
                                                ...
                                                <textarea rows="6" cols="50" name="palpationBC"></textarea>
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">2) SENSATION</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">3) ROM</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <div class="inline fields">
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">4) MUSCLE TONE (MAS)</div>
                            <div class="ui segment">
                                <div class="ui grid">
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">5) DEEP TENDON REFLEX</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="btrRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>TTR</td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="ttrRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>KTR</td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="ktrRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ATR</td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="atrRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Babinsky</td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="babinskyRemarks">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">6) MUSCLE POWER</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <div class="inline fields">
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">7) COORDINATION</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="fingerTestRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="heelTestRemarks">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">8) FUNCTIONAL ACTIVITY</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="transferRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">2</th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="suptoSideRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">3</th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="sideToSitRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">4</th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="sittRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">5</th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="sitToStdRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">6</th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="stdRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">7</th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="shiftRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">8</th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="ambulationRemarks">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">9) SPECIAL TEST</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="barthelIndexRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Berg Balance</td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="bergBalanceRemarks">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="sixMinWalkRemarks">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
    ...
    <div class="sixteen wide column">
        <div class="ui segments">
            <div class="ui secondary segment">SPEECH - LANGUAGE AND SWALLOWING ASSESSMENT</div>
            <div class="ui segment">
                <div class="ui grid">
                    <div class="sixteen wide column">
                        <div class="ui segments">
                            <div class="ui secondary segment">1) OROMOTOR EXAMINATION</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Jaw</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="jawInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="jawFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Lips</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="lipsInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="lipsFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Soft Palate</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="softPalateInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="softPalateFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Voice</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="voiceInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="voiceFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Tongue</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="tongueInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="tongueFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comments:</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="oromotorCmtInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="oromotorCmtFin"></textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">2) SPEECH ASSESSMENT</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Maximum Phonation Time (MPT)</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="MPTInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="MPTFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Loudness</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="loudInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="loudFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Pitch</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="pitchInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="pitchFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Articulation</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="articltInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="articltFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comments:</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="speechCmtInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="speechCmtFin"></textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">3) LANGUAGE ASSESSMENT</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Spontaneous Speech Score</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="spontaneousInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="spontaneousFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Auditory Verbal Comprehension Score</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="auditoryInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="auditoryFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Repetition Score</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="repeatInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="repeatFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Naming and Word Finding Score</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="namingInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="namingFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Aphasia Quotient:</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="aphasiaInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="aphasiaFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comments:</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="languageCmtInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="languageCmtFin"></textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">4) SWALLOWING ASSESSMENT</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Oral Phase</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="oralInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="oralFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Pharyngeal Phase</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="pharyngealInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="pharyngealFin"></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Recommendation and Management</td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="manageInit"></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea rows="4" cols="50" name="manageFin"></textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
    ...
    <div class="sixteen wide column">
        <div class="ui segments">
            <div class="ui secondary segment">ANALYSIS</div>
            <div class="ui segment">
                <div class="ui grid">
                    <div class="sixteen wide column">
                        <div class="ui segments">
                            <div class="ui secondary segment">1) PROBLEM LISTING & INTERVENTION</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <table class="ui celled striped table">
                        ...
                        <div class="ui segments">
                            <div class="ui secondary segment">2) SUMMARY OF CASE PROGRESS</div>
                            <div class="ui segment">
                                <div class="ui grid">
                                    <div class="sixteen wide column">
                                        <p>a) REHABILITATION PLANS/GOALS</p>
                                        <table class="ui celled striped table">
                                            <thead>
                                                <tr>
                                                    <th scope="col">INITIAL</th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="inline fields">
                                                            <label>Therapist name</label>
                                                            <div class="field">
                                                                <input name="therapistNameInit3" type="text">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <!-- <td>
                                                        <div class="inline fields">
                                                            <label>Therapist name</label>
                                                            <div class="field">
                                                                <input name="therapistNameProg3" type="text">
                                                            </div>
                                                        </div>
                                                    </td> -->
                                                    <td>
                                                        <div class="inline fields">
                                                            <label>Therapist name</label>
                                                            <div class="field">
                                                                <input name="therapistNameFin3" type="text">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <div class="sixteen wide column">
        <div class="ui segment">
            ...
            <div class="inline fields">
                <label>SUMMARY INITIAL ASSESSMENT</label>
