                                                    ...
                                                    <div class="ui grid">
                                                        <div class="sixteen wide column centered grid" style="padding: 14px 14px 0px 150px;">
                                                            ...
                                                            <div class="ui grid">
                                                                ...
                                                                <div class="twelve wide column">
                                                                    <div class="field eight wide column">
                                                                        1.  <input id="oper_type" name="oper_type" type="text" style="width: 350px;">
                                                                    </div>
                                                                    <div class="field eight wide column">
                                                                        2.  <input id="oper_type2" name="oper_type2" type="text" style="width: 350px;">
                                                                    </div>
                                                                    <div class="field eight wide column">
                                                                        3.  <input id="oper_type3" name="oper_type3" type="text" style="width: 350px;">
                                                                    </div>
                                                                    <div class="field eight wide column">
                                                                        4.  <input id="oper_type4" name="oper_type4" type="text" style="width: 350px;">
                                                                    </div>
                                                                    <div class="field eight wide column">
                                                                        5.  <input id="oper_type5" name="oper_type5" type="text" style="width: 350px;">
                                                                    </div>
                                                                </div>
                                                            </div>
