...
<html>
    <head>
        <title>Physiotherapy Assessment</title>
    </head>
        ...
        $(document).ready(function (){
            var docDefinition = {
                ...
                content: [
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    {
                                        text: [
                                            ...
                                            { text: `\u200B\t{!!$patrehabperkeso->diagnosis!!}` },
                                        ], colSpan: 2, alignment: 'left'
                                    },{},
                                ],
                                [
                                    {
                                        text: [
                                            { text: 'BACKGROUND INFORMATION:', bold: true },
                                        ], colSpan: 2, alignment: 'left'
                                    },{},
                                ],
                                [
                                    {
                                        text: [
                                            { text: 'Current source of income:' },
                                            { text: '\ngaji/family/jabatan kebajikan/bantuan baitulmal/saving\n\n', italics: true },
                                        ],
                                    },
                                    { text: `{!!$patrehabperkeso->incomeSource!!}` },
                                ],
                                [
                                    { text: 'Total Dependents:\n\n' },
                                    { text: '{{$patrehabperkeso->totDependents}}' },
                                ],
                                [
                                    { text: 'Educational level:\n\n' },
                                    { text: '{{$patrehabperkeso->eduLevel}}' },
                                ],
                                [
                                    {
                                        text: [
                                            { text: 'MEDICAL & REHABILITATION INFORMATION', bold: true },
                                        ], colSpan: 2, alignment: 'left'
                                    },{},
                                ],
                                [
                                ...
                                [
                                    {
                                        text: [
                                            { text: 'EMPLOYMENT HISTORY', bold: true },
                                        ], colSpan: 2, alignment: 'left'
                                    },{},
                                ],
                                [
                                    { text: 'Current employment Status:\n\n' },
                                    { text: '{{$patrehabperkeso->employmentStat}}' },
                                ],
                                [
                                    { text: 'Current work information:\n\n' },
                                    { text: '{{$patrehabperkeso->workInfo}}' },
                                ],
                                [
                                    { text: 'Employment History:\n\n' },
                                    { text: `{!!$patrehabperkeso->employmentHist!!}` },
                                ],
                                [
                                    {
                                        text: [
                                            { text: 'Community mobility:' },
                                            { text: '\nHow does OB mobilize in the community\n\n', italics: true },
                                        ],
                                    },
                                    { text: `{!!$patrehabperkeso->communityMobility!!}` },
                                ],
                                [
                                    {
                                        text: [
                                            { text: 'RTW PLANNING', bold: true },
                                        ], colSpan: 2, alignment: 'left'
                                    },{},
                                ],
                                [
                                    {
                                        text: [
                                            { text: 'View & Perception About work:' },
                                            { text: '\nYes/no/undecided\n\n', italics: true },
                                        ],
                                    },
                                    { text: '{{$patrehabperkeso->workView}}' },
                                ],
                                [
                                    {
                                        text: [
                                            { text: 'Working Industry:' },
                                            { text: '\n(same job same employer/same job different employer/Different Job different employer/etc)\n\n' },
                                        ],
                                    },
                                    { text: '{{$patrehabperkeso->workIndustry}}' },
                                ],
                                [
                                    { text: 'OB\u2019S MOTIVATION LEVEL DURING IA:\n\n', bold: true },
                                    { text: `{!!$patrehabperkeso->OBmotivation!!}` },
                                ],
                            ]
                        },
                        layout: {
                    ...
                    { text: '\u200B\t9) SPECIAL TEST', fontSize: 9 },
                    {
                        style: 'tableExample1',
                        table: {
                            headerRows: 1,
                    ...
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    { text: 'Impression:' },
                                    { text: `{!!$patrehabperkeso->impressionST!!}` },
                                ],
                            ]
                        },
                        layout: 'noBorders',
