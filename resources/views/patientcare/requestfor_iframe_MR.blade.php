...
<input id="age_requestForMR" name="age_requestFor" type="hidden" value="{{$pat_mast_data->age}}">
<input id="ptname_requestForMR" name="ptname_requestFor" type="hidden" value="{{$pat_mast_data->Name}}">
<input id="preg_requestForMR" name="preg_requestFor" type="hidden" value="{{$episode_data->pregnant}}">
<input id="ic_requestForMR" name="ic_requestFor" type="hidden" value="{{$pat_mast_data->Newic}}">
<input id="doctorname_requestForMR" name="doctorname_requestFor" type="hidden" value="{{$episode_data->doctorname}}">
<input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">

@include('patientcare.requestfor_MR')

@endsection

@section('js')
<script type="text/javascript" src="{{asset('patientcare/js/requestfor_iframe_MR.js?v=1.1')}}"></script>
@endsection