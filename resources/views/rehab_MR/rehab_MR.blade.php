    ...
    <div class="panel panel-default" style="z-index: 100; position: relative; margin: 10px 0px 10px 0px;" id="rehabMain_panel">
        ...
        <div id="tab_rehabMain" class="panel-collapse">
            <div class="panel-body paneldiv">
                @include('rehab_MR.rehabMain_MR.rehabMain_MR')
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/rehabMain_MR/rehabMain_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/transaction_phys.js') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/physiotherapy_MR/physioterapy_MR.js?v=1.7') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/physiotherapy_MR/physioterapy_ncase_MR.js?v=1.3') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/rehab_main_MR.js?v=1.7') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/physio_MR.js?v=1.5') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/neurorobotic_MR/neurorobotic_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/sixMinWalking_MR.js?v=1.3') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/bergBalanceTest_MR.js?v=1.3') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/musculoAssessment_MR.js?v=1.3') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/posturalAssessment_MR.js?v=1.4') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/oswestryQuest_MR.js?v=1.3') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/cardiorespAssessment_MR.js?v=1.3') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/neuroAssessment_MR.js?v=1.5') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/motorScale_MR.js?v=1.3') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/spinalCord_MR.js?v=1.4') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/physio_MR/physioNotes_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/occupTherapy_MR/occupTherapy_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/occupTherapy_MR/occupTherapy_cognitive_MR.js?v=1.2') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/occupTherapy_MR/occupTherapy_barthel_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/occupTherapy_MR/occupTherapy_upperExtremity_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/occupTherapy_MR/occupTherapy_notes_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/speechTherapy_MR/speechTherapy_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/psychotherapy_MR/psychotherapy_MR.js?v=1.1') }}"></script>
    <script type="text/javascript" src="{{ asset('patientcare/js/rehab_MR/dietitian_MR/dietitian_MR.js?v=1.1') }}"></script>
@endsection