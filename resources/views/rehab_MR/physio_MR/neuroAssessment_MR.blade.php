    ...
    <div class="ui segment">
        <div class="ui grid">
            <form id="formNeuroAssessment" class="floated ui form sixteen wide column">
                ...
                <input id="neuroAssessment_type" name="type" value="neurological" type="hidden">
                <div class="ui grid">
                    ...
                    <div class='twelve wide column'>
                        <div class="inline fields">
                            ...
                            <div class="field" style="display: none;">
                                <input id="neuroAssessment_enteredtime" name="enteredtime" type="time">
                            </div>
                        </div>
                        ...
                        <div class="ui grid">
                            ...
                            @include('rehab_MR.physio_MR.neuroAssessment_p1_MR')
                            ...
                            @include('rehab_MR.physio_MR.neuroAssessment_p2_MR')
