...
$(document).ready(function () {
	...
	if(istablet){
		...
		$("#jqGrid").jqGrid({
			datatype: "local",
			colModel: [
				{ label: 'MRN', name: 'MRN', width: 13, classes: 'wrap', formatter: padzero, unformat: unpadzero, checked: true,  },
				{ label: ' ', name: 'Episno', width: 8 ,align: 'right',classes: 'wrap' , hidden:true},
				{ label: 'Time', name: 'reg_time', width: 15 ,classes: 'wrap', formatter: timeFormatter, unformat: timeUNFormatter},
				{ label: 'Name', name: 'Name', width: 24 ,classes: 'wrap' },
				{ label: 'Payer', name: 'payer', width: 13 },
				{ label: 'Dept', name: 'regdept', width: 10  },
		...
		$("#jqGrid").jqGrid({
			...
			colModel: [
				...
				{ label: 'Name', name: 'Name', width: 175 ,classes: 'wrap' },
				{ label: 'Payer', name: 'payer', width: 80 },
				{ label: 'Dept', name: 'regdept', width: 60  },
				{ label: 'I/C', name: 'Newic', width: 90 ,classes: 'wrap' },
				...
				{ label: 'Sex', name: 'Sex', width: 50 ,classes: 'wrap' },
				{ label: 'Mode', name: 'pyrmode', width: 60 ,classes: 'wrap'},
				{ label: 'Discharge', name: 'episstatus', width: 60 ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2},
				{ label: 'Seen', name: 'doctorstatus' ,classes: 'wrap',formatter: formatterstatus_tick,hidden: true },
				{ label: 'idno', name: 'idno', hidden: true, key:true},
				{ label: 'DOB', name: 'DOB', hidden: true },
				{ label: 'RaceCode', name: 'RaceCode', hidden: true },
				{ label: 'religion', name: 'religion', hidden: true },
