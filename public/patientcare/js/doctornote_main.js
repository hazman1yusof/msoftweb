	...
	if(istablet){
		...
		$("#jqGrid").jqGrid({
			...
			colModel: [
				...
				{ label: 'Mode', name: 'pyrmode', width: 90 ,classes: 'wrap'},
				{ label: 'Discharge', name: 'episstatus', width: 90 ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2},
