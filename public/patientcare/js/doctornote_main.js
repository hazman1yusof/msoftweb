...
$(document).ready(function () {
	...
	if(istablet){
		...
		$("#jqGrid").jqGrid({
			datatype: "local",
			colModel: [
				{ label: 'MRN', name: 'MRN', width: 10, classes: 'wrap', formatter: padzero, unformat: unpadzero, checked: true,  },
				{ label: ' ', name: 'Episno', width: 5 ,align: 'right',classes: 'wrap' , hidden:true},
				{ label: 'Time', name: 'reg_time', width: 12 ,classes: 'wrap', formatter: timeFormatter, unformat: timeUNFormatter},
				{ label: 'Name', name: 'Name', width: 21 ,classes: 'wrap' },
				{ label: 'Payer', name: 'payer', width: 10 },
				{ label: 'Dept', name: 'regdept', width: 7  },
				{ label: 'I/C', name: 'Newic', width: 15 },
				...
				{ label: 'Discharge', name: 'episstatus', hidden:true, width: 8 ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2},
		...
		$("#jqGrid").jqGrid({
			...
			colModel: [
				...
				{ label: 'Time', name: 'reg_time', width: 12 ,classes: 'wrap', formatter: timeFormatter, unformat: timeUNFormatter},
				{ label: 'Name', name: 'Name', width: 22 ,classes: 'wrap' },
				{ label: 'Payer', name: 'payer', width: 10 },
				{ label: 'Dept', name: 'regdept', width: 7  },
				{ label: 'I/C', name: 'Newic', width: 16 ,classes: 'wrap' },
				{ label: 'Rehab', name: 'reff_rehab', width: 8 ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
				{ label: 'Physio', name: 'reff_physio', width: 8 ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
				{ label: 'Diet', name: 'reff_diet', width: 8 ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
				{ label: 'ED', name: 'reff_ed', width: 8 ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
				{ label: 'HP', name: 'telhp', width: 15 ,classes: 'wrap' },
				{ label: 'Sex', name: 'Sex', width: 5 ,classes: 'wrap' },
				{ label: 'Mode', name: 'pyrmode', width: 10 ,classes: 'wrap'},
				{ label: 'Discharge', name: 'episstatus', width: 8, hidden:true ,classes: 'wrap',formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2},
