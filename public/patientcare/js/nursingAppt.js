	...
	$("#dialognewexamFormTriage")
		...
		buttons: [{
			text: "Save",click: function() {
				...
				$.post( './ptcare_nursingAppt/form?'+$.param(saveParam), postobj , function( data ) {
...
function saveForm_ti(callback){
    ...
    $.post( "./ptcare_nursingAppt/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values) , function( data ) {
