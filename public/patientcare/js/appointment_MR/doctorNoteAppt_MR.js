...
$(document).ready(function (){
    ...
    $("#save_doctorNoteAppt").click(function (){
        if($('#formDoctorNoteAppt').isValid({requiredFields: ''}, conf, true)){
            saveForm_doctorNoteAppt(function (data){
                emptyFormdata_div("#formDoctorNoteAppt",['#mrn_doctorNoteAppt','#episno_doctorNoteAppt']);
                disableForm('#formDoctorNoteAppt',['toggle_type_docNoteAppt']);
                docNoteAppt_date_tbl.ajax.url("./doctorNoteAppt_MR/table?"+$.param(dateParam_docNoteAppt)).load(function (){
    ...
    $("#jqGridAddNotesAppt").jqGrid({
        datatype: "local",
        editurl: "./doctorNoteAppt_MR/form",
        colModel: [
    ...
    var myEditOptions_add = {
        ...
        beforeSaveRow: function (options, rowid){
            ...
            let editurl = "./doctorNoteAppt_MR/form?"+
                $.param({
                    _token: $('#_token').val(),
    ...
    // 				$.post("./doctorNoteAppt_MR/form?"+$.param(param), {oper:'del'}, function (data){
...
function saveForm_doctorNoteAppt(callback){
    ...
    $.post("./doctorNoteAppt_MR/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values), function (data){
...
$('#tab_doctornote').on('shown.bs.collapse', function (){
    ...
    docNoteAppt_date_tbl.ajax.url("./doctorNoteAppt_MR/table?"+$.param(dateParam_docNoteAppt)).load(function (data){
        emptyFormdata_div("#formDoctorNoteAppt",['#mrn_doctorNoteAppt','#episno_doctorNoteAppt']);
        // $('#docNoteAppt_date_tbl tbody tr:eq(0)').click(); // to select first row
    });
});
...
$('#docNoteAppt_date_tbl tbody').on('click', 'tr', function (){
    ...
    $.get("./doctorNoteAppt_MR/table?"+$.param(doctornote_docNoteAppt), function (data){
