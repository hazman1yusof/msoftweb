...
var urlParam = {
	...
	// url: './appointment_MR/table',
	url: "appointment_MR/table?action=get_table_doctornote&epistycode="+$("#epistycode").val()+"&curpat="+$("#curpat").val()+"&PatClass="+$("#PatClass_MR").val()+'&mrn='+$('#mrnMR').val()+'&episno='+$('#episnoMR').val(),
	...
	if(istablet){
		...
		$("#jqGrid").jqGrid({
			...
			colModel: [
				...
				{ label: 'Reg Source', name: 'admsrccode', width: 18},
