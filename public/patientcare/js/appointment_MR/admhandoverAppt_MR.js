...
$(document).ready(function (){
	...
	$('#tab_admHandoverAppt').on('shown.bs.collapse', function (){
		...
		$.post("./ptcare_admhandoverAppt_MR/form?"+$.param(urlparam), $.param(postobj), function (data){
	...
	$("#jqGridNoteAdmHandover").jqGrid({
		datatype: "local",
		editurl: "./ptcare_admhandoverAppt_MR/form",
		colModel: [
	...
	var myEditOptions_add = {
		...
		beforeSaveRow: function (options, rowid){
			...
			let editurl = "./ptcare_admhandoverAppt_MR/form?"+
				$.param({
					_token: $('#_token').val(),
					episno: $('#episno_admHandover').val(),
					mrn: $('#mrn_admHandover').val(),
	...
	// 				$.post("./ptcare_admhandoverAppt_MR/form?"+$.param(param), {oper:'del'}, function (data){
...
function saveForm_admHandoverAppt(callback){
    ...
    $.post("./ptcare_admhandoverAppt_MR/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values), function (data){
