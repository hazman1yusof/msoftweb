...
$(document).ready(function () {
	...
	$('#tab_triage').on('shown.bs.collapse', function () {
		...
		$.post( "./ptcare_nursingAppt_MR/form?"+$.param(saveParam), $.param(postobj), function( data ) {
  ...
  //   });
	...
	// 				}
	// 				$.post( "./ptcare_nursingAppt_MR/form?"+$.param(param),{oper:'del_exam'}, function( data ){
	// 				}).fail(function (data) {
	...
	var myEditOptions_add_AddNotesTriage = {
		...
		beforeSaveRow: function (options, rowid) {
			...
			let editurl = "./ptcare_nursingAppt_MR/form?"+
				$.param({
					_token: $("#_token").val(),
					episno:$('#episno_ti').val(),
					mrn:$('#mrn_ti').val(),
	...
	$("#dialognewexamFormTriage")
		...
		buttons: [{
			text: "Save",click: function() {
				...
				$.post( './ptcare_nursingAppt_MR/form?'+$.param(saveParam), postobj , function( data ) {
...
function saveForm_ti(callback){
    ...
    $.post( "./ptcare_nursingAppt_MR/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values) , function( data ) {
...
function getdata_triageAppt(){
	...
	$.post("./ptcare_nursingAppt_MR/form?"+$.param(urlparam), $.param(postobj), function (data){
