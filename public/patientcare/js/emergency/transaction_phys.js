$(document).ready(function () {
	...
	$("#jqGrid_trans_phys").jqGrid({
		datatype: "local",
		editurl: "./ptcare_doctornoteED_transaction_save",
		colModel: [
	...
	var myEditOptions_phys_add = {
        ...
        beforeSaveRow: function(options, rowid) {
			...
			let editurl = "./ptcare_doctornoteED_transaction_save?"+
				$.param({
					mrn: selrow.MRN,
				    ...
				    buttons: {
				        confirm:{
				        	...
				        	action: function () {
								...
								$.post( "./ptcare_doctornoteED_transaction_save",param, function( data ){
