...
$(document).ready(function (){
    ...
    $("#new_otbookReqFor").click(function (){
        ...
        emptyFormdata_div("#formOTBookReqFor",['#mrn_emergencyMain','#episno_emergencyMain','#otReqFor_doctorname']);
    });
    ...
    $("#new_physioReqFor").click(function (){
        ...
        emptyFormdata_div("#formPhysioReqFor",['#mrn_emergencyMain','#episno_emergencyMain','#phyReqFor_doctorname']);
    });
    ...
    $("#new_dressingReqFor").click(function (){
        ...
        emptyFormdata_div("#formDressingReqFor",['#mrn_emergencyMain','#episno_emergencyMain','#dressingReqFor_patientname','#ReqFor_patientnric','#dressingReqFor_doctorname']);
    });
...
function empty_requestFor_ptcare(obj){
    ...
    $('#ptname_emergencyMain').val('');
    $('#preg_emergencyMain').val('');
    $('#ic_emergencyMain').val('');
    $('#doctorname_emergencyMain').val('');
}
...
function populate_otbookReqFor_getdata(){
    emptyFormdata(errorField,"#formOTBookReqFor",["#mrn_emergencyMain","#episno_emergencyMain"]);
    ...
    $.get("./ptcare_requestforED/table?"+$.param(saveParam), $.param(postobj), function (data){
        ...
        if(!$.isEmptyObject(data.pat_otbook)){
            ...
            if(!emptyobj_(data.pat_otbook.ot_doctorname)){
                ...
                $("#otReqFor_doctorname").val($('#doctorname_emergencyMain').val());
            }
...
function populate_radClinicReqFor_getdata(){
    emptyFormdata(errorField,"#formRadClinicReqFor",["#mrn_emergencyMain","#episno_emergencyMain"]);
    ...
    $.get("./ptcare_requestforED/table?"+$.param(saveParam), $.param(postobj), function (data){
        ...
        if(!$.isEmptyObject(data)){
            ...
            // $("#radReqFor_pregnant").val($('#preg_emergencyMain').val());
            if(!emptyobj_(data.rad_allergy))$("#radReqFor_allergy").val(data.rad_allergy);
            // $("#radClinicReqFor_doctorname").val($('#doctorname_emergencyMain').val());
...
function populate_mriReqFor_getdata(){
    emptyFormdata(errorField,"#formMRIReqFor",["#mrn_emergencyMain","#episno_emergencyMain"]);
    ...
    $.get("./ptcare_requestforED/table?"+$.param(saveParam), $.param(postobj), function (data){
        ...
        if(!$.isEmptyObject(data.pat_mri)){
            ...
            if(!emptyobj_(data.pat_mri.mri_doctorname)){
                ...
                $("#mriReqFor_doctorname").val($('#doctorname_emergencyMain').val());
            }
        ...
        $("#mriReqFor_patientname").val($('#ptname_emergencyMain').val());
        // textarea_init_mriReqFor();
    });
}
...
function radiographer_acceptReqFor(){
    ...
    //             $.post("./ptcare_requestforED/form?"+$.param(saveParam), $.param(postobj), function (data){
...
function populate_physioReqFor_getdata(){
    emptyFormdata(errorField,"#formPhysioReqFor",["#mrn_emergencyMain","#episno_emergencyMain"]);
    ...
    $.get("./ptcare_requestforED/table?"+$.param(saveParam), $.param(postobj), function (data){
        ...
        // $("#phyReqFor_doctorname").val($('#doctorname_emergencyMain').val());
        $('#p_error_ReqForTreatment').text("");
        // textarea_init_physioReqFor();
    });
}
...
function populate_dressingReqFor_getdata(){
    emptyFormdata(errorField,"#formDressingReqFor",["#mrn_emergencyMain","#episno_emergencyMain"]);
    ...
    $.get("./ptcare_requestforED/table?"+$.param(saveParam), $.param(postobj), function (data){
        ...
        $("#dressingReqFor_patientname").val($('#ptname_emergencyMain').val());
        $("#ReqFor_patientnric").val($('#ic_emergencyMain').val());
        // $("#dressingReqFor_doctorname").val($('#doctorname_emergencyMain').val());
        // textarea_init_dressingReqFor();
    });
}
...
function populate_preContrastReqFor_getdata(){
    disableForm('#formPreContrastReqFor');
    emptyFormdata(errorField,"#formPreContrastReqFor",["#mrn_emergencyMain","#episno_emergencyMain"]);
...
function populate_consentFormReqFor_getdata(){
    disableForm('#formConsentFormReqFor');
    emptyFormdata(errorField,"#formConsentFormReqFor",["#mrn_emergencyMain","#episno_emergencyMain"]);
    ...
    $.get("./ptcare_requestforED/table?"+$.param(saveParam), $.param(postobj), function (data){
        ...
        $("#req_patientName").val($('#ptname_emergencyMain').val());
...
function saveForm_otbookReqFor(callback){
    ...
    $.post("./ptcare_requestforED/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values), function (data){
