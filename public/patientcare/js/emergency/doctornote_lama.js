...
$(document).ready(function (){
	...
	$("#save_doctorNote").click(function (){
		if($('#formDoctorNote').isValid({requiredFields: ''}, conf, true)){
			saveForm_doctorNote(function (data){
				emptyFormdata_div("#formDoctorNote",['#mrn_emergencyMain','#episno_emergencyMain']);
				disableForm('#formDoctorNote',['toggle_type']);
				docnote_date_tbl.ajax.url("./ptcare_doctornoteED/table?"+$.param(dateParam_docnote)).load(function (){
	...
	$("#new_otbook").click(function (){
		...
		rdonly('#formOTBook');
		emptyFormdata_div("#formOTBook",['#mrn_emergencyMain','#episno_emergencyMain','#ot_doctorname']);
	});
	...
	$("#save_otbook").click(function (){
		...
		if($('#formOTBook').isValid({requiredFields: ''}, conf, true)){
			saveForm_otbook(function (data){
				// emptyFormdata_div("#formOTBook",['#mrn_emergencyMain','#episno_emergencyMain']);
				// disableForm('#formOTBook');
	...
	$("#new_radClinic").click(function (){
		...
		emptyFormdata_div("#formRadClinic",['#mrn_emergencyMain','#episno_emergencyMain']);
	...
	$("#new_mri").click(function (){
		...
		enableForm('#formMRI');
		rdonly('#formMRI');
		emptyFormdata_div("#formMRI",['#mrn_emergencyMain','#episno_emergencyMain']);
	});
	...
	$("#new_physio").click(function (){
		...
		rdonly('#formPhysio');
		emptyFormdata_div("#formPhysio",['#mrn_emergencyMain','#episno_emergencyMain','#phy_doctorname']);
	});
		...
		if(!checked){
			...
			if($('#formPhysio').isValid({requiredFields: ''}, conf, true)){
				saveForm_physio(function (data){
					// emptyFormdata_div("#formPhysio",['#mrn_emergencyMain','#episno_emergencyMain']);
					// disableForm('#formPhysio');
	...
	$("#new_dressing").click(function (){
		...
		rdonly('#formDressing');
		emptyFormdata_div("#formDressing",['#mrn_emergencyMain','#episno_emergencyMain','#dressing_patientname','#patientnric','#dressing_doctorname']);
	});
	...
	$("#save_dressing").click(function (){
		...
		if($('#formDressing').isValid({requiredFields: ''}, conf, true)){
			saveForm_dressing(function (data){
				// emptyFormdata_div("#formDressing",['#mrn_emergencyMain','#episno_emergencyMain']);
				// disableForm('#formDressing');
	...
	$("#new_preContrast").click(function (){
		...
		emptyFormdata_div("#formPreContrast",['#mrn_emergencyMain','#episno_emergencyMain']);
	});
	...
	$("#new_consentForm").click(function (){
		...
		emptyFormdata_div("#formConsentForm",['#mrn_emergencyMain','#episno_emergencyMain']);
	});
	...
	$("#otbook_chart").click(function (){
		window.open('./doctornote/otbook_chart?mrn='+$('#mrn_emergencyMain').val()+'&episno='+$("#episno_emergencyMain").val(), '_blank');
	});
	
	$("#radClinic_chart").click(function (){
		window.open('./doctornote/radClinic_chart?mrn='+$('#mrn_emergencyMain').val()+'&episno='+$("#episno_emergencyMain").val()+'&age='+$("#age_emergencyMain").val(), '_blank');
	});
	
	$("#mri_chart").click(function (){
		window.open('./doctornote/mri_chart?mrn='+$('#mrn_emergencyMain').val()+'&episno='+$("#episno_emergencyMain").val(), '_blank');
	});
	
	$("#physio_chart").click(function (){
		window.open('./doctornote/physio_chart?mrn='+$('#mrn_emergencyMain').val()+'&episno='+$("#episno_emergencyMain").val(), '_blank');
	});
	
	$("#dressing_chart").click(function (){
		window.open('./doctornote/dressing_chart?mrn='+$('#mrn_emergencyMain').val()+'&episno='+$("#episno_emergencyMain").val(), '_blank');
	});

	$("#preContrast_chart").click(function (){
        window.open('./doctornote/preContrast_chart?mrn='+$('#mrn_emergencyMain').val()+'&episno='+$("#episno_emergencyMain").val()+'&age='+$("#age_emergencyMain").val(), '_blank');
    });

    $("#consentForm_chart").click(function (){
        window.open('./doctornote/consentForm_chart?mrn='+$('#mrn_emergencyMain').val()+'&episno='+$("#episno_emergencyMain").val(), '_blank');
    });
	//////////////////////////////////////////print button ends//////////////////////////////////////////
		...
		beforeSaveRow: function (options, rowid){
			...
			let editurl = "/doctornote/form?"+
				$.param({
					...
					mrn: $('#mrn_emergencyMain_past').val(),
...
var dialog_icd = new ordialog(
	'icdcode',['hisdb.diagtab AS dt','sysdb.sysparam AS sp'],"#formDoctorNote input[name='icdcode']",errorField,
	{
		...
		title: "Select ICD",
		open: function (){
			dialog_icd.urlParam.url = "ptcare_doctornoteED/table";
...
function populate_otbook_getdata(){
	emptyFormdata(errorField,"#formOTBook",["#mrn_emergencyMain","#episno_emergencyMain"]);
	...
	$.get("./ptcare_requestfor/table?"+$.param(saveParam), $.param(postobj), function (data){
		...
		if(!$.isEmptyObject(data.pat_otbook)){
			...
			if(!emptyobj_(data.pat_otbook.ot_doctorname)){
				...
				$("#ot_doctorname").val($('#doctorname_emergencyMain').val());
			}
...
function populate_radClinic_getdata(){
	emptyFormdata(errorField,"#formRadClinic",["#mrn_emergencyMain","#episno_emergencyMain"]);
	...
	var postobj = {
		...
		mrn: $("#mrn_emergencyMain").val(),
		episno: $("#episno_emergencyMain").val(),
		recorddate: $("#recorddate_emergencyMain").val(),
	};
	...
	$.get("./ptcare_requestfor/table?"+$.param(saveParam), $.param(postobj), function (data){
		...
		// $("#rad_pregnant").val($('#preg_emergencyMain').val());
		if(!emptyobj_(data.rad_allergy))$("#rad_allergy").val(data.rad_allergy);
		// $("#radClinic_doctorname").val($('#doctorname_emergencyMain').val());
...
function populate_mri_getdata(){
	emptyFormdata(errorField,"#formMRI",["#mrn_emergencyMain","#episno_emergencyMain"]);
	...
	$.get("./ptcare_requestfor/table?"+$.param(saveParam), $.param(postobj), function (data){
		...
		if(!$.isEmptyObject(data.pat_mri)){
			...
			if(!emptyobj_(data.pat_mri.mri_doctorname)){
				...
				$("#mri_doctorname").val($('#doctorname_emergencyMain').val());
			}
		...
		$("#mri_patientname").val($('#ptname_emergencyMain').val());
		// textarea_init_mri();
	});
}
...
function populate_physio_getdata(){
	emptyFormdata(errorField,"#formPhysio",["#mrn_emergencyMain","#episno_emergencyMain"]);
	...
	$.get("./ptcare_requestfor/table?"+$.param(saveParam), $.param(postobj), function (data){
		...
		// $("#phy_doctorname").val($('#doctorname_emergencyMain').val());
		$('#p_error_ReqTreatment').text("");
		// textarea_init_physio();
	});
}
...
function populate_dressing_getdata(){
	emptyFormdata(errorField,"#formDressing",["#mrn_emergencyMain","#episno_emergencyMain"]);
	...
	$.get("./ptcare_requestfor/table?"+$.param(saveParam), $.param(postobj), function (data){
		...
		$("#dressing_patientname").val($('#ptname_emergencyMain').val());
		$("#patientnric").val($('#ic_emergencyMain').val());
		// $("#dressing_doctorname").val($('#doctorname_emergencyMain').val());
		// textarea_init_dressing();
	});
}
...
function populate_preContrast_getdata(){
	disableForm('#formPreContrast');
	emptyFormdata(errorField,"#formPreContrast",["#mrn_emergencyMain","#episno_emergencyMain"]);
...
function populate_consentForm_getdata(){
	disableForm('#formConsentForm');
	emptyFormdata(errorField,"#formConsentForm",["#mrn_emergencyMain","#episno_emergencyMain"]);
	...
	$.get("./ptcare_requestfor/table?"+$.param(saveParam), $.param(postobj), function (data){
		...
		$("#patientName").val($('#ptname_emergencyMain').val());
...
function saveForm_doctorNote(callback){
	...
	$.post("./ptcare_doctornoteED/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values), function (data){
...
function saveForm_otbook(callback){
	...
	values.push({
        name: 'oper_type2',
        value: $('#formOTBook input[name=oper_type2]').val()
    })
    values.push({
        name: 'oper_type3',
        value: $('#formOTBook input[name=oper_type3]').val()
    })
    values.push({
        name: 'oper_type4',
        value: $('#formOTBook input[name=oper_type4]').val()
    })
    values.push({
        name: 'oper_type5',
        value: $('#formOTBook input[name=oper_type5]').val()
    })
	values.push({
		name: 'ot_diagnosis',
...
$('#docnote_date_tbl tbody').on('click', 'tr', function (){ 
	...
	$('#recorddate_emergencyMain').val(data.date);
	
	$.get("./ptcare_doctornoteED/table?"+$.param(doctornote_docnote), function (data){
