...
$(document).ready(function (){
	...
	$("#jqGridAddNotesAdmHandoverED").jqGrid({
		datatype: "local",
		editurl: "./ptcare_admhandover_MR/form",
		colModel: [
	...
	var myEditOptions_addAdmHandoverED = {
		...
		beforeSaveRow: function (options, rowid){
			...
			let editurl = "./ptcare_admhandover_MR/form?"+
				$.param({
					_token: $('#_token').val(),
...
function populate_admhandover_getdata(){
    ...
    $.get("./ptcare_admhandover_MR/table?"+$.param(saveParam), $.param(postobj), function (data){
...
function saveForm_admHandover(callback){
	...
	$.post("./ptcare_admhandover_MR/form?"+$.param(saveParam), $.param(postobj), function (data){
