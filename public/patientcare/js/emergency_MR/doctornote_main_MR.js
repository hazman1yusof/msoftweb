...
var urlParam = {
	...
	url: "ptcare_doctornoteED_MR/table?action=get_table_doctornote&epistycode="+$("#epistycode").val()+"&curpat="+$("#curpat").val()+"&PatClass="+$("#PatClass_MR").val()+'&mrn='+$('#mrnMR').val()+'&episno='+$('#episnoMR').val(),
	...
	if(istablet){
		...
		$("#jqGrid").jqGrid({
			...
			colModel: [
				...
				{ label: 'Rehab', name: 'reff_rehab', width: 8, formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2, hidden: true },
				{ label: 'Physio', name: 'reff_physio', width: 8, formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2, hidden: true },
			...
			onSelectRow:function(rowid, selected){
				...
				$('#mrnMR').val(selrowData('#jqGrid').MRN);
				$('#episnoMR').val(selrowData('#jqGrid').Episno);
