	...
	if(istablet){
		...
		$("#jqGrid").jqGrid({
			...
			colModel: [
				...
				{ label: 'Register Source', name: 'admsrccode', width: 8, formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
		...
		$("#jqGrid").jqGrid({
			...
			colModel: [
				...
				{ label: 'Register Source', name: 'admsrccode', width: 50, formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
