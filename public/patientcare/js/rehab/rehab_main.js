    ...
    if(istablet){
        ...
        $("#jqGrid").jqGrid({
            ...
            colModel: [
                ...
                { label: 'Rehab', name: 'reff_rehab', width: 55, formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
                { label: 'Physio', name: 'reff_physio', width: 55, formatter: formatterstatus_tick2, unformat: UNformatterstatus_tick2 },
