...
$(document).ready(function () {
	...
	$("#jqGrid2").jqGrid({
		...
		colModel: [
			...
			{label: 'year', name: 'year', hidden:true },
			{label: 'period', name: 'period', hidden:true },
			{label: 'Reference', name: 'reference', width: 50, classes : 'wrap text-uppercase' },
			{label: 'Amount', name: 'amount', width: 20 },
			{ label:'Src', name:'refsrc', width:10 },
			{ label:'TT', name:'reftrantype', width:10 },
			{ label:'Audit No', name:'refauditno', width:20 },
			{ label:'PV No', name:'pvno', width:20 },
			{label: 'lastuser', name: 'lastuser', hidden:true },
			{label: 'lastupdate', name: 'lastupdate', hidden:true },
			{label: 'bitype', name: 'bitype', hidden:true },
	...
	$("#jqGrid3").jqGrid({
		...
		colModel: [
			{ label:'idno', name:'idno', hidden:true, key:true },
			{ label:'Date', name:'postdate', width:20 },
			{ label:'Reference', name:'reference', width:50, classes : 'wrap text-uppercase' },
			{ label:'Amount', name:'amount', width:20  },
			{ label:'compcode', name:'compcode', hidden:true },
			{ label:'bankcode', name:'bankcode', hidden:true },
			{ label:'Src', name:'source', width:10 },
			{ label:'TT', name:'trantype', width:10 },
			{ label:'Audit No', name:'auditno', width:20 },
			{ label:'PV No', name:'pvno', width:20 },
			{ label:'year', name:'year', hidden:true },
			{ label:'period', name:'period', hidden:true },
			{ label:'cheqno', name:'cheqno', hidden:true },
