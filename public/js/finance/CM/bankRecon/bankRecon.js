...
$(document).ready(function () {
	...
	$("#jqGrid2").jqGrid({
		...
		colModel: [
			...
			{label: 'compcode', name: 'compcode', hidden:true },
			{label: 'auditno', name: 'auditno', hidden:true },
			{label: 'Date', name: 'docdate', width: 15 },
			{label: 'year', name: 'year', hidden:true },
			{label: 'period', name: 'period', hidden:true },
			{label: 'Reference', name: 'reference', width: 45, classes : 'wrap text-uppercase' },
			{label: 'Amount', name: 'amount', width: 18 },
			{ label:'Src', name:'refsrc', width:9 },
			{ label:'TT', name:'reftrantype', width:9 },
			{ label:'Audit No', name:'refauditno', width:18 },
			{ label:'PV No', name:'pvno', width:18 },
			{ label:'Receipt No', name:'recptno', width:18 },
			{label: 'lastuser', name: 'lastuser', hidden:true },
			{label: 'lastupdate', name: 'lastupdate', hidden:true },
			{label: 'bitype', name: 'bitype', hidden:true },
	...
	$("#jqGrid3").jqGrid({
		...
		colModel: [
			{ label:'idno', name:'idno', hidden:true, key:true },
			{ label:'Date', name:'postdate', width:15 },
			{ label:'Reference', name:'reference', width:45, classes : 'wrap text-uppercase' },
			{ label:'Amount', name:'amount', width:18  },
			{ label:'compcode', name:'compcode', hidden:true },
			{ label:'bankcode', name:'bankcode', hidden:true },
			{ label:'Src', name:'source', width:9 },
			{ label:'TT', name:'trantype', width:9 },
			{ label:'Audit No', name:'auditno', width:18 },
			{ label:'PV No', name:'pvno', width:18 },
			{ label:'Receipt No', name:'recptno', width:18 },
			{ label:'year', name:'year', hidden:true },
			{ label:'period', name:'period', hidden:true },
