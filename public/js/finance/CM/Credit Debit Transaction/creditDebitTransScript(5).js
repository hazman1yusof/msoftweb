			...
			$("#jqGrid").jqGrid({
				datatype: "local",
				 colModel: [
					...
					{ label: 'Audit No', name: 'auditno', width: 10, classes: 'wrap', canSearch: true, checked: true},
					{ label: 'TT', name: 'trantype', width: 10},
					{ label: 'Bank Code', name: 'bankcode', width: 35, classes: 'wrap', canSearch: true},
					{ label: 'Pay To', name: 'payto', width: 35, classes: 'wrap', hidden: true},
					{ label: 'Reference', name: 'refsource', width: 40, classes: 'wrap',},
					{ label: 'Post Date', name: 'actdate', width: 25, classes: 'wrap', hidden:true,},
