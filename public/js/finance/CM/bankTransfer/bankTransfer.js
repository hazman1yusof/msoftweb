	...
	$("#jqGrid").jqGrid({
		datatype: "local",
		 colModel: [
			...
			{label: 'Audit No', name: 'auditno', width: 27, classes: 'wrap', canSearch:true, align: 'right', formatter: padzero, unformat: unpadzero},
			{label: 'Payment No', name: 'pvno', width: 27, hidden: false, classes: 'wrap', align:'right', formatter: padzero, unformat: unpadzero},
