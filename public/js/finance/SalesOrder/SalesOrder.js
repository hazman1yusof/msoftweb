...
=======
			{ label: 'Doc Date', name: 'db_entrydate', width: 12},
			{ label: 'Audit No', name: 'db_auditno', width: 5},
			{ label: 'Invoice No', name: 'db_invno', width: 12, canSearch: true, formatter: padzero5, unformat: unpadzero },
>>>>>>> 24ed2c0564f71eec1441ec7ee2076b9ec5f3f99d
