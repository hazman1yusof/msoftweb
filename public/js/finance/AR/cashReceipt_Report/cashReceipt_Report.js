...
$(document).ready(function () {
	...
	$("#pdfgen1").click(function() {
		window.open('./cashReceipt_Report/showpdf?datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val(), '_blank');
	});

	$("#excelgen1").click(function() {
		window.location='./cashReceipt_Report/showExcel?datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val();
	});
