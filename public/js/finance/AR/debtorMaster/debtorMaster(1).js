		...
		$(document).ready(function () {
			...
			//////to hide financial class dialog handler during edit/////////////

			function disableFinClass() {
				$("#1").addClass("hidden");
			...
			$("#jqGrid").jqGrid({
				datatype: "local",
				 colModel: [
					...
					{label: 'Entered By', name: 'adduser', width: 200, hidden: true, classes: 'wrap'}, 
					{label: 'Last Entered', name: 'upduser', width: 200, hidden: true, classes: 'wrap'},
			...
			addParamField('#jqGrid',false,saveParam,['depamt','idno']);
