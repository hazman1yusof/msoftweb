...
$(document).ready(function () {
    ...
    $('#save_btn').click(function(){
        ...
        $.post('./claimBatch/form?oper=edit',obj, function( data ) {
    ...
    $('#print_btn').click(function(){
        ...
        if($('#formdata').isValid({requiredFields:''},conf,true)){
            window.open('./claimBatch/table?action=print&datefr='+$('#datefr').val()+'&dateto='+$('#dateto').val()+'&datesend='+$('#datesend').val()+'&debtorcode='+$('#debtorcode').val(), '_blank');
        }
    });

    function get_comment(){
        $.get( './claimBatch/table?action=get_comment&trantype='+$('input[name=trantype]:checked').val(), function( data ) {
