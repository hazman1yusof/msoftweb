		 ...
		 //   	dialog_deptcode.handler(errorField);
            ...
            $("#gridhist").jqGrid({
				...
				colModel: [
					...
					{label: 'Current Dept', name: 'curloccode', classes: 'wrap'},
					{label: 'Prev Dept', name: 'oldloccode', classes: 'wrap'},
				...
				datatype: "local",
				 colModel: [
					...
					{label: 'Type', name: 'assettype', width: 10, classes: 'wrap',canSearch: true},		
					 {label: 'Category', name: 'assetcode', width: 10, classes: 'wrap', canSearch: true,checked:true},		
                   ...
                   // { label: 'Start Date', name:'statdate', width:20, classes:'wrap', formatter:dateFormatter, hidden:true},
                    ...
                    { label: 'Cost', name: 'origcost', width: 20, classes: 'wrap', formatter:'currency'},
