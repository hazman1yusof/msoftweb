		...
		$("#jqGrid").jqGrid({
			datatype: "local",
			 colModel: [
				...
				{ label: 'Supplier', name: 'suppcode', width: 40, sorttype: 'text', classes: 'wrap', formatter: showdetail,},	
				...
				{ label: 'Regtype', name: 'regtype', width: 15, sorttype: 'text', classes: 'wrap', formatter:regtypeformat,unformat:regtypeunformat},	
