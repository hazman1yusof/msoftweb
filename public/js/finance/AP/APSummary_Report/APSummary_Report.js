...
$(document).ready(function () {
	...
	$('#pdfgen').click(function(){
		window.open('./APSummary_Report/showpdf?suppcode_from='+$('#suppcode_from').val()+'&suppcode_to='+$("#suppcode_to").val()+'&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val(),  '_blank'); 
	});

	$('#excel').click(function(){
		window.location='./APSummary_Report/showExcel?suppcode_from='+$('#suppcode_from').val()+'&suppcode_to='+$("#suppcode_to").val()+'&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val();
	});
