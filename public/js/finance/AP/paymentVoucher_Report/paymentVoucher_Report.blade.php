...
@section('title', 'Payment Voucher Report')

@section('body')
<div class="container">
	<div class="jumbotron" style="margin-top: 30px;text-align: center;">
		<form method="get" id="genreport" action="/paymentVoucher_Report/showExcel">
...
@section('scripts')
	...
	<script src="js/finance/AP/paymentVoucher_Report/paymentVoucher_Report.js"></script>
