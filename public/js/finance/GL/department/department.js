	...
	$("#jqGrid").jqGrid({
		datatype: "local",
		 colModel: [
			...
			{ label: 'Purchase Dept', name: 'purdept', width: 30, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td'},
			{ label: 'Register Dept', name: 'regdept', width: 30, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td'},
			{ label: 'Charge Dept', name: 'chgdept', width: 30, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td'},
			{ label: 'Ward Dept', name: 'warddept', width: 30, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td'},
			{ label: 'Admit Dept', name: 'admdept', width: 30, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td'},
			{ label: 'Dispense Dept', name: 'dispdept', width: 30, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td'},
			{ label: 'Store Dept', name: 'storedept', width: 30, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td'},
