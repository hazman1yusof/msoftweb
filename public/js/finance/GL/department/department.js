			...
			$("#jqGrid").jqGrid({
				datatype: "local",
				 colModel: [
					...
					{ label: 'Purchase', name: 'purdept', width: 30, classes: 'wrap'},
					{ label: 'Register', name: 'regdept', width: 30, classes: 'wrap'},
					{ label: 'Charges', name: 'chgdept', width: 30, classes: 'wrap'},
					{ label: 'Ward', name: 'warddept', width: 30, classes: 'wrap'},
					{ label: 'Admission', name: 'admdept', width: 30, classes: 'wrap'},
					{ label: 'Dispense', name: 'dispdept', width: 30, classes: 'wrap'},
					{ label: 'Store', name: 'storedept', width: 30, classes: 'wrap'},
