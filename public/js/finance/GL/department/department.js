			...
			$("#jqGrid").jqGrid({
				datatype: "local",
				 colModel: [
					...
					{ label: 'Purchase Dept', name: 'purdept', width: 30, classes: 'wrap'},
					{ label: 'Register Dept', name: 'regdept', width: 30, classes: 'wrap'},
					{ label: 'Charge Dept', name: 'chgdept', width: 30, classes: 'wrap'},
					{ label: 'Ward Dept', name: 'warddept', width: 30, classes: 'wrap'},
					{ label: 'Admit Dept', name: 'admdept', width: 30, classes: 'wrap'},
					{ label: 'Dispense Dept', name: 'dispdept', width: 30, classes: 'wrap'},
					{ label: 'Store Dept', name: 'storedept', width: 30, classes: 'wrap'},
