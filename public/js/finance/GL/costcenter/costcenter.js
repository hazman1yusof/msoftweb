		...
		$(document).ready(function () {
			...
			var err_reroll = new err_reroll('#jqGrid',['costcode', 'description']);
			...
			$("#jqGrid").jqGrid({
				...
				editurl: "./costcenter/form",
				 colModel: [
					...
					{ label: 'Cost Code', name: 'costcode', width: 30, classes: 'wrap', canSearch: true, editable: true, editrules: { required: true }, editoptions: {style: "text-transform: uppercase"}},
