function textfield_modal(){
    ...
    this.ontabbing = function(){
        $("#hid_newgl_corpcomp,#txt_newgl_occupcode,#txt_newgl_relatecode").on('keydown',{data:this},onTab);
    }

    this.checking = function(){
        $("#hid_newgl_corpcomp,#txt_newgl_occupcode,#txt_newgl_relatecode").on('blur',{data:this},onCheck);
    }

    this.clicking = function(){
        $("#btn_newgl_corpcomp,#btn_newgl_occupcode,#btn_newgl_relatecode").on('click',{data:this},onClick);
    }
