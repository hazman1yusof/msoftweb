...
$(document).ready(function (){
    ...
    $("#save_clientProgNoteRef").click(function (){
        ...
        if($('#formClientProgNoteRef').isValid({requiredFields: ''}, conf, true)){
            saveForm_clientProgNoteRef(function (data){
                ...
                clientprognoteref_date_tbl.ajax.url("./clientprogressnoteref_MR/table?"+$.param(dateParam_clientprognoteref)).load(function (){
    ...
    $("#jqGridAddNotesClientProgNoteRef").jqGrid({
        datatype: "local",
        editurl: "./clientprogressnoteref_MR/form",
        colModel: [
    ...
    var myEditOptions_addClientProgNoteRef = {
        ...
        beforeSaveRow: function (options, rowid){
            ...
            let editurl = "./clientprogressnoteref_MR/form?"+
                $.param({
...
function saveForm_clientProgNoteRef(callback){
    ...
    $.post("./clientprogressnoteref_MR/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values), function (data){
...
$('#jqGridClientProgNoteRef_panel').on('shown.bs.collapse', function (){
    ...
    docalloc_tbl.ajax.url("./clientprogressnoteref_MR/table?"+$.param(docalloc_clientprognoteref)).load(function (data){
        emptyFormdata_div("#formClientProgNoteRef",['#mrn_clientProgNoteRef','#episno_clientProgNoteRef','#datetime_clientProgNoteRef','#epistycode_clientProgNoteRef','#refdoctor_clientProgNoteRef']);
        $('#docalloc_tbl tbody tr:eq(0)').click(); // to select first row
    });
...
$('#clientprognoteref_date_tbl tbody').on('click', 'tr', function (){
    ...
    $.get("./clientprogressnoteref_MR/table?"+$.param(doctornote_clientprognoteref), function (data){
...
function check_doctorRef(){
    ...
    $.get("./clientprogressnoteref_MR/table?"+$.param(urlparam), $.param(postobj), function (data){
