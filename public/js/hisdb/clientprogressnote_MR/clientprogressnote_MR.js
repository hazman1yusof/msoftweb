...
$(document).ready(function (){
	...
	$("#save_clientProgNote").click(function (){
		...
		if($('#formClientProgNote').isValid({requiredFields: ''}, conf, true)){
			saveForm_clientProgNote(function (data){
				...
				clientprognote_date_tbl.ajax.url("./clientprogressnote_MR/table?"+$.param(dateParam_clientprognote)).load(function (){
	...
	$("#jqGridAddNotesClientProgNote").jqGrid({
		datatype: "local",
		editurl: "./clientprogressnote_MR/form",
		colModel: [
	...
	var myEditOptions_addClientProgNote = {
		...
		beforeSaveRow: function (options, rowid){
			...
			let editurl = "./clientprogressnote_MR/form?"+
				$.param({
...
function populate_refLetterClientProgNote(obj){
	...
	$("#refLetterClientProgNote_chart").click(function (){
		// window.location='./clientprogressnote_MR/refLetterClientProgNote_chart?mrn='+$('#mrn_clientProgNote').val()+'&episno='+$("#episno_clientProgNote").val();
		window.open('./clientprogressnote_MR/refLetterClientProgNote_chart?mrn='+$('#mrn_clientProgNote').val()+'&episno='+$("#episno_clientProgNote").val(), '_blank');
	});
	...
	$.post("./clientprogressnote_MR/form?"+$.param(urlparam), $.param(postobj), function (data){
...
function saveForm_clientProgNote(callback){
	...
	$.post("./clientprogressnote_MR/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values), function (data){
...
$('#clientprognote_date_tbl tbody').on('click', 'tr', function (){
	...
	$.get("./clientprogressnote_MR/table?"+$.param(doctornote_clientprognote), function (data){
...
function check_doctor(){
	...
	$.get("./clientprogressnote_MR/table?"+$.param(urlparam), $.param(postobj), function (data){
