                ...
                <div class="modal-header label-warning">
                    ...
                    <div class="form-group has-error">
                        <div class="col-sm-3">
                            ...
                            <input class="form-control " name="mrn" id="mrn" placeholder="" type="text" disabled>
...
<!--                        </div>-->
                        <div class="col-sm-3">
                            ...
                            <input class="form-control" name="first_visit_date" id="first_visit_date" placeholder="" type="text" disabled>
                        </div>
                        <div class="col-sm-3">
                            <small for="last_visit_date">LAST VISIT</small>
                            <input class="form-control" name="last_visit_date" id="last_visit_date" placeholder="" type="text" disabled>
                        </div>
                        <div class="col-sm-3">
                            <small for="episno">EPISODE NO</small>
                            <input class="form-control" name="episno" id="episno" placeholder="" type="text" disabled></div>
                    </div>
                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade active in" id="tab9">
											...
											<div class="col-md-10">
												...
												<div class="row">
													<div class="col-md-3">
														...
														<div class="input-group">
															<input type="text" class="form-control form-mandatory" name="txt_pat_title" id="txt_pat_title">
															<input type="hidden" name="hid_pat_title" id="hid_pat_title" value="" required />
													...
													<div class="col-md-6">
														...
														<input class="form-control has-error form-mandatory" name="txt_pat_name" id="txt_pat_name" placeholder="" type="text" required>
													</div>
													<div class="col-md-3">
														<small for="cmb_pat_sex">Sex</small>
														<select id="cmb_pat_sex" name="cmb_pat_sex" class="form-control form-mandatory">
												...
												<div class="row">
													<div class="col-md-3">
														...
														<select id="cmb_pat_idtype" name="cmb_pat_idtype" class="form-control has-error">
															<option value="">- Select IC Type -</option>
														</select>
													</div>
													<div class="col-md-3">
														<small for="txt_pat_newic">New IC (eg 690101086649)</small>
														<input class="form-control form-mandatory" name="txt_pat_newic" id="txt_pat_newic" placeholder="" type="text">
													</div>
													<div class="col-md-3">
														<small for="txt_pat_oldic">Old IC</small>
														<input class="form-control form-mandatory" name="txt_pat_oldic" id="txt_pat_oldic" placeholder="" type="text">
													</div>
													<div class="col-md-3">
														<small for="txt_pat_idno">Other (eg Passport Number)</small>
														<input class="form-control form-mandatory" name="txt_pat_idno" id="txt_pat_idno" placeholder="" type="text">
													</div>												
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4">
												...
												<div class="input-group">
													<input class="form-control form-mandatory" style="width:180px;" name="txt_pat_dob" id="txt_pat_dob" placeholder="" type="date" required>
											...
											<div class="col-md-2">
                                                ...
                                                <select id="cmb_pat_racecode" name="cmb_pat_racecode" class="form-control form-mandatory">
                                                    <option value="">- Select Race -</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <small for="cmb_pat_religion">Religion</small>
                                                <select id="cmb_pat_religion" name="cmb_pat_religion" class="form-control form-mandatory">
                                                    <option value="">- Select Religion -</option>
                                                </select>
                                            </div>											
											<div class="col-md-3">
                                                <small for="cmb_pat_langcode">Language</small>
                                                <select id="cmb_pat_langcode" name="cmb_pat_langcode" class="form-control">
										...
										<div class="form-group">                                            
                                             <div class="col-md-4">
												...
												<div class="input-group">
                                                    ...
                                                    <input type="hidden" name="hid_pat_citizen" id="hid_pat_citizen" value="" />
                                                    <span class="input-group-btn">
                                            ...
                                            <div class="col-md-4">
												...
												<div class="input-group">
                                                    ...
                                                    <input type="hidden" name="hid_pat_area" id="hid_pat_area" value="" />
                                                    <span class="input-group-btn">
											...
											<div class="col-md-4">
                                                ...
                                                <input class="form-control" name="txt_pat_email" id="txt_pat_email" placeholder="" type="email">
                                            </div>
										</div>						
														...
														<div class="tab-content">
															<div class="tab-pane fade in active" id="addr_current">
																<!--div class="row"-->
																	...
																	<div class="col-md-8">
																		<p><input name="txt_pat_curradd1" id="txt_pat_curradd1" class="form-control form-mandatory" type="text" required /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-8">
																		<p><input name="txt_pat_curradd2" id="txt_pat_curradd2" class="form-control form-mandatory" type="text" required /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-8">
																		<p><input name="txt_pat_curradd3" id="txt_pat_curradd3" class="form-control form-mandatory" type="text" required /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-4">
																		<p>Postcode<input name="txt_pat_currpostcode" id="txt_pat_currpostcode" class="form-control form-mandatory" type="text" required /></p>
																	</div>
																	<div class="col-md-12">
																		<p></p>
																	</div>
																	...
																	<div class="col-md-4">
																		<p>House<input name="txt_pat_currtelh" id="txt_pat_currtelh" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-4">
																		<p>Mobile<input name="txt_pat_currtelhp" id="txt_pat_currtelhp" class="form-control form-mandatory" type="text" required /></p>
																	</div>
																<!--/div-->
															</div>
															<div class="tab-pane fade in" id="addr_office">
																<!--div class="row"-->
																	...
																	<div class="col-md-8">
																		<p><input name="txt_pat_offadd1" id="txt_pat_offadd1" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-8">
																		<p><input name="txt_pat_offadd2" id="txt_pat_offadd2" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-8">
																		<p><input name="txt_pat_offadd3" id="txt_pat_offadd3" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-4">
																		<p>Postcode<input name="txt_pat_offpostcode" id="txt_pat_offpostcode" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-12">
																		<p></p>
																	</div>
															...
															<div class="tab-pane fade in" id="addr_home">
																<!--div class="row"-->
																	...
																	<div class="col-md-8">
																		<p><input name="txt_pat_padd1" id="txt_pat_padd1" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-8">
																		<p><input name="txt_pat_padd2" id="txt_pat_padd2" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-8">
																		<p><input name="txt_pat_padd3" id="txt_pat_padd3" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-4">
																		<p></p>
																	</div>
																	<div class="col-md-4">
																		<p>Postcode<input name="txt_pat_ppostcode" id="txt_pat_ppostcode" class="form-control" type="text" /></p>
																	</div>
																	<div class="col-md-12">
																		<p></p>
																	</div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="tab10">
										...
										<div class="form-group">
											<div class="col-md-6">
                                                ...
                                                <input class="form-control" name="txt_payer_email_official" id="txt_payer_email_official" placeholder="" type="text">
                                            </div>
											<div class="col-md-6">
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn_register_patient" type="button" class="btn btn-success">Save changes</button>
                </div>
            </div>
        </form>
    </div>
