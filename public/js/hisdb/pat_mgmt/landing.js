    ...
    var grid = $("#grid-command-buttons").bootgrid({
        ...
        formatters: {
            "col_add": function (column,row) {
                ...
                if(row.PatStatus == 1 && $('#epistycode').val()=='IP'){
                    retval+="&nbsp;<a class='btn btn-xs btn-default'><img src='img/occupied.jpg' width='18'></a>";
                }else if(row.PatStatus == 1 && $('#epistycode').val()=='OP'){
                    retval+="&nbsp;<a class='btn btn-xs btn-default'><img src='img/op.png' width='18'></a>";
                }
                return retval;
            },
