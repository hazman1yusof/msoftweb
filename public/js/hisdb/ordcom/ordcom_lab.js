...
$(document).ready(function(){
	...
	$("#jqGrid_lab").jqGrid({
		...
		onSelectRow:function(rowid){
			...
			// write_detail_lab([
			// 	{span:'#jqgrid_detail_lab_chgcode',value:selrowdata.chgcode},
			// 	{span:'#jqgrid_detail_lab_chgcode_desc',value:selrowdata.chgcode},
			// 	{span:'#jqgrid_detail_lab_dept',value:selrowdata.deptcode},
			// 	{span:'#jqgrid_detail_lab_cost_price',value:selrowdata.cost_price},
			// 	{span:'#jqgrid_detail_lab_unitprice',value:selrowdata.unitprce},
			// 	{span:'#jqgrid_detail_lab_discamt',value:selrowdata.discamount},
			// 	{span:'#jqgrid_detail_lab_taxamt',value:selrowdata.taxamount},
			// ]);
...
var myEditOptions_lab = {
	...
	oneditfunc: function (rowid) {
		...
		$("#jqGrid_lab input[name='deptcode']").val($("#userdeptcode").val());
...
function calculate_line_totgst_and_totamt_lab(event) {
	...
	// write_detail_lab('#jqgrid_detail_lab_discamt',discamount);
...
var dialog_uomcode_lab = new ordialog(
	...
	{	colModel:
		...
		justb4refresh: function(obj_){
			dialog_uomcode_lab.urlParam.searchCol2=[];
			dialog_uomcode_lab.urlParam.searchVal2=[];
		},
...
var dialog_uom_recv_lab = new ordialog(
	...
	{	colModel:
		...
		justb4refresh: function(obj_){
			dialog_uom_recv_lab.urlParam.searchCol2=[];
			dialog_uom_recv_lab.urlParam.searchVal2=[];
		},
		justaftrefresh: function(obj_){
			$("#Dtext_"+obj_.unique).val('');
		}
...
function deptcodeCustomEdit_lab(val,opt){  	
	...
	if(val.trim() == ''){
		...
		// write_detail_lab('#jqgrid_detail_lab_dept',val);
	}
