	...
	$("#jqGrid_rehab").jqGrid({
		...
		colModel: [
			...
			{ label: 'Net<br>Amount', name: 'totamount', width: 60, align: 'right', classes: 'wrap txnum', editable:true,
				formatter:totamountFormatter_rehab_doc,
				editrules:{required: true},editoptions:{readonly: "readonly"},
			},
		...
		loadComplete: function(data){
			calc_jq_height_onchange("jqGrid_rehab",false,parseInt($('#jqGrid_ordcom_c').prop('clientHeight'))-160);
...
var myEditOptions_rehab = {
	...
	oneditfunc: function (rowid) {
		...
		calc_jq_height_onchange("jqGrid_rehab",true,parseInt($('#jqGrid_ordcom_c').prop('clientHeight'))-100);
	},
	...
	beforeSaveRow: function (options, rowid) {
		...
		let editurl = "./ordcom/form?"+
			$.param({
				...
				uom_recv: $("#jqGrid_rehab input[name='uom_recv']").val(),
...
var myEditOptions_rehab_edit = {
	...
	oneditfunc: function (rowid) {
	    ...
	    $("#jqGrid_rehab input[name='taxamount']").val(ret_parsefloat(selrowdata.taxamount));
	    $("#jqGrid_rehab input[name='discamount']").val(ret_parsefloat(selrowdata.discamount));
	    $("#jqGrid_rehab input[name='billtypeamt']").val(ret_parsefloat(selrowdata.billtypeamt));
	    $("#jqGrid_rehab input[name='unitprce']").val(selrowdata.unitprce);
	    $("#jqGrid_rehab input[name='uom']").val(selrowdata.uom);
	    $("#jqGrid_rehab input[name='uom_recv']").val(selrowdata.uom_recv);

		// dialog_dosage_rehab.on();
		// dialog_dosage_rehab.id_optid = rowid;
		// dialog_dosage_rehab.check(errorField,rowid+"_ftxtdosage","jqGrid_rehab",null,null,null );

		// dialog_frequency_rehab.on();
		// dialog_frequency_rehab.id_optid = rowid;
		// dialog_frequency_rehab.check(errorField,rowid+"_frequency","jqGrid_rehab",null,null,null );

		// dialog_instruction_rehab.on();
		// dialog_instruction_rehab.id_optid = rowid;
		// dialog_instruction_rehab.check(errorField,rowid+"_addinstruction","jqGrid_rehab",null,null,null );

		// dialog_drugindicator_rehab.on();
		// dialog_drugindicator_rehab.id_optid = rowid;
		// dialog_drugindicator_rehab.check(errorField,rowid+"_drugindicator","jqGrid_rehab",null,null,null );
...
var dialog_chgcode_rehab = new ordialog(
	...
	{	colModel:
		...
		ondblClickRow:function(event){
			...
			dialog_chgcode_rehab.urlParam.chgcode = data['chgcode'];
		...
		open:function(obj_){
			...
			dialog_chgcode_rehab.urlParam.uom = $("#jqGrid_rehab input[name='uom']").val();
		...
		close: function(obj){
			$("#jqGrid_rehab input[name='uom_recv']").focus().select();
		}
...
var dialog_uomcode_rehab = new ordialog(
	...
	{	colModel:
		...
		open:function(obj_){
			...
			dialog_uomcode_rehab.urlParam.action_chk = "get_itemcode_uom_check";
...
var dialog_uom_recv_rehab = new ordialog(
	...
	{	colModel:
		...
		ondblClickRow:function(event){
			...
			if(data.invflag == '1' && (data.pt_idno == '' || data.pt_idno == null)){
				...
				myfail_msg_rehab.add_fail({
					id:'nostock_rehab',
					textfld:"#jqGrid_rehab #"+id_optid+"_uom_recv",
					msg:'Item not available in store dept '+$("#jqGrid_rehab #"+id_optid+"_deptcode").parent().next('span.help-block').text()+', please check',
				});
				...
				myfail_msg_rehab.del_fail({id:'noprod_rehab'});
				myfail_msg_rehab.del_fail({id:'nostock_rehab'});
		...
		title:"Select UOM Code For Item",
		open:function(obj_){
			dialog_uom_recv_rehab.urlParam.url = "./SalesOrderDetail/table";
			dialog_uom_recv_rehab.urlParam.action = 'get_itemcode_uom_recv';
			dialog_uom_recv_rehab.urlParam.url_chk = "./SalesOrderDetail/table";
...
// var dialog_dosage_rehab = new ordialog(
// 	'dosage_rehab',['hisdb.dose'],"#jqGrid_rehab input[name='dosage']",errorField,
// 	{	colModel:
// 		[
...
// 				},
// 		ondblClickRow:function(event){
// 			let data=selrowData('#'+dialog_dosage_rehab.gridname);
// 			// $(dialog_dosage_rehab.textfield).val(data.dosedesc);
// 			// $(dialog_dosage_rehab.textfield+'_code').val(data.dosecode);
// 		},
// 		gridComplete: function(obj){
// 			var gridname = '#'+obj.gridname;
// 			if($(gridname).jqGrid('getDataIDs').length == 1 && obj.ontabbing == true){
...
// 		title:"Select Tax Code For Item",
// 		open:function(obj_){
// 			dialog_dosage_rehab.urlParam.filterCol=['compcode','recstatus'];
// 			dialog_dosage_rehab.urlParam.filterVal=['session.compcode','ACTIVE'];
// 		},
// 		close: function(){
// 			// $(dialog_deptcode_rehab.textfield)			//lepas close dialog focus on next textfield 
// 			// 	.closest('td')						//utk dialog dalam jqgrid jer
...
// 	},'urlParam', 'radio', 'tab' 	
// );
// dialog_dosage_rehab.makedialog(false);

// var dialog_frequency_rehab = new ordialog(
// 	'freq_rehab',['hisdb.freq'],"#jqGrid_rehab input[name='frequency']",errorField,
// 	{	colModel:
// 		[
...
// 				},
// 		ondblClickRow:function(event){
// 			let data=selrowData('#'+dialog_frequency_rehab.gridname);
// 			// $(dialog_frequency_rehab.textfield).val(data.freqdesc);
// 			// $(dialog_frequency_rehab.textfield+'_code').val(data.freqcode);
// 		},
// 		gridComplete: function(obj){
// 			var gridname = '#'+obj.gridname;
// 			if($(gridname).jqGrid('getDataIDs').length == 1 && obj.ontabbing == true){
...
// 		title:"Select Tax Code For Item",
// 		open:function(obj_){
// 			dialog_frequency_rehab.urlParam.filterCol=['compcode','recstatus'];
// 			dialog_frequency_rehab.urlParam.filterVal=['session.compcode','ACTIVE'];
// 		},
// 		close: function(){
// 			// $(dialog_deptcode_rehab.textfield)			//lepas close dialog focus on next textfield 
// 			// 	.closest('td')						//utk dialog dalam jqgrid jer
...
// 	},'urlParam', 'radio', 'tab' 	
// );
// dialog_frequency_rehab.makedialog(false);

// var dialog_instruction_rehab = new ordialog(
// 	'instruction_rehab',['hisdb.instruction'],"#jqGrid_rehab input[name='instruction']",errorField,
// 	{	colModel:
// 		[
...
// 				},
// 		ondblClickRow:function(event){
// 			let data=selrowData('#'+dialog_instruction_rehab.gridname);
// 			// $(dialog_instruction_rehab.textfield).val(data.description);
// 			// $(dialog_instruction_rehab.textfield+'_code').val(data.inscode);
// 		},
// 		gridComplete: function(obj){
// 			var gridname = '#'+obj.gridname;
// 			if($(gridname).jqGrid('getDataIDs').length == 1 && obj.ontabbing == true){
...
// 		title:"Select Tax Code For Item",
// 		open:function(obj_){
// 			dialog_instruction_rehab.urlParam.filterCol=['compcode','recstatus'];
// 			dialog_instruction_rehab.urlParam.filterVal=['session.compcode','ACTIVE'];
// 		},
// 		close: function(){
// 			// $(dialog_deptcode_rehab.textfield)			//lepas close dialog focus on next textfield 
// 			// 	.closest('td')						//utk dialog dalam jqgrid jer
...
// 	},'urlParam', 'radio', 'tab' 	
// );
// dialog_instruction_rehab.makedialog(false);

// var dialog_drugindicator_rehab = new ordialog(
// 	'drugindicator_rehab',['hisdb.drugindicator'],"#jqGrid_rehab input[name='drugindicator']",errorField,
// 	{	colModel:
// 		[
...
// 				},
// 		ondblClickRow:function(event){
// 			let data=selrowData('#'+dialog_drugindicator_rehab.gridname);
// 			// $(dialog_drugindicator_rehab.textfield).val(data.description);
// 			// $(dialog_drugindicator_rehab.textfield+'_code').val(data.drugindcode);
// 		},
// 		gridComplete: function(obj){
// 			var gridname = '#'+obj.gridname;
// 			if($(gridname).jqGrid('getDataIDs').length == 1 && obj.ontabbing == true){
...
// 		title:"Select Tax Code For Item",
// 		open:function(obj_){
// 			dialog_drugindicator_rehab.urlParam.filterCol=['compcode','recstatus'];
// 			dialog_drugindicator_rehab.urlParam.filterVal=['session.compcode','ACTIVE'];
// 		},
// 		close: function(){
// 			// $(dialog_deptcode_rehab.textfield)			//lepas close dialog focus on next textfield 
// 			// 	.closest('td')						//utk dialog dalam jqgrid jer
...
// 	},'urlParam', 'radio', 'tab' 	
// );
// dialog_drugindicator_rehab.makedialog(false);
...
function totamountFormatter_rehab_doc(val,opt,rowObject ){
...
function dosageCustomEdit_rehab(val,opt){
	val = (val.slice(0, val.search("[<]")) == "undefined") ? "" : val.slice(0, val.search("[<]"));	
	return $(`<div class="input-group"><input autocomplete="off" jqgrid="jqGrid_rehab" optid="`+opt.id+`" id="`+opt.id+`" name="dosage" type="text" class="form-control input-sm" style="text-transform:uppercase" data-validation="required" value="`+val+`" style="z-index: 0"><a class="input-group-addon btn btn-primary"><span class="fa fa-ellipsis-h"></span></a></div><span class="help-block"></span>`);
}
function frequencyCustomEdit_rehab(val,opt){
	val = (val.slice(0, val.search("[<]")) == "undefined") ? "" : val.slice(0, val.search("[<]"));	
	return $(`<div class="input-group"><input autocomplete="off" jqgrid="jqGrid_rehab" optid="`+opt.id+`" id="`+opt.id+`" name="frequency" type="text" class="form-control input-sm" style="text-transform:uppercase" data-validation="required" value="`+val+`" style="z-index: 0"><a class="input-group-addon btn btn-primary"><span class="fa fa-ellipsis-h"></span></a></div><span class="help-block"></span>`);
}
function instructionCustomEdit_rehab(val,opt){
	val = (val.slice(0, val.search("[<]")) == "undefined") ? "" : val.slice(0, val.search("[<]"));	
	return $(`<div class="input-group"><input autocomplete="off" jqgrid="jqGrid_rehab" optid="`+opt.id+`" id="`+opt.id+`" name="instruction" type="text" class="form-control input-sm" style="text-transform:uppercase" data-validation="required" value="`+val+`" style="z-index: 0"><a class="input-group-addon btn btn-primary"><span class="fa fa-ellipsis-h"></span></a></div><span class="help-block"></span>`);
}
function drugindicatorCustomEdit_rehab(val,opt){
	val = (val.slice(0, val.search("[<]")) == "undefined") ? "" : val.slice(0, val.search("[<]"));	
	return $(`<div class="input-group"><input autocomplete="off" jqgrid="jqGrid_rehab" optid="`+opt.id+`" id="`+opt.id+`" name="drugindicator" type="text" class="form-control input-sm" style="text-transform:uppercase" data-validation="required" value="`+val+`" style="z-index: 0"><a class="input-group-addon btn btn-primary"><span class="fa fa-ellipsis-h"></span></a></div><span class="help-block"></span>`);
}
