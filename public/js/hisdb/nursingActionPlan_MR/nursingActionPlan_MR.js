...
$(document).ready(function (){
    ...
    $("#jqGridNursActionPlan_panel").on("shown.bs.collapse", function (){
        $('#jqGridPagerDelete_Treatment, #jqGridPagerRefresh_Treatment, #jqGridPagerDelete_Observation, #jqGridPagerRefresh_Observation, #jqGridPagerDelete_Feeding, #jqGridPagerRefresh_Feeding, #jqGridPagerDelete_ImgDiag, #jqGridPagerRefresh_ImgDiag, #jqGridPagerDelete_BloodTrans, #jqGridPagerRefresh_BloodTrans, #jqGridPagerDelete_Exams, #jqGridPagerRefresh_Exams, #jqGridPagerDelete_Procedure, #jqGridPagerRefresh_Procedure').hide();
