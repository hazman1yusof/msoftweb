...
$(document).ready(function (){
    ...
    $('#dietNote_date_tbl tbody').on('click', 'tr', function (){
        ...
        $.post("./dieteticCareNotes_MR/form?"+$.param(saveParam), $.param(postobj), function (data){
	...
	$("#jqGridAddNotesDieteticCareNotes").jqGrid({
		datatype: "local",
		editurl: "./dieteticCareNotes_MR/form",
		colModel: [
	...
	var myEditOptions_addDieteticCareNotes = {
		...
		beforeSaveRow: function (options, rowid){
			...
			let editurl = "./dieteticCareNotes_MR/form?"+
				$.param({
...
function saveForm_dieteticCareNotes(callback){
    ...
    $.post("./dieteticCareNotes_MR/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values), function (data){
...
function getdata_dietNote(){
    ...
    $.post("./dieteticCareNotes_MR/form?"+$.param(urlparam), $.param(postobj), function (data){
