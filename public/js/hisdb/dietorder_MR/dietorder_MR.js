...
$(document).ready(function (){
	...
	$("#jqGridDietOrder_panel").on("shown.bs.collapse", function (){
		...
		$.post("dietorder_MR/form?"+$.param(saveParam), $.param(postobj), function (data){
	...
	$("#preview").click(function (){
		...
		window.open('./dietorder_MR/table?action=dietorder_preview&epistycode='+$('#epistycode').val(), '_blank');
	});
...
function saveForm_dietOrder(callback){
	...
	$.post("./dietorder_MR/form?"+$.param(saveParam), $.param(postobj)+'&'+$.param(values) , function (data){
