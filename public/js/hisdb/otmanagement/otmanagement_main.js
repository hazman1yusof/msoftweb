...
$(document).ready(function () {
	...
	if(istablet){
		...
		$("#jqGrid").jqGrid({
			datatype: "local",
			colModel: [
				{ label: 'Patient Name', name: 'pat_name', width: 12, classes: 'wrap' },
				{ label: 'OT Room', name: 'ot_room', width: 12, classes: 'wrap' },
				{ label: 'Surgery Date', name: 'surgery_date', width: 12, classes: 'wrap' },
				{ label: 'OP Unit', name: 'op_unit', width: 12, classes: 'wrap' },
				{ label: 'Operation Type', name: 'oper_type', width: 12, classes: 'wrap' },
				{ label: 'Status', name: 'oper_status', width: 12, classes: 'wrap' },
				{ label: 'Action', name: 'pat_name', width: 12, classes: 'wrap' },
