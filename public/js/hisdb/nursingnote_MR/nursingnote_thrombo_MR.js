...
$(document).ready(function (){
    ...
    $("#thrombophlebitis_chart").click(function (){
        window.open('./thrombophlebitis_MR/thrombophlebitis_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()+'&dateInsert='+$("#dateInsert").val(), '_blank');
    });
    /////////////////////////////////////print button ends/////////////////////////////////////
    ...
    $("#jqGridThrombo").jqGrid({
		datatype: "local",
		editurl: "./thrombophlebitis_MR/form",
		colModel: [
...
function populate_thrombo_getdata(){
    ...
    $.post("./thrombophlebitis_MR/form?"+$.param(saveParam), $.param(postobj), function (data){
