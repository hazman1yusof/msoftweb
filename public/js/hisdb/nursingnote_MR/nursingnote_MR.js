...
$(document).ready(function (){
    ...
    $("#InvChartDialog").dialog({
        ...
        buttons: [{
            text: "Print Chart", click: function (){
                window.open('./nursingnote_MR/invChart_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()+'&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val(), '_blank');
                // window.location='./nursingnote_MR/invChart_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val();
            }
        },{
    ...
    $("#MorseFallScaleDialog").dialog({
        ...
        buttons: [{
            text: "Print Chart", click: function (){
                window.open('./nursingnote_MR/morsefallscale_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()+'&datefr='+$("#morsefallscale_datefr").val()+'&dateto='+$("#morsefallscale_dateto").val()+'&age='+$("#age_nursNote").val(), '_blank');
                // window.location='./nursingnote_MR/morsefallscale_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val();
            }
        },{
            text: "Cancel", click: function (){
                $(this).dialog('close');
    ...
    $("#fitchart_chart").click(function (){
        window.open('./nursingnote_MR/fitchart_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val(), '_blank');
    });
    
    $("#circulation_chart").click(function (){
        window.open('./nursingnote_MR/circulation_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()+'&age='+$("#age_nursNote").val(), '_blank');
    });
    
    $("#slidingScale_chart").click(function (){
        window.open('./nursingnote_MR/slidingScale_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val(), '_blank');
    });
    
    $("#othersChart1_chart").click(function (){
        window.open('./nursingnote_MR/othersChart_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()+'&tabtitle='+$("#othersChart1_tabtitle").val(), '_blank');
    });
    
    $("#othersChart2_chart").click(function (){
        window.open('./nursingnote_MR/othersChart_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()+'&tabtitle='+$("#othersChart2_tabtitle").val(), '_blank');
    });
    
    $("#bladder_chart").click(function (){
        window.open('./nursingnote_MR/bladder_chart?mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val(), '_blank');
    });
    ...
    $('#jqGridNursNote_panel_tabs.nav-tabs a').on('shown.bs.tab', function (e){
        ...
        switch(type){
            case 'invChart':
                ...
                $('#invChart_file').DataTable().ajax.url('./nursingnote_MR/table?action=invChart_file&mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()).load();
                ...
                tbl_invcat_FBC.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_FBC)).load(function (data){
            ...
            case 'progress':
                ...
                datetime_tbl.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_datetime_tbl)).load(function (data){
            ...
            case 'intake':
                ...
                tbl_intake_date.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_intake_date)).load(function (data){
            ...
            case 'drug':
                ...
                tbl_prescription.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_prescription)).load(function (data){
            ...
            case 'treatmentP':
                ...
                tbl_treatmentP.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_treatmentP)).load(function (data){
                ...
                tbl_investigation.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_investigation)).load(function (data){
                ...
                tbl_injection.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_injection)).load(function (data){
            ...
            case 'careplan':
                ...
                tbl_careplan_date.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_careplan_date)).load(function (data){
            ...
            case 'gcs':
                ...
                datetimegcs_tbl.ajax.url("./glasgow_MR/table?"+$.param(urlparam_datetimegcs_tbl)).load(function (data){
            ...
            case 'pivc':
                ...
                datetimepivc_tbl.ajax.url("./pivc_MR/table?"+$.param(urlparam_datetimepivc_tbl)).load(function (data){
            ...
            case 'morsefallscale':
                ...
                tbl_morsefallscale_date.ajax.url("./morsefallscale_MR/table?"+$.param(urlparam_tbl_morsefallscale)).load(function (data){
            ...
            case 'thrombo':
                ...
                datetimethrombo_tbl.ajax.url("./thrombophlebitis_MR/table?"+$.param(urlparam_datetimethrombo_tbl)).load(function (data){
    ...
    $('#jqGridNursNote_inv_tabs.nav-tabs a').on('shown.bs.tab', function (e){
        ...
        switch(type){
            ...
            case 'Coag':
                ...
                tbl_invcat_Coag.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_Coag)).load(function (data){
            ...
            case 'RP':
                ...
                tbl_invcat_RP.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_RP)).load(function (data){
            ...
            case 'LFT':
                ...
                tbl_invcat_LFT.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_LFT)).load(function (data){
            ...
            case 'Elect':
                ...
                tbl_invcat_Elect.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_Elect)).load(function (data){
            ...
            case 'ABGVBG':
                ...
                tbl_invcat_ABGVBG.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_ABGVBG)).load(function (data){
            ...
            case 'UFEME':
                ...
                tbl_invcat_UFEME.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_UFEME)).load(function (data){
            ...
            case 'CE':
                ...
                tbl_invcat_CE.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_CE)).load(function (data){
            ...
            case 'CS':
                ...
                tbl_invcat_CS.ajax.url("./nursingnote_MR/table?"+$.param(urlparam_tbl_invcat_CS)).load(function (data){
    ...
    var myEditOptions_add_PatMedic = {
        ...
        beforeSaveRow: function (options, rowid){
            ...
            let editurl = "./nursingnote_MR/form?"+
                $.param({
                    mrn: $('#mrn_nursNote').val(),
                    episno: $('#episno_nursNote').val(),
...
var invChart_tbl = $('#invChart_file').DataTable({
    ...
    sDom: 't',
    ajax: './nursingnote_MR/table?action=invChart_file&mrn='+$('#mrn_nursNote').val()+'&episno='+$("#episno_nursNote").val()
});
...
function uploadfile(){
    ...
    $.ajax({
        url: './nursingnote_MR/form?action=uploadfile',
        type: 'POST',
        data: formData,
        dataType: 'json',
        async: false,
