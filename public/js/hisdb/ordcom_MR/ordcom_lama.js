$(document).ready(function () {
	...
	var mycurrency2_ordcom =new currencymode([]);
   ...
   //              }
	...
	var myEditOptions = {
		...
		oneditfunc: function (rowid) {
			...
			mycurrency2_ordcom.array.length = 0;
			Array.prototype.push.apply(mycurrency2_ordcom.array, ["table#jqGrid_ordcom input[name='unitprice']","table#jqGrid_ordcom input[name='amount']","table#jqGrid_ordcom input[name='quantity']"]);
			mycurrency2_ordcom.formatOnBlur();

			$("#jqGrid_ordcom input[name='quantity'], #jqGrid_ordcom input[name='ordcom_taxcode'], #jqGrid_ordcom input[name='amtdisc']").on('blur',{currency: mycurrency2_ordcom},onleave_input_ordcom);
