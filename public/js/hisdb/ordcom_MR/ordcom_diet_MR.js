...
function calculate_line_totgst_and_totamt_diet(event) {
	...
	var billty_discamt = ret_parsefloat($("#jqGrid_diet #"+id_optid+"_chgcode").data('billty_discamt')).toFixed(2);
...
var dialog_chgcode_diet = new ordialog(
	...
	{	colModel:
		...
		ondblClickRow:function(event){
			...
			$("#jqGrid_diet #"+id_optid+"_chgcode").data('billty_discamt',data['billty_discamt']);
		...
		open:function(obj_){
			...
			dialog_chgcode_diet.urlParam.url_chk = "./ordcom_MR/table";
...
var dialog_uom_recv_diet = new ordialog(
	...
	{	colModel:
		...
		title:"Select UOM Code For Item",
		open:function(obj_){
			dialog_uom_recv_diet.urlParam.url = "./ordcom_MR/table";
			dialog_uom_recv_diet.urlParam.action = 'get_itemcode_uom_recv';
			dialog_uom_recv_diet.urlParam.url_chk = "./ordcom_MR/table";
