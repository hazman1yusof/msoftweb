...
function calculate_line_totgst_and_totamt_rehab(event) {
	...
	var billty_discamt = ret_parsefloat($("#jqGrid_rehab #"+id_optid+"_chgcode").data('billty_discamt')).toFixed(2);
...
var dialog_chgcode_rehab = new ordialog(
	...
	{	colModel:
		...
		ondblClickRow:function(event){
			...
			$("#jqGrid_rehab #"+id_optid+"_chgcode").data('billty_discamt',data['billty_discamt']);
		...
		open:function(obj_){
			...
			dialog_chgcode_rehab.urlParam.url_chk = "./ordcom_MR/table";
...
var dialog_uom_recv_rehab = new ordialog(
	...
	{	colModel:
		...
		title:"Select UOM Code For Item",
		open:function(obj_){
			dialog_uom_recv_rehab.urlParam.url = "./ordcom_MR/table";
			dialog_uom_recv_rehab.urlParam.action = 'get_itemcode_uom_recv';
			dialog_uom_recv_rehab.urlParam.url_chk = "./ordcom_MR/table";
