...
$(document).ready(function () {
	...
	var err_reroll = new err_reroll('#jqGrid',['statuscode', 'Description']);
	...
	$("#jqGrid").jqGrid({
		...
		editurl: './doctorStatus/form',
			...
			{ label: 'Code', name: 'statuscode', width: 50, canSearch: true, checked: true, editable: true, 
	...
	function check_cust_rules(rowid){
		var chk = ['statuscode','Description'];
...
//////////////////////////My edit options /////////////////////////////////////////////////////////
	...
	var myEditOptions_edit = {
		...
		oneditfunc: function (rowid) {
			$("#jqGridPagerDelete,#jqGridPagerRefresh").hide();
			$("input[name='statuscode']").attr('disabled','disabled');
			$("select[name='recstatus']").keydown(function(e) {//when click tab at last column in header, auto save
				var code = e.keyCode || e.which;
				if (code == '9')$('#jqGrid_ilsave').click();
				/*addmore_jqgrid.state = true;
