...
$(document).ready(function () {
	...
	$("#jqGrid").jqGrid({
		...
		gridComplete: function () {
			...
			// $('#jqGrid #' + $("#jqGrid").jqGrid('getGridParam', 'selrow')).focus();
	...
	$("#jqGridsvc").jqGrid({
		...
		gridComplete: function () {
			...
			// $('#jqGridsvc #' + $("#jqGridsvc").jqGrid('getGridParam', 'selrow')).focus();
	...
	$("#jqGriditem").jqGrid({
		...
		gridComplete: function () {
			...
			// $('#jqGriditem #' + $("#jqGriditem").jqGrid('getGridParam', 'selrow')).focus();
