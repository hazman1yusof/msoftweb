...
$(document).ready(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            { label: 'Discharge Code', name: 'code', width: 20, classes: 'wrap'},
            { label: 'Description', name: 'discharge', width: 70, classes: 'wrap', canSearch: true, checked:true},
