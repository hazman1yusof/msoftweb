...
$(document).ready(function () {
	...
	$("#jqGrid").jqGrid({
		...
		colModel: [
			...
			{ label: 'Add User', name: 'adduser', width: 18, hidden:false},
			{ label: 'Add Date', name: 'adddate', width: 30, hidden:false},
			{ label: 'Upd User', name: 'upduser', width: 18, hidden:false},
			{ label: 'Upd Date', name: 'upddate', width: 30, hidden:false},
			{ label: 'Computer ID', name: 'computerid', width: 18, hidden:false},
