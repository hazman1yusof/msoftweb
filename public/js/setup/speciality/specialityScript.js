			...
			$("#jqGrid").jqGrid({
				datatype: "local",
				 colModel: [
					...
					{ label: 'Category Type', name: 'type', width: 30, classes: 'wrap',editable: true, 
							editrules:{required: true}, 
							editoptions: {maxlength: 2},
						},
					...
					{ label: 'Active', name: 'recstatus', width: 20, formatter: formatterstatus, unformat: unformat,
			...
			$("#jqGrid").jqGrid('navGrid','#jqGridPager',{	
				...
				onClickButton: function(){
					...
					if(!selRowId){
						...
						saveFormdata("#jqGrid","#dialogForm","#formdata",'del',saveParam,urlParam,null,{'specialitycode':selRowId});
					}
				},
			}).jqGrid('navButtonAdd',"#jqGridPager",{
				caption:"",cursor: "pointer",position: "first", 
