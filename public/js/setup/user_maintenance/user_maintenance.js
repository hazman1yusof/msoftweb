...
$(document).ready(function (){
	...
	$("#jqGrid").jqGrid({
		...
		colModel: [
			...
			{ label: 'Billing', name: 'billing', width: 60, formatter: formatter, unformat: unformat, formatter: formatterstatus_tick2, unformat: unformatstatus_tick2, classes: 'center_td' },
			{ label: 'Nurse', name: 'nurse', width: 60, formatter: formatter, unformat: unformat, formatter: formatterstatus_tick2, unformat: unformatstatus_tick2, classes: 'center_td' },
			{ label: 'Doctor', name: 'doctor', width: 60, formatter: formatter, unformat: unformat, formatter: formatterstatus_tick2, unformat: unformatstatus_tick2, classes: 'center_td' },
			{ label: 'Register', name: 'register', width: 60, formatter: formatter, unformat: unformat, formatter: formatterstatus_tick2, unformat: unformatstatus_tick2, classes: 'center_td' },
			{ label: 'Price View', name: 'priceview', width: 60, formatter: formatter, unformat: unformat, formatter: formatterstatus_tick2, unformat: unformatstatus_tick2, classes: 'center_td' },
	...
	searchClick('#jqGrid','#searchForm',urlParam_search);
