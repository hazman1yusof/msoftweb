...
$(document).ready(function () {
	...
	var err_reroll = new err_reroll('#jqGrid',['RelationShipCode', 'Description']);
	...
	$("#jqGrid").jqGrid({
		...
		colModel: [
			...
			{ label: 'Code', name: 'RelationShipCode', width: 50, classes: 'wrap', canSearch: true,  editable: true, editrules: { required: true }, editoptions: {style: "text-transform: uppercase"} },
	...
	function check_cust_rules(rowid){
		var chk = ['RelationShipCode','Description'];
	...
	var myEditOptions_edit = {
		...
		oneditfunc: function (rowid) {
			$("#jqGridPagerDelete,#jqGridPagerRefresh").hide();
			$("input[name='RelationShipCode']").attr('disabled','disabled');
			$("input[name='Description']").keydown(function(e) {//when click tab at last column in header, auto save
				var code = e.keyCode || e.which;
				if (code == '9')$('#jqGrid_ilsave').click();
				/*addmore_jqgrid.state = true;
