			...
			$("#jqGrid").jqGrid({
				...
				datatype: "json",
				 colModel: [
					...
					{ label: 'Occupation Code', name: 'occupcode', width: 30, sorttype: 'number', canSearch: true, checked:true, classes: 'wrap',},
					{ label: 'Description', name: 'description', width: 80, sorttype: 'text', canSearch: true, classes: 'wrap',},
			...
			$("#jqGrid").jqGrid('navGrid','#jqGridPager',
				...
				onClickButton: function(){
					...
					if(!selRowId){
						...
						saveFormdata('del',{'occupcode':selRowId});
					}
				}, 
				position: "first", 
