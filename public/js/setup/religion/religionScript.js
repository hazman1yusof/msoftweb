...
$(document).ready(function () {
	...
	$("#jqGrid").jqGrid({
		...
		colModel: [
			...
			{ label: 'Description', name: 'Description', classes: 'wrap', canSearch: true, width: 100, editable: true, checked: true, editrules: { required: true }, editoptions: {style: "text-transform: uppercase"}},
