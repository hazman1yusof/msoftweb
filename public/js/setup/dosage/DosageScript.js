	...
	$("#jqGrid").jqGrid({
		...
		editurl: "/dosage/form",
		 colModel: [
			...
			{ label: 'Dose Code', name: 'dosecode', width: 30, classes: 'wrap', canSearch: true,editable: true, editrules: { required: true }, editoptions: {style: "text-transform: uppercase"}},
			{ label: 'Description', name: 'dosedesc', classes: 'wrap', canSearch: true, width: 100, checked:true,editable: true, editrules: { required: true }, editoptions: {style: "text-transform: uppercase"}},
