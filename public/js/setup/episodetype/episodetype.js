...
$(document).ready(function () {
	...
	var err_reroll = new err_reroll('#jqGrid',['epistycode', 'description']);
	...
	function check_cust_rules(rowid){
		var chk = ['epistycode','description','activatedate'];
