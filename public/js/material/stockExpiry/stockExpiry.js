...
$(document).ready(function () {
	...
	$('#pdfgen').click(function(){
		window.open('./stockExpiry/showpdf?item_from='+$('#item_from').val()+'&item_to='+$("#item_to").val()+'&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val(),  '_blank'); 
	});

	$('#excelgen').click(function(){
		window.location='./stockExpiry/showExcel?item_from='+$('#item_from').val()+'&item_to='+$("#item_to").val()+'&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val();
	});
