...
$(document).ready(function () {
	...
	$('#pdfgen').click(function(){
		window.open('./inventoryTransaction_Report/showpdf?&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val(),  '_blank'); 
	});

	$('#excelgen').click(function(){
		window.location='./inventoryTransaction_Report/showExcel?&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val();
	});
});
