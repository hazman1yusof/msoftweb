		...
		<div id="dialogForm" title="Add Form" >
			<form class='form-horizontal' style='width:99%' id='formdata'>
                ...
                <div class="form-group">                   
				  ...
				  <div class="col-md-4">
				  <input id="generic" name="generic" type="text" maxlength="40" class="form-control input-sm">
				  </div>
				</div>
                ...
                <div class="form-group">
				  ...
				  <div class="col-md-3">
                    ...
                    <label class="radio-inline"><input type="radio" id="groupcodeOther" name="groupcode" value='Other' data-validation="">Other</label>
				  </div>
                ...
                <div class="form-group">
				  ...
				  <div class="col-md-3">
				  <div class='input-group'>
				  <input id="subcatcode" name="subcatcode" type="text" maxlength="15" class="form-control input-sm">
				  <a class='input-group-addon btn btn-primary'><span class='fa fa-ellipsis-h'></span></a>
					  </div>
					  <span class="help-block"></span>
				  </div>
                ...
                <div class="form-group">
				  ...
				  <div class="col-md-3">
					  <div class='input-group'>
						<input id="suppcode" name="suppcode" type="text" class="form-control input-sm">
						<a class='input-group-addon btn btn-primary'><span class='fa fa-ellipsis-h'></span></a>
					  </div>
					  <span class="help-block"></span>
				  </div>
				  ...
				  <div class="col-md-3">
					  <div class='input-group'>
						<input id="mstore" name="mstore" type="text" class="form-control input-sm">
						<a class='input-group-addon btn btn-primary'><span class='fa fa-ellipsis-h'></span></a>
					  </div>
					  <span class="help-block"></span>
				  </div>
