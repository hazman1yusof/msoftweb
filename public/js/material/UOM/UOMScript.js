		...
		$(document).ready(function () {
			...
			$("#jqGrid").jqGrid({
				...
				editurl: "./uom/form",
				 colModel: [
					...
					{ label: 'UOM Code', name: 'uomcode', width: 30, classes: 'wrap', canSearch: true,editable: true, editrules: { required: true }, editoptions: {style: "text-transform: uppercase"}},
			...
			function check_cust_rules(rowid){
				var chk = ['uomcode','description', 'convfactor'];
