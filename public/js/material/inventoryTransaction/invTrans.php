				...
				<div class="panel-heading">
					...
					<div class="panel-body" style="position: relative;">
						<form class='form-horizontal' style='width:99%' id='formdata'>
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="txndept">Transaction Department</label>
						  		...
						  		<label class="col-md-2 control-label" for="srcdocno">Request RecNo</label>  
						  			<div class="col-md-2">
										<input id="srcdocno" name="srcdocno" type="text" maxlength="30" class="form-control input-sm">
						  			</div>
							</div>
							...
							<div class="form-group">
						  		<label class="col-md-2 col-md-offset-4 control-label" for="recno">Record No</label>  
						  			<div class="col-md-2">
							...
							<div class="form-group">
					    		<label class="col-md-2 control-label" for="trandate">Transaction Date</label>  
							  	...
							  	<label class="col-md-2 col-md-offset-0 control-label" for="recstatus">Status</label>  
							  	<div class="col-md-2">
