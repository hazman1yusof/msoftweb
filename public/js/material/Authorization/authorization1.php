...
<head>
    ...
    <?php include("authorizationScript.php")?>
            	 ...
            	 <div class="form-group">
				  ...
				  <div class="col-md-3">
					  <div class='input-group'>
						<input id="authorid" name="authorid" type="text" maxlength="12" class="form-control input-sm" data-validation="required">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
				 <label class="col-md-2 control-label" for="active">Record Status</label>  
				  <div class="col-md-5">
					<label class="radio-inline"><input type="radio" name="active" value='A' checked>Active</label>
					<label class="radio-inline"><input type="radio" name="active" value='D'>Deactive</label>
