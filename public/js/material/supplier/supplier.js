	...
	$("#jqGrid").jqGrid({
		datatype: "local",
		 colModel: [
			...
			{ label: 'Term Others', name: 'TermOthers', width: 30, align: 'right',editable: true, classes: 'wrap' }, 
			{ label: 'TermNonDisp', name: 'TermNonDisp', width: 35, align: 'right',editable: true, classes: 'wrap' },
