...
$(document).ready(function () {
	...
	$("#jqGrid").jqGrid({
		...
		colModel: [
			...
			{ label: 'Max Stock Qty', name: 'maxqty', width: 40, classes: 'wrap', align:'right'  },
			{ label: 'Reorder Level', name: 'reordlevel', width: 60, classes: 'wrap',  align:'right'  },
			{ label: 'Reorder Quantity', name: 'reordqty', width: 60, classes: 'wrap',  align:'right' },
