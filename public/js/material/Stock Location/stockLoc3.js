		...
		$(document).ready(function () {
				...
				open: function( event, ui ) {
					...
					switch(oper) {
						case state = 'add':
							...
							//alert($("#itemcode").val());
							///i = $("#itemcode").val();
							////$("#formdata :input[name='itemcode']").val(i);
							break;
						case state = 'edit':
			...
			/*function getItemCode(itemcode){
				var param={
							action:'get_table_default',
							field:['idno', 'compcode', 'deptcode' , 'itemcode', 'uomcode', 'bincode', 'rackno',
									'year', 'openbalqty', 'openbalval', 'netmvqty1', 'netmvval1', 'stocktxntype',
									'disptype', 'qtyonhand', 'minqty', 'maxqty', 'reordlevel', 'reordqty',
									'lastissdate', 'frozen', 'adduser', 'adddate', 'upduser', 'upddate', 'cntdocno',
									'fix_uom', 'locavgcs', 'lstfrzdt', 'lstfrztm','frzqty'],
							table_name:'material.stockloc',
							table_id:'idno',
							sort_idno:true,
							filterCol:['itemcode'],
						...
						$("#jqGrid").jqGrid('setGridParam',{datatype:'json',url:'../../../../assets/php/entry.php?'+$.param(param)}).trigger('reloadGrid');
