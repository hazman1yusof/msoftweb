			...
			$("#jqGrid").jqGrid({
				datatype: "local",
				 colModel: [
					...
					{label: 'PO Validate', name: 'povalidate', width: 27, classes: 'wrap', formatter:formatter, unformat:unformat, formatter:formatterstatus_tick2, unformat:unformatstatus_tick2, classes: 'center_td' },					
