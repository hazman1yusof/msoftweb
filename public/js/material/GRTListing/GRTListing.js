...
$(document).ready(function () {
	...
	$('#pdfgen').click(function(){
		window.open('./GRTListing/showpdf?&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val()+'&Status='+$("#Status").val(),  '_blank'); 
	});

	$('#excelgen').click(function(){
		window.location='./GRTListing/showExcel?&datefr='+$("#datefr").val()+'&dateto='+$("#dateto").val()+'&Status='+$("#Status").val();
	});
});
